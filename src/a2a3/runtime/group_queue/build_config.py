...
# -----------------------------------------------------------------------------------------------------------
# group_queue runtime build configuration
# All paths are relative to this file's directory (src/runtime/group_queue/)
#
...
# types.h by bare name: they resolve here when compiled for group_queue and to
