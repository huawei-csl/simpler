...
struct PTO2SchedulerState {
    ...
    inline int drain_new_task_queue([[maybe_unused]] bool force_drain = false) {
    ...
    // ready buffer. See push_ready_routed_local for the
    // dispatch-time fast path.
    inline void push_ready_routed(PTO2TaskSlotState *slot_state) {
