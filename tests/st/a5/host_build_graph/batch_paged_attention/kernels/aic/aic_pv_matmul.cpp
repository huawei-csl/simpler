...
static __aicore__ void pv_matmul_batch_impl(
    ...
    using GlobalB = pto::GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, K, N>, pto::Stride<K * N, K * N, K * N, N, 1>>;
    ...
    using TileMatB =
        pto::Tile<pto::TileType::Mat, bfloat16_t, K, N, pto::BLayout::ColMajor, K, N, pto::SLayout::RowMajor, 512>;
