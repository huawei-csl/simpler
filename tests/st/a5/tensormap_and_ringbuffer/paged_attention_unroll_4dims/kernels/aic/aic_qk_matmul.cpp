...
static __aicore__ void qk_matmul_n_impl(
    ...
    using GlobalA =
        pto::GlobalTensor<bfloat16_t, pto::Shape<1, BATCH, Q_LEN, M, K>, pto::Stride<1, M * K, M * K, K, 1>>;
    using GlobalB = pto::GlobalTensor<
        bfloat16_t, pto::Shape<1, 1, 1, K, N>, pto::Stride<K * N, K * N, K * N, 1, K>, pto::Layout::DN>;
    using GlobalOut = pto::GlobalTensor<float, pto::Shape<1, BATCH, Q_LEN, M, N>, pto::Stride<1, M * N, M * N, N, 1>>;
