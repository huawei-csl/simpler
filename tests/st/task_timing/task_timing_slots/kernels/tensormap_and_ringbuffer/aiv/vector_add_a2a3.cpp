 ...
 */
/**
 * Element-wise simpler::tmr::Tensor Addition Kernel
 *
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack arguments (simpler::tmr::Tensor* pointers from runtime)
    __gm__ simpler::tmr::Tensor *src0_tensor = reinterpret_cast<__gm__ simpler::tmr::Tensor *>(args[0]);
    __gm__ simpler::tmr::Tensor *src1_tensor = reinterpret_cast<__gm__ simpler::tmr::Tensor *>(args[1]);
    __gm__ simpler::tmr::Tensor *out_tensor = reinterpret_cast<__gm__ simpler::tmr::Tensor *>(args[2]);
