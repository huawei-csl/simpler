...
__attribute__((visibility("default"))) void aicpu_orchestration_entry(const ChipTaskArgs &orch_args) {
    ...
    const simpler::tmr::Tensor &f = orch_args.tensor(2).ref();  // external output, written in place
    ...
    simpler::tmr::Tensor c = c_out.get_ref(0);
    ...
    simpler::tmr::Tensor d = d_out.get_ref(0);
    ...
    simpler::tmr::Tensor e = e_out.get_ref(0);
