...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for worker_async_endpoint: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.worker_async_endpoint.test_worker_async_endpoint import TestWorkerAsyncEndpoint as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/worker_async_endpoint"
...
class TestWorkerAsyncEndpointScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestWorkerAsyncEndpointScanAndClaim.run_module(__name__)
