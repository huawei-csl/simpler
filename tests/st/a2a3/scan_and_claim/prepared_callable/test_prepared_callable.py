...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for prepared_callable: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.prepared_callable.test_prepared_callable import TestPreparedCallableHbg as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/prepared_callable"
...
class TestPreparedCallableScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestPreparedCallableScanAndClaim.run_module(__name__)
