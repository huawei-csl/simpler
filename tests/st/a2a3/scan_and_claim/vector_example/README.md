# Vector Example — Task Dependency Graph (scan_and_claim runtime)
...
python tests/st/a2a3/scan_and_claim/vector_example/test_vector_example.py -p a2a3sim

# Hardware
python tests/st/a2a3/scan_and_claim/vector_example/test_vector_example.py -p a2a3 -d 0

# Batch via pytest
pytest tests/st/a2a3/scan_and_claim/vector_example --platform a2a3sim
```
