...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for dump_args: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.dump_args.test_dump_args_example import TestDumpArgsExample as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/dump_args"
...
class TestDumpArgsScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestDumpArgsScanAndClaim.run_module(__name__)
