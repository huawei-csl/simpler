...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for worker_async_fifo: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.worker_async_fifo.test_worker_async_fifo import TestWorkerAsyncWholeRunFifo as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/worker_async_fifo"
...
class TestWorkerAsyncFifoScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestWorkerAsyncFifoScanAndClaim.run_module(__name__)
