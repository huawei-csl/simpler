...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for paged_attention_unroll: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.paged_attention_unroll.test_paged_attention_unroll import TestPagedAttentionUnrollHostBuildGraph as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/paged_attention_unroll"
...
class TestPagedAttentionUnrollScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestPagedAttentionUnrollScanAndClaim.run_module(__name__)
