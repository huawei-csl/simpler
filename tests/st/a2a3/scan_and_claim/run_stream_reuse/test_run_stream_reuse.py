...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for run_stream_reuse: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.run_stream_reuse.test_run_stream_reuse import TestRunStreamReuseHbg as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/run_stream_reuse"
...
class TestRunStreamReuseScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestRunStreamReuseScanAndClaim.run_module(__name__)
