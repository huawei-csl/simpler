...
static __aicore__ void online_update_impl(
    __gm__ Tensor *mij, __gm__ Tensor *lij, __gm__ Tensor *oi_new, __gm__ Tensor *mi,
    __gm__ Tensor *li, __gm__ Tensor *oi, uint64_t is_first, uint64_t is_last, __gm__ Tensor *dst
) {
