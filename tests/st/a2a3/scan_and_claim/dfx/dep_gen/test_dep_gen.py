...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for dfx/dep_gen: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.dfx.dep_gen.test_dep_gen import TestDepGenHostBuildGraph as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[3] / "host_build_graph/dfx/dep_gen"
...
class TestDfxDepGenScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestDfxDepGenScanAndClaim.run_module(__name__)
