...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for concurrent_prepare_stress: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.concurrent_prepare_stress.test_concurrent_prepare_stress import TestConcurrentPrepareStressHbg as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/concurrent_prepare_stress"
...
class TestConcurrentPrepareStressScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestConcurrentPrepareStressScanAndClaim.run_module(__name__)
