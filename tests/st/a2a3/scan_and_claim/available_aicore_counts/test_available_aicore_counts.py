...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for available_aicore_counts: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.available_aicore_counts.test_available_aicore_counts import TestAvailableAicoreCounts as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/available_aicore_counts"
...
class TestAvailableAicoreCountsScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestAvailableAicoreCountsScanAndClaim.run_module(__name__)
