...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for batch_paged_attention: the host_build_graph scene, same kernels
...
from tests.st.a2a3.host_build_graph.batch_paged_attention.test_batch_paged_attention import TestBatchPagedAttentionHostBuildGraph as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/batch_paged_attention"
...
if __name__ == "__main__":
    TestBatchPagedAttentionScanAndClaim.run_module(__name__)
