...
__attribute__((visibility("default"))) void aicpu_orchestration_entry(const ChipTaskArgs &orch_args) {
    ...
    const simpler::hbg::Tensor &ext_f = orch_args.tensor(2).ref();
    ...
    const simpler::hbg::Tensor &c = outs_t0.get_ref(0);
    ...
    SIMPLER_SCOPE() {
        ...
        const simpler::hbg::Tensor &d = outs_t1.get_ref(0);
        ...
        const simpler::hbg::Tensor &e = outs_t2.get_ref(0);
        ...
        const simpler::hbg::Tensor &g = outs_t3.get_ref(0);
