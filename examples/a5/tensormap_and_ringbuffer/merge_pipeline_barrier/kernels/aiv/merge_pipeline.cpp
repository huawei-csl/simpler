...
using GData = pto::GlobalTensor<float, pto::Shape<1, 1, 1, kR, kC>, pto::Stride<1, 1, 1, kC, 1>>;
using VTile = pto::Tile<pto::TileType::Vec, float, kR, kC, pto::BLayout::RowMajor, -1, -1>;
