...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack scalar: k_base_inline111__ssa_v0
    union {
        uint64_t u64;
        int64_t val;
    } k_base_inline111__ssa_v0_conv;
    k_base_inline111__ssa_v0_conv.u64 = args[5];
    int64_t k_base_inline111__ssa_v0 = k_base_inline111__ssa_v0_conv.val;
    ...
    residual_rms_cast(
        mlp_norm_in_inline71__ssa_v0, post_norm_partial_inline118__ssa_v0, attn_proj_fp32_inline220__ssa_v7,
        cur__iter_v6, post_rms_weight__ssa_v0, k_base_inline111__ssa_v0, i__idx_v0
    );
}
