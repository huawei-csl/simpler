...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *mlp_norm_in_inline71__rv_v5_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[0]);
    ...
    __gm__ ChipTensor *post_norm_partial_inline118__rv_v5_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[1]);
