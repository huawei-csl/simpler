...
extern "C" __aicore__ void kernel_entry(__gm__ int64_t *args) {
    __gm__ simpler::tmr::Tensor *input_a_tensor = reinterpret_cast<__gm__ simpler::tmr::Tensor *>(args[0]);
    __gm__ simpler::tmr::Tensor *input_b_tensor = reinterpret_cast<__gm__ simpler::tmr::Tensor *>(args[1]);
    __gm__ simpler::tmr::Tensor *c_tensor = reinterpret_cast<__gm__ simpler::tmr::Tensor *>(args[2]);
