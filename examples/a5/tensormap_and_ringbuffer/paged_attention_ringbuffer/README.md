...
```python
PA_KERNELS = "../../../../tests/st/a5/tensormap_and_ringbuffer/batch_paged_attention/kernels"
```
...
| ----------------- | ---------- | ---- |
| `ring_task_window` | 64 | Default is 16384 (`CHIP_TASK_WINDOW_SIZE`, `src/a5/runtime/tensormap_and_ringbuffer/runtime/runtime_types.h`) — **256× smaller** |
...
```bash
pytest examples/a5/tensormap_and_ringbuffer/paged_attention_ringbuffer --platform a5 --device 0
```
...
pass in `tests/st/a5/tensormap_and_ringbuffer/batch_paged_attention/` at
