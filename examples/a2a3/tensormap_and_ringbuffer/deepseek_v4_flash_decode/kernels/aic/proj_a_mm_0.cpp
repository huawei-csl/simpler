...
static __aicore__ void proj_a_mm_0(
    ...
    // pto: %nf_inline995_inline9505__ssa_v0, %23
    int64_t v25 = (int64_t)((uint64_t)((int64_t)v7) * (uint64_t)v13);
    // pto: %xa0_chunk_inline1098_inline9503__tile
    Tile<
    ...
    // pto: %o_packed_inline1065_inline9868__ssa_v0_pview
    ...
    // pto: %wa0_chunk_inline964_inline9502__tile
    Tile<
    ...
    // pto: %wa0_chunk_inline964_inline9502__tile_view2d_pview
    ...
    // pto: %wa0_chunk_inline964_inline9502__tile_t
    Tile<
    ...
    TASSIGN(v39, v40);
    // pto: %acc_a_inline1002_inline9538__tile_l0_init_storage
    Tile<
    ...
    // pto: %acc_a_inline1002_inline9538__tile_l0_a
    Tile<
    ...
    // pto: %acc_a_inline1002_inline9538__tile_l0_b
    Tile<
    ...
    // pto: %acc_a_inline1002_inline9538__tile_l0_c_first
    Tile<
        TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v51 = Tile<
    ...
    TMATMUL(v51, v43, v45);
    // pto: %acc_a_inline1002_inline9538__tile_l0_c_acc
    Tile<
        TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v53 = Tile<
    ...
    for (int64_t i55 = v17; i55 < v11; i55 += v10) {
        ...
        // pto: %xa_k_chunk_inline1112_inline9500__tile
        Tile<
            TileType::Mat, bfloat16_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
            CompactMode::Null>
            v58 = Tile<
        ...
        TLOAD(v64, v69);
        // pto: %wa_k_chunk_inline1047_inline9499__tile
        Tile<
            TileType::Mat, bfloat16_t, 128, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
            CompactMode::Null>
            v70 = Tile<
        ...
        TASSIGN(v70, v71);
        // pto: %wa_k_chunk_inline1047_inline9499__tile_view2d_pview
        ...
        // pto: %wa_k_chunk_inline1047_inline9499__tile_t
        Tile<
            TileType::Mat, bfloat16_t, 256, 128, BLayout::RowMajor, -1, -1, SLayout::ColMajor, 512, PadValue::Null,
            CompactMode::Null>
            v80 = Tile<
        ...
        TASSIGN(v80, v81);
        // pto: %acc_a_inline1002_inline9538__iter_v1_l0_a
        Tile<
            TileType::Left, bfloat16_t, 16, 128, BLayout::RowMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
            CompactMode::Normal>
            v82 = Tile<
        ...
        // pto: %acc_a_inline1002_inline9538__iter_v1_l0_b
        Tile<
            TileType::Right, bfloat16_t, 128, 128, BLayout::RowMajor, -1, -1, SLayout::ColMajor, 512, PadValue::Null,
            CompactMode::Null>
            v84 = Tile<
        ...
        // pto: %acc_a_inline1002_inline9538__iter_v1_l0_c_acc
        Tile<
            TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
            CompactMode::Null>
            v90 = Tile<
    ...
    // pto: %acc_a_inline1002_inline9538__rv_v2
    Tile<
        TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v132 = Tile<
    ...
    // pto: %o_r_pad_inline974_inline9624__iter_v1_pview
    ...
    // pto: %55, %o_r_pad_inline974_inline9624__iter_v1_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: o_packed_inline1065_inline9868__ssa_v0
    __gm__ Tensor *o_packed_inline1065_inline9868__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ bfloat16_t *o_packed_inline1065_inline9868__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(o_packed_inline1065_inline9868__ssa_v0_tensor->buffer.addr) +
        o_packed_inline1065_inline9868__ssa_v0_tensor->start_offset;

    // Unpack tensor: wo_a_l1_inline655__ssa_v0
    __gm__ Tensor *wo_a_l1_inline655__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ bfloat16_t *wo_a_l1_inline655__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(wo_a_l1_inline655__ssa_v0_tensor->buffer.addr) +
        wo_a_l1_inline655__ssa_v0_tensor->start_offset;

    // Unpack tensor: o_r_pad_inline974_inline9624__iter_v1
    __gm__ Tensor *o_r_pad_inline974_inline9624__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *o_r_pad_inline974_inline9624__iter_v1 =
        reinterpret_cast<__gm__ float *>(o_r_pad_inline974_inline9624__iter_v1_tensor->buffer.addr) +
        o_r_pad_inline974_inline9624__iter_v1_tensor->start_offset;

    // Unpack scalar: row_base_o_inline1126_inline9507__ssa_v0
    union {
        uint64_t u64;
        int64_t val;
    } row_base_o_inline1126_inline9507__ssa_v0_conv;
    row_base_o_inline1126_inline9507__ssa_v0_conv.u64 = args[3];
    int64_t row_base_o_inline1126_inline9507__ssa_v0 = row_base_o_inline1126_inline9507__ssa_v0_conv.val;
    ...
    // Unpack scalar: out_col_g_inline1092_inline9662__ssa_v0
    union {
        uint64_t u64;
        int64_t val;
    } out_col_g_inline1092_inline9662__ssa_v0_conv;
    out_col_g_inline1092_inline9662__ssa_v0_conv.u64 = args[5];
    int64_t out_col_g_inline1092_inline9662__ssa_v0 = out_col_g_inline1092_inline9662__ssa_v0_conv.val;

    // Forward to ptoas-generated function
    proj_a_mm_0(
        o_packed_inline1065_inline9868__ssa_v0, wo_a_l1_inline655__ssa_v0, o_r_pad_inline974_inline9624__iter_v1,
        row_base_o_inline1126_inline9507__ssa_v0, g_inline978_inline9508__idx_v0,
        out_col_g_inline1092_inline9662__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
