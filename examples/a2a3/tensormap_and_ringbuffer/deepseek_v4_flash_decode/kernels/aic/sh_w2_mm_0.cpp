...
static __aicore__ void sh_w2_mm_0(__gm__ int8_t *v1, __gm__ int8_t *v2, __gm__ int32_t *v3, int32_t v4, int32_t v5) {
    ...
    // pto: %y_acc_inline2627_inline9951__phi_v5
    Tile<
    ...
    TASSIGN(v19, v20);
    // pto: %y_acc_inline2627_inline9951__tile_l0_c_phi
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v21 = Tile<
    ...
    TASSIGN(v21, v22);
    // pto: %db_idx_inline2650_inline10149__ssa_v0, %19
    int64_t v23 = (int64_t)((uint64_t)((int64_t)v4) * (uint64_t)v9);
    // pto: %y_acc_inline2627_inline9951__tile
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v24 = Tile<
    ...
    for (int64_t i26 = v18; i26 < v12; i26 += v8) {
        // pto: %hs_k_inline2625_inline10085__tile
        Tile<
        ...
        // pto: %h_tile_i8_inline2663_inline9935__rv_v2_pview
        ...
        TLOAD(v27, v32);
        // pto: %sw2_k_inline2624_inline9999__tile
        Tile<
        ...
        // pto: %shared_w2_l1_inline637__ssa_v0_pview
        ...
        if (i26 == v18) {
            // pto: %sw2_k_inline2624_inline9999__tile_t
            Tile<
            ...
            TASSIGN(v51, v52);
            // pto: %y_acc_inline2627_inline9951__tile_l0_init
            Tile<
                TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                CompactMode::Null>
                v53 = Tile<
            ...
            for (int64_t j55 = v18; j55 < v7; j55 += v9) {
                // pto: %y_acc_inline2627_inline9951__tile_l0_a
                Tile<
                ...
                // pto: %y_acc_inline2627_inline9951__tile_l0_b
                Tile<
                ...
                if (j55 == v18) {
                    // pto: %y_acc_inline2627_inline9951__tile_l0_c_first
                    Tile<
                    ...
                    // pto: %y_acc_inline2627_inline9951__tile_l0_c_acc
                    Tile<
                        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                        PadValue::Null, CompactMode::Null>
                        v67 = Tile<
    ...
    // pto: %y_i32_inline2673_inline10147__ssa_v0_pview
    ...
    // pto: %40, %y_i32_inline2673_inline10147__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: h_tile_i8_inline2663_inline9935__rv_v2
    __gm__ Tensor *h_tile_i8_inline2663_inline9935__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ int8_t *h_tile_i8_inline2663_inline9935__rv_v2 =
        reinterpret_cast<__gm__ int8_t *>(h_tile_i8_inline2663_inline9935__rv_v2_tensor->buffer.addr) +
        h_tile_i8_inline2663_inline9935__rv_v2_tensor->start_offset;

    // Unpack tensor: shared_w2_l1_inline637__ssa_v0
    __gm__ Tensor *shared_w2_l1_inline637__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *shared_w2_l1_inline637__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(shared_w2_l1_inline637__ssa_v0_tensor->buffer.addr) +
        shared_w2_l1_inline637__ssa_v0_tensor->start_offset;

    // Unpack tensor: y_i32_inline2673_inline10147__ssa_v0
    __gm__ Tensor *y_i32_inline2673_inline10147__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ int32_t *y_i32_inline2673_inline10147__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(y_i32_inline2673_inline10147__ssa_v0_tensor->buffer.addr) +
        y_i32_inline2673_inline10147__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    sh_w2_mm_0(
        h_tile_i8_inline2663_inline9935__rv_v2, shared_w2_l1_inline637__ssa_v0, y_i32_inline2673_inline10147__ssa_v0,
