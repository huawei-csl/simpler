 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: qr_proj_matmul_2
...
static __aicore__ void qr_proj_matmul_2(
    ...
    // pto: %q_acc_inline1291_inline11717__phi_v5
    Tile<
    ...
    TASSIGN(v30, v31);
    // pto: %qbg_idx_inline1226_inline11489__ssa_v0
    ...
    for (int64_t i36 = v24; i36 < (v4 / v13); i36 += v17) {
        ...
        // pto: %q_acc_inline1291_inline11717__tile
        Tile<
            TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
            CompactMode::Null>
            v38 = Tile<
        ...
        for (int64_t j40 = v24; j40 < v12; j40 += v16) {
            ...
            // pto: %q_x_chunk_bf16_inline1248_inline11666__tile
            Tile<
            ...
            TLOAD(v46, v55);
            // pto: %w_chunk_inline1192_inline11510__tile
            Tile<
            ...
            // pto: %wq_a_hca_inline528__ssa_v0_pview
            ...
            if (j40 == v24) {
                // pto: %q_acc_inline1291_inline11717__tile_l0_init_storage
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v76 = Tile<
                ...
                // pto: %q_acc_inline1291_inline11717__tile_l0_a
                Tile<
                ...
                // pto: %q_acc_inline1291_inline11717__tile_l0_b
                Tile<
                ...
                // pto: %q_acc_inline1291_inline11717__tile_l0_c_first
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v86 = Tile<
                ...
                pipe_barrier(PIPE_M);
                TMATMUL(v86, v78, v80);
                // pto: %q_acc_inline1291_inline11717__tile_l0_c_acc
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v88 = Tile<
        ...
        // pto: %qr_partials_inline1197_inline11540__iter_v1_pview
        ...
        // pto: %44, %qr_partials_inline1197_inline11540__iter_v1_pview, %45
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: qr_partials_inline1197_inline11540__ssa_v0
    __gm__ Tensor *qr_partials_inline1197_inline11540__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *qr_partials_inline1197_inline11540__ssa_v0 =
        reinterpret_cast<__gm__ float *>(qr_partials_inline1197_inline11540__ssa_v0_tensor->buffer.addr) +
        qr_partials_inline1197_inline11540__ssa_v0_tensor->start_offset;
    ...
    // Unpack tensor: wq_a_hca_inline528__ssa_v0
    __gm__ Tensor *wq_a_hca_inline528__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ bfloat16_t *wq_a_hca_inline528__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(wq_a_hca_inline528__ssa_v0_tensor->buffer.addr) +
        wq_a_hca_inline528__ssa_v0_tensor->start_offset;
    ...
    // Extract dynamic dim: qr_partial_rows_inline1240_inline11631__ssa_v0
    int64_t qr_partial_rows_inline1240_inline11631__ssa_v0 =
        static_cast<int64_t>(qr_partials_inline1197_inline11540__ssa_v0_tensor->shapes[0]);
    ...
    qr_proj_matmul_2(
        qr_partials_inline1197_inline11540__ssa_v0, x_view_inline1221_inline11524__ssa_v0, wq_a_hca_inline528__ssa_v0,
        t_matmul_inline1250_inline11559__ssa_v0, t_dim_inline1283_inline11618__ssa_v0,
        qr_partial_rows_inline1240_inline11631__ssa_v0, t_dim_inline1283_inline11618__ssa_v0_1, __pypto_spmd_block_idx,
