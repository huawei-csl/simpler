...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *qr_partials_inline1197_inline11540__ssa_v0_tensor =
    ...
    __gm__ ChipTensor *wq_a_hca_inline528__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[2]);
