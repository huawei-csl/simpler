...
static __aicore__ void exp_gate_mm_1(
    ...
    // pto: %gate_acc_inline2785_inline11258__phi_v5
    Tile<
    ...
    TASSIGN(v23, v24);
    // pto: %gate_acc_inline2785_inline11258__tile_l0_c_phi
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v25 = Tile<
    ...
    for (int64_t i27 = v22; i27 < v10; i27 += v13) {
        ...
        for (int64_t j31 = v22; j31 < v15; j31 += v11) {
            // pto: %x_k_inline2772_inline11031__tile
            Tile<
            ...
            TLOAD(v39, v45);
            // pto: %w1_k_inline2790_inline11148__tile
            Tile<
            ...
            // pto: %w1_k_inline2790_inline11148__tile_view2d_pview
            ...
            if (j31 == v22) {
                // pto: %w1_k_inline2790_inline11148__tile_t
                Tile<
                ...
                TASSIGN(v53, v54);
                // pto: %gate_acc_inline2785_inline11258__tile_l0_init
                Tile<
                    TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v55 = Tile<
                ...
                for (int64_t k57 = v22; k57 < v12; k57 += v9) {
                    // pto: %gate_acc_inline2785_inline11258__tile_l0_a
                    Tile<
                    ...
                    // pto: %gate_acc_inline2785_inline11258__tile_l0_b
                    Tile<
                    ...
                    if (k57 == v22) {
                        // pto: %gate_acc_inline2785_inline11258__tile_l0_c_first
                        Tile<
                            TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v67 = Tile<
                        ...
                        // pto: %gate_acc_inline2785_inline11258__tile_l0_c_acc
                        Tile<
                            TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v69 = Tile<
                ...
                for (int64_t k75 = v22; k75 < v12; k75 += v9) {
                    // pto: %gate_acc_inline2785_inline11258__iter_v1_l0_a
                    Tile<
                        TileType::Left, int8_t, 16, 128, BLayout::RowMajor, -1, -1, SLayout::RowMajor, 512,
                        PadValue::Null, CompactMode::Null>
                        v76 = Tile<
                    ...
                    // pto: %gate_acc_inline2785_inline11258__iter_v1_l0_b
                    Tile<
                        TileType::Right, int8_t, 128, 256, BLayout::RowMajor, -1, -1, SLayout::ColMajor, 512,
                        PadValue::Null, CompactMode::Null>
                        v78 = Tile<
                    ...
                    // pto: %gate_acc_inline2785_inline11258__iter_v1_l0_c_acc
                    Tile<
                        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                        PadValue::Null, CompactMode::Null>
                        v85 = Tile<
        ...
        TASSIGN(v110, v111);
        // pto: %gate_tile_i32_inline2749_inline11102__iter_v1_pview
        ...
        // pto: %45, %gate_tile_i32_inline2749_inline11102__iter_v1_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: gate_tile_i32_inline2749_inline11102__ssa_v0
    __gm__ Tensor *gate_tile_i32_inline2749_inline11102__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ int32_t *gate_tile_i32_inline2749_inline11102__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(gate_tile_i32_inline2749_inline11102__ssa_v0_tensor->buffer.addr) +
        gate_tile_i32_inline2749_inline11102__ssa_v0_tensor->start_offset;
    ...
    // Unpack tensor: routed_w1_csa_inline536__ssa_v0
    __gm__ Tensor *routed_w1_csa_inline536__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ int8_t *routed_w1_csa_inline536__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(routed_w1_csa_inline536__ssa_v0_tensor->buffer.addr) +
        routed_w1_csa_inline536__ssa_v0_tensor->start_offset;
    ...
    exp_gate_mm_1(
        gate_tile_i32_inline2749_inline11102__ssa_v0, recv_x_flat_inline2781_inline11205__ssa_v0,
        routed_w1_csa_inline536__ssa_v0, flat_t0_inline2786_inline11215__ssa_v0, local_i_inline2779_inline10990__idx_v0,
