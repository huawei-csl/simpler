...
sh_up_mm_2(__gm__ int8_t *v1, __gm__ int8_t *v2, __gm__ int32_t *v3, int64_t v4, int32_t v5, int32_t v6) {
    ...
    // pto: %up_acc_inline2647_inline12000__phi_v5
    Tile<
    ...
    TASSIGN(v21, v22);
    // pto: %up_acc_inline2647_inline12000__tile_l0_c_phi
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v23 = Tile<
    ...
    TASSIGN(v23, v24);
    // pto: %nb_idx_inline2638_inline11861__ssa_v0, %19
    int64_t v25 = (int64_t)((uint64_t)((int64_t)v5) * (uint64_t)v10);
    // pto: %up_acc_inline2647_inline12000__tile
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v26 = Tile<
    ...
    for (int64_t i28 = v20; i28 < v13; i28 += v9) {
        ...
        TLOAD(v29, v35);
        // pto: %sw3_k_inline2644_inline11868__tile
        Tile<
        ...
        // pto: %shared_w3_hca_inline735__ssa_v0_pview
        ...
        if (i28 == v20) {
            // pto: %sw3_k_inline2644_inline11868__tile_t
            Tile<
            ...
            TASSIGN(v54, v55);
            // pto: %up_acc_inline2647_inline12000__tile_l0_init_storage
            Tile<
                TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                CompactMode::Null>
                v56 = Tile<
            ...
            for (int64_t j58 = v20; j58 < v8; j58 += v10) {
                // pto: %up_acc_inline2647_inline12000__tile_l0_a
                Tile<
                ...
                // pto: %up_acc_inline2647_inline12000__tile_l0_b
                Tile<
                ...
                if (j58 == v20) {
                    // pto: %up_acc_inline2647_inline12000__tile_l0_c_first
                    Tile<
                    ...
                    // pto: %up_acc_inline2647_inline12000__tile_l0_c_acc
                    Tile<
                        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                        PadValue::Null, CompactMode::Null>
                        v70 = Tile<
    ...
    // pto: %up_i32_inline2654_inline11954__ssa_v0_pview
    ...
    // pto: %42, %up_i32_inline2654_inline11954__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: shared_w3_hca_inline735__ssa_v0
    __gm__ Tensor *shared_w3_hca_inline735__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *shared_w3_hca_inline735__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(shared_w3_hca_inline735__ssa_v0_tensor->buffer.addr) +
        shared_w3_hca_inline735__ssa_v0_tensor->start_offset;

    // Unpack tensor: up_i32_inline2654_inline11954__ssa_v0
    __gm__ Tensor *up_i32_inline2654_inline11954__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ int32_t *up_i32_inline2654_inline11954__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(up_i32_inline2654_inline11954__ssa_v0_tensor->buffer.addr) +
        up_i32_inline2654_inline11954__ssa_v0_tensor->start_offset;
    ...
    sh_up_mm_2(
        x_norm_i8_inline11951__rv_v2, shared_w3_hca_inline735__ssa_v0, up_i32_inline2654_inline11954__ssa_v0,
