...
idx_qr_proj_matmul(__gm__ int32_t *v1, __gm__ int8_t *v2, __gm__ int8_t *v3, int32_t v4, int32_t v5) {
    ...
    // pto: %qr_acc_inline1974_inline10860__phi_v5
    Tile<
    ...
    TASSIGN(v23, v24);
    // pto: %qr_acc_inline1974_inline10860__tile_l0_c_phi
    Tile<
        TileType::Acc, int32_t, 16, 512, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v25 = Tile<
    ...
    TASSIGN(v25, v26);
    // pto: %ot_inline1983_inline10555__ssa_v0, %17
    ...
    for (int64_t i28 = v22; i28 < v16; i28 += v12) {
        // pto: %qr_acc_inline1974_inline10860__tile
        Tile<
            TileType::Acc, int32_t, 16, 512, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
            CompactMode::Null>
            v29 = Tile<
        ...
        for (int64_t j31 = v22; j31 < v11; j31 += v10) {
            ...
            // pto: %qr_tile_inline1993_inline10496__tile
            Tile<
            ...
            // pto: %qr_inline10562__ssa_v0_pview
            ...
            TLOAD(v34, v39);
            // pto: %wq_tile_inline1988_inline10375__tile
            Tile<
            ...
            // pto: %csa_idx_wq_b_csa_inline556__ssa_v0_pview
            ...
            if (v32 == v22) {
                // pto: %qr_acc_inline1974_inline10860__tile_l0_init_storage
                Tile<
                    TileType::Acc, int32_t, 16, 512, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v58 = Tile<
                ...
                for (int64_t k60 = v22; k60 < v9; k60 += v8) {
                    // pto: %qr_acc_inline1974_inline10860__tile_l0_a
                    Tile<
                    ...
                    // pto: %qr_acc_inline1974_inline10860__tile_l0_b
                    Tile<
                    ...
                    if (k60 == v22) {
                        // pto: %qr_acc_inline1974_inline10860__tile_l0_c_first
                        Tile<
                            TileType::Acc, int32_t, 16, 512, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v70 = Tile<
                        ...
                        // pto: %qr_acc_inline1974_inline10860__tile_l0_c_acc
                        Tile<
                            TileType::Acc, int32_t, 16, 512, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v72 = Tile<
        ...
        // pto: %qr_acc_pad_inline2023_inline10773__iter_v1_pview
        ...
        // pto: %42, %qr_acc_pad_inline2023_inline10773__iter_v1_pview
        GlobalTensor<
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: qr_acc_pad_inline2023_inline10773__ssa_v0
    __gm__ Tensor *qr_acc_pad_inline2023_inline10773__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ int32_t *qr_acc_pad_inline2023_inline10773__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(qr_acc_pad_inline2023_inline10773__ssa_v0_tensor->buffer.addr) +
        qr_acc_pad_inline2023_inline10773__ssa_v0_tensor->start_offset;

    // Unpack tensor: qr_inline10562__ssa_v0
    __gm__ Tensor *qr_inline10562__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *qr_inline10562__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(qr_inline10562__ssa_v0_tensor->buffer.addr) +
        qr_inline10562__ssa_v0_tensor->start_offset;

    // Unpack tensor: csa_idx_wq_b_csa_inline556__ssa_v0
    __gm__ Tensor *csa_idx_wq_b_csa_inline556__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ int8_t *csa_idx_wq_b_csa_inline556__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(csa_idx_wq_b_csa_inline556__ssa_v0_tensor->buffer.addr) +
        csa_idx_wq_b_csa_inline556__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    idx_qr_proj_matmul(
        qr_acc_pad_inline2023_inline10773__ssa_v0, qr_inline10562__ssa_v0, csa_idx_wq_b_csa_inline556__ssa_v0,
