...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *partials_inline1608_inline11714__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    ...
    __gm__ Tensor *o_r_i8_pad_inline1462_inline11408__rv_v4_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    __gm__ Tensor *wo_b_hca_inline521__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
