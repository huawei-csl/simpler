...
static __aicore__ void proj_b_mm_3(
    ...
    // pto: %acc_b_inline2089_inline12211__phi_v5
    Tile<
    ...
    for (int64_t i26 = v23; i26 < v13; i26 += v15) {
        ...
        for (int64_t j30 = v23; j30 < v11; j30 += v13) {
            ...
            if (j30 == v23) {
                // pto: %b_act_inline2084_inline12174__tile
                Tile<
                ...
                // pto: %o_r_i8_pad_inline2082_inline12196__rv_v4_pview
                ...
                // pto: %b_weight_inline2204_inline12173__tile
                Tile<
                ...
                TASSIGN(v40, v41);
                // pto: %wo_b_last_inline545__ssa_v0_pview
                ...
                // pto: %30, %wo_b_last_inline545__ssa_v0_pview
                GlobalTensor<
                ...
                // pto: %b_weight_inline2204_inline12173__tile_t
                Tile<
                ...
                TASSIGN(v45, v46);
                // pto: %acc_b_inline2089_inline12211__tile_l0_init
                Tile<
                    TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v47 = Tile<
                ...
                TASSIGN(v47, v48);
                // pto: %acc_b_inline2089_inline12211__tile_l0_a
                Tile<
                ...
                // pto: %acc_b_inline2089_inline12211__tile_l0_b
                Tile<
                ...
                // pto: %acc_b_inline2089_inline12211__tile_l0_c_first
                Tile<
                    TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v57 = Tile<
                ...
                pipe_barrier(PIPE_M);
                TMATMUL(v57, v49, v51);
                // pto: %acc_b_inline2089_inline12211__tile_l0_c_acc
                Tile<
                    TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v59 = Tile<
        ...
        // pto: %partials_inline2126_inline12241__iter_v3_pview
        ...
        // pto: %44, %partials_inline2126_inline12241__iter_v3_pview
        GlobalTensor<
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: partials_inline2126_inline12241__iter_v1
    __gm__ Tensor *partials_inline2126_inline12241__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ int32_t *partials_inline2126_inline12241__iter_v1 =
        reinterpret_cast<__gm__ int32_t *>(partials_inline2126_inline12241__iter_v1_tensor->buffer.addr) +
        partials_inline2126_inline12241__iter_v1_tensor->start_offset;

    // Unpack tensor: o_r_i8_pad_inline2082_inline12196__rv_v4
    __gm__ Tensor *o_r_i8_pad_inline2082_inline12196__rv_v4_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *o_r_i8_pad_inline2082_inline12196__rv_v4 =
        reinterpret_cast<__gm__ int8_t *>(o_r_i8_pad_inline2082_inline12196__rv_v4_tensor->buffer.addr) +
        o_r_i8_pad_inline2082_inline12196__rv_v4_tensor->start_offset;

    // Unpack tensor: wo_b_last_inline545__ssa_v0
    __gm__ Tensor *wo_b_last_inline545__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ int8_t *wo_b_last_inline545__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(wo_b_last_inline545__ssa_v0_tensor->buffer.addr) +
        wo_b_last_inline545__ssa_v0_tensor->start_offset;

    // Unpack scalar: n0_inline2077_inline12193__ssa_v0
    union {
        uint64_t u64;
        int64_t val;
    } n0_inline2077_inline12193__ssa_v0_conv;
    n0_inline2077_inline12193__ssa_v0_conv.u64 = args[3];
    int64_t n0_inline2077_inline12193__ssa_v0 = n0_inline2077_inline12193__ssa_v0_conv.val;
    ...
    col_g_inline2196_inline12308__ssa_v0_conv.u64 = args[4];
    ...
    g_inline2162_inline12195__idx_v0_conv.u64 = args[5];
    int64_t g_inline2162_inline12195__idx_v0 = g_inline2162_inline12195__idx_v0_conv.val;

    // Forward to ptoas-generated function
    proj_b_mm_3(
        partials_inline2126_inline12241__iter_v1, o_r_i8_pad_inline2082_inline12196__rv_v4, wo_b_last_inline545__ssa_v0,
        n0_inline2077_inline12193__ssa_v0, col_g_inline2196_inline12308__ssa_v0, g_inline2162_inline12195__idx_v0,
