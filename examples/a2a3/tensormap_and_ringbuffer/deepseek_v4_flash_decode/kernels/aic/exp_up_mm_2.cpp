...
exp_up_mm_2(__gm__ int32_t *v1, __gm__ int8_t *v2, __gm__ int8_t *v3, int64_t v4, int64_t v5, int32_t v6, int32_t v7) {
    ...
    // pto: %up_acc_inline2775_inline11984__phi_v5
    Tile<
    ...
    TASSIGN(v23, v24);
    // pto: %up_acc_inline2775_inline11984__tile_l0_c_phi
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v25 = Tile<
    ...
    for (int64_t i27 = v22; i27 < v10; i27 += v13) {
        ...
        for (int64_t j31 = v22; j31 < v15; j31 += v11) {
            // pto: %x_u_inline2768_inline12142__tile
            Tile<
            ...
            TLOAD(v39, v45);
            // pto: %w3_k_inline2777_inline12144__tile
            Tile<
            ...
            // pto: %w3_k_inline2777_inline12144__tile_view2d_pview
            ...
            if (j31 == v22) {
                // pto: %w3_k_inline2777_inline12144__tile_t
                Tile<
                ...
                TASSIGN(v53, v54);
                // pto: %up_acc_inline2775_inline11984__tile_l0_init
                Tile<
                    TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v55 = Tile<
                ...
                for (int64_t k57 = v22; k57 < v12; k57 += v9) {
                    // pto: %up_acc_inline2775_inline11984__tile_l0_a
                    Tile<
                    ...
                    // pto: %up_acc_inline2775_inline11984__tile_l0_b
                    Tile<
                    ...
                    if (k57 == v22) {
                        // pto: %up_acc_inline2775_inline11984__tile_l0_c_first
                        Tile<
                            TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v67 = Tile<
                        ...
                        // pto: %up_acc_inline2775_inline11984__tile_l0_c_acc
                        Tile<
                            TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v69 = Tile<
                ...
                for (int64_t k75 = v22; k75 < v12; k75 += v9) {
                    // pto: %up_acc_inline2775_inline11984__iter_v1_l0_a
                    Tile<
                        TileType::Left, int8_t, 16, 128, BLayout::RowMajor, -1, -1, SLayout::RowMajor, 512,
                        PadValue::Null, CompactMode::Null>
                        v76 = Tile<
                    ...
                    // pto: %up_acc_inline2775_inline11984__iter_v1_l0_b
                    Tile<
                        TileType::Right, int8_t, 128, 256, BLayout::RowMajor, -1, -1, SLayout::ColMajor, 512,
                        PadValue::Null, CompactMode::Null>
                        v78 = Tile<
                    ...
                    // pto: %up_acc_inline2775_inline11984__iter_v1_l0_c_acc
                    Tile<
                        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                        PadValue::Null, CompactMode::Null>
                        v85 = Tile<
        ...
        TASSIGN(v110, v111);
        // pto: %up_tile_i32_inline2764_inline12061__iter_v1_pview
        ...
        // pto: %45, %up_tile_i32_inline2764_inline12061__iter_v1_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: up_tile_i32_inline2764_inline12061__ssa_v0
    __gm__ Tensor *up_tile_i32_inline2764_inline12061__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ int32_t *up_tile_i32_inline2764_inline12061__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(up_tile_i32_inline2764_inline12061__ssa_v0_tensor->buffer.addr) +
        up_tile_i32_inline2764_inline12061__ssa_v0_tensor->start_offset;
    ...
    // Unpack tensor: routed_w3_hca_inline590__ssa_v0
    __gm__ Tensor *routed_w3_hca_inline590__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ int8_t *routed_w3_hca_inline590__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(routed_w3_hca_inline590__ssa_v0_tensor->buffer.addr) +
        routed_w3_hca_inline590__ssa_v0_tensor->start_offset;
    ...
    exp_up_mm_2(
        up_tile_i32_inline2764_inline12061__ssa_v0, recv_x_flat_inline2781_inline12084__ssa_v0,
        routed_w3_hca_inline590__ssa_v0, flat_t0_inline2786_inline12094__ssa_v0, local_i_inline2779_inline11869__idx_v0,
