 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: qproj_matmul_3
...
static __aicore__ void qproj_matmul_3(
    ...
    // pto: %col_acc_inline1776_inline12666__phi_v5
    Tile<
    ...
    TASSIGN(v22, v23);
    // pto: %qproj_n_idx_inline1724_inline12625__ssa_v0, %16
    ...
    for (int64_t i25 = v21; i25 < (v5 / v12); i25 += v14) {
        ...
        // pto: %col_acc_inline1776_inline12666__tile
        Tile<
            TileType::Acc, int32_t, 16, 512, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
            CompactMode::Null>
            v27 = Tile<
        ...
        for (int64_t j29 = v21; j29 < v11; j29 += v10) {
            ...
            // pto: %qr_i8_chunk_inline1684_inline12799__tile
            Tile<
            ...
            // pto: %qr_i8_matmul_inline1775_inline12282__rv_v2_pview
            ...
            TLOAD(v32, v38);
            // pto: %wq_chunk_inline1795_inline12336__tile
            Tile<
            ...
            // pto: %wq_b_last_inline703__ssa_v0_pview
            ...
            if (v30 == v21) {
                // pto: %col_acc_inline1776_inline12666__tile_l0_init
                Tile<
                    TileType::Acc, int32_t, 16, 512, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v56 = Tile<
                ...
                TASSIGN(v56, v57);
                // pto: %col_acc_inline1776_inline12666__tile_l0_a
                Tile<
                ...
                // pto: %col_acc_inline1776_inline12666__tile_l0_b
                Tile<
                ...
                // pto: %col_acc_inline1776_inline12666__tile_l0_c_first
                Tile<
                    TileType::Acc, int32_t, 16, 512, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v66 = Tile<
                ...
                pipe_barrier(PIPE_M);
                TMATMUL(v66, v58, v60);
                // pto: %col_acc_inline1776_inline12666__tile_l0_c_acc
                Tile<
                    TileType::Acc, int32_t, 16, 512, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v68 = Tile<
        ...
        // pto: %q_proj_i32_inline1756_inline12345__iter_v1_pview
        ...
        // pto: %33, %q_proj_i32_inline1756_inline12345__iter_v1_pview, %34
        GlobalTensor<
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Extract dynamic dim: t_matmul_inline1739_inline12394__ssa_v0_1
    int64_t t_matmul_inline1739_inline12394__ssa_v0_1 =
        static_cast<int64_t>(q_proj_i32_inline1756_inline12345__ssa_v0_tensor->shapes[0]);

    // Forward to ptoas-generated function
    qproj_matmul_3(
        q_proj_i32_inline1756_inline12345__ssa_v0, qr_i8_matmul_inline1775_inline12282__rv_v2,
        wq_b_last_inline703__ssa_v0, t_matmul_inline1739_inline12394__ssa_v0, t_matmul_inline1739_inline12394__ssa_v0_1,
