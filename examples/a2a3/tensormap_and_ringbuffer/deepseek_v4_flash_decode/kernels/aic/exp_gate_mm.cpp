...
exp_gate_mm(__gm__ int32_t *v1, __gm__ int8_t *v2, __gm__ int8_t *v3, int64_t v4, int64_t v5, int32_t v6, int32_t v7) {
    ...
    // pto: %gate_acc_inline2785_inline9451__phi_v5
    Tile<
    ...
    TASSIGN(v23, v24);
    // pto: %gate_acc_inline2785_inline9451__tile_l0_c_phi
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v25 = Tile<
    ...
    for (int64_t i27 = v22; i27 < v10; i27 += v13) {
        ...
        for (int64_t j31 = v22; j31 < v15; j31 += v11) {
            // pto: %x_k_inline2772_inline9224__tile
            Tile<
            ...
            // pto: %recv_x_flat_inline2781_inline9398__ssa_v0_pview
            ...
            TLOAD(v39, v45);
            // pto: %w1_k_inline2790_inline9341__tile
            Tile<
            ...
            // pto: %w1_k_inline2790_inline9341__tile_view2d_pview
            ...
            if (j31 == v22) {
                // pto: %w1_k_inline2790_inline9341__tile_t
                Tile<
                ...
                TASSIGN(v53, v54);
                // pto: %gate_acc_inline2785_inline9451__tile_l0_init
                Tile<
                    TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v55 = Tile<
                ...
                for (int64_t k57 = v22; k57 < v12; k57 += v9) {
                    // pto: %gate_acc_inline2785_inline9451__tile_l0_a
                    Tile<
                    ...
                    // pto: %gate_acc_inline2785_inline9451__tile_l0_b
                    Tile<
                    ...
                    if (k57 == v22) {
                        // pto: %gate_acc_inline2785_inline9451__tile_l0_c_first
                        Tile<
                            TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v67 = Tile<
                        ...
                        // pto: %gate_acc_inline2785_inline9451__tile_l0_c_acc
                        Tile<
                            TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v69 = Tile<
                ...
                for (int64_t k75 = v22; k75 < v12; k75 += v9) {
                    // pto: %gate_acc_inline2785_inline9451__iter_v1_l0_a
                    Tile<
                        TileType::Left, int8_t, 16, 128, BLayout::RowMajor, -1, -1, SLayout::RowMajor, 512,
                        PadValue::Null, CompactMode::Null>
                        v76 = Tile<
                    ...
                    // pto: %gate_acc_inline2785_inline9451__iter_v1_l0_b
                    Tile<
                        TileType::Right, int8_t, 128, 256, BLayout::RowMajor, -1, -1, SLayout::ColMajor, 512,
                        PadValue::Null, CompactMode::Null>
                        v78 = Tile<
                    ...
                    // pto: %gate_acc_inline2785_inline9451__iter_v1_l0_c_acc
                    Tile<
                        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                        PadValue::Null, CompactMode::Null>
                        v85 = Tile<
        ...
        TASSIGN(v110, v111);
        // pto: %gate_tile_i32_inline2749_inline9295__iter_v1_pview
        ...
        // pto: %45, %gate_tile_i32_inline2749_inline9295__iter_v1_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: gate_tile_i32_inline2749_inline9295__ssa_v0
    __gm__ Tensor *gate_tile_i32_inline2749_inline9295__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ int32_t *gate_tile_i32_inline2749_inline9295__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(gate_tile_i32_inline2749_inline9295__ssa_v0_tensor->buffer.addr) +
        gate_tile_i32_inline2749_inline9295__ssa_v0_tensor->start_offset;

    // Unpack tensor: recv_x_flat_inline2781_inline9398__ssa_v0
    __gm__ Tensor *recv_x_flat_inline2781_inline9398__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *recv_x_flat_inline2781_inline9398__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(recv_x_flat_inline2781_inline9398__ssa_v0_tensor->buffer.addr) +
        recv_x_flat_inline2781_inline9398__ssa_v0_tensor->start_offset;

    // Unpack tensor: routed_w1_l0_inline564__ssa_v0
    __gm__ Tensor *routed_w1_l0_inline564__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ int8_t *routed_w1_l0_inline564__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(routed_w1_l0_inline564__ssa_v0_tensor->buffer.addr) +
        routed_w1_l0_inline564__ssa_v0_tensor->start_offset;

    // Unpack scalar: flat_t0_inline2786_inline9408__ssa_v0
    union {
        uint64_t u64;
        int64_t val;
    } flat_t0_inline2786_inline9408__ssa_v0_conv;
    flat_t0_inline2786_inline9408__ssa_v0_conv.u64 = args[3];
    int64_t flat_t0_inline2786_inline9408__ssa_v0 = flat_t0_inline2786_inline9408__ssa_v0_conv.val;
    ...
    local_i_inline2779_inline9183__idx_v0_conv.u64 = args[4];
    int64_t local_i_inline2779_inline9183__idx_v0 = local_i_inline2779_inline9183__idx_v0_conv.val;

    // Forward to ptoas-generated function
    exp_gate_mm(
        gate_tile_i32_inline2749_inline9295__ssa_v0, recv_x_flat_inline2781_inline9398__ssa_v0,
        routed_w1_l0_inline564__ssa_v0, flat_t0_inline2786_inline9408__ssa_v0, local_i_inline2779_inline9183__idx_v0,
