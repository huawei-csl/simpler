...
sh_gate_mm_1(__gm__ int8_t *v1, __gm__ int8_t *v2, __gm__ int32_t *v3, int64_t v4, int32_t v5, int32_t v6) {
    ...
    // pto: %gate_acc_inline2643_inline11111__phi_v5
    Tile<
    ...
    TASSIGN(v21, v22);
    // pto: %gate_acc_inline2643_inline11111__tile_l0_c_phi
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v23 = Tile<
    ...
    TASSIGN(v23, v24);
    // pto: %nb_idx_inline2639_inline11221__ssa_v0, %19
    int64_t v25 = (int64_t)((uint64_t)((int64_t)v5) * (uint64_t)v10);
    // pto: %gate_acc_inline2643_inline11111__tile
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v26 = Tile<
    ...
    for (int64_t i28 = v20; i28 < v13; i28 += v9) {
        // pto: %xs_k_inline2636_inline10984__tile
        Tile<
        ...
        // pto: %x_norm_i8_inline11072__rv_v2_pview
        ...
        TLOAD(v29, v35);
        // pto: %sw1_k_inline2635_inline10983__tile
        Tile<
        ...
        // pto: %shared_w1_csa_inline532__ssa_v0_pview
        ...
        if (i28 == v20) {
            // pto: %sw1_k_inline2635_inline10983__tile_t
            Tile<
            ...
            TASSIGN(v54, v55);
            // pto: %gate_acc_inline2643_inline11111__tile_l0_init_storage
            Tile<
                TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                CompactMode::Null>
                v56 = Tile<
            ...
            for (int64_t j58 = v20; j58 < v8; j58 += v10) {
                // pto: %gate_acc_inline2643_inline11111__tile_l0_a
                Tile<
                ...
                // pto: %gate_acc_inline2643_inline11111__tile_l0_b
                Tile<
                ...
                if (j58 == v20) {
                    // pto: %gate_acc_inline2643_inline11111__tile_l0_c_first
                    Tile<
                    ...
                    // pto: %gate_acc_inline2643_inline11111__tile_l0_c_acc
                    Tile<
                        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                        PadValue::Null, CompactMode::Null>
                        v70 = Tile<
    ...
    // pto: %gate_i32_inline2662_inline11084__ssa_v0_pview
    ...
    // pto: %42, %gate_i32_inline2662_inline11084__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *x_norm_i8_inline11072__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    ...
    // Unpack tensor: shared_w1_csa_inline532__ssa_v0
    __gm__ Tensor *shared_w1_csa_inline532__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *shared_w1_csa_inline532__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(shared_w1_csa_inline532__ssa_v0_tensor->buffer.addr) +
        shared_w1_csa_inline532__ssa_v0_tensor->start_offset;

    // Unpack tensor: gate_i32_inline2662_inline11084__ssa_v0
    __gm__ Tensor *gate_i32_inline2662_inline11084__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ int32_t *gate_i32_inline2662_inline11084__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(gate_i32_inline2662_inline11084__ssa_v0_tensor->buffer.addr) +
        gate_i32_inline2662_inline11084__ssa_v0_tensor->start_offset;
    ...
    ts0_inline2658_inline11033__ssa_v0_conv.u64 = args[3];
    int64_t ts0_inline2658_inline11033__ssa_v0 = ts0_inline2658_inline11033__ssa_v0_conv.val;

    // Forward to ptoas-generated function
    sh_gate_mm_1(
        x_norm_i8_inline11072__rv_v2, shared_w1_csa_inline532__ssa_v0, gate_i32_inline2662_inline11084__ssa_v0,
        ts0_inline2658_inline11033__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
