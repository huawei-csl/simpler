 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: kv_proj_matmul_2
...
static __aicore__ void kv_proj_matmul_2(
    ...
    // pto: %x_view_inline1221_inline11524__ssa_v0_view
    int64_t v25 = v7 * v18;
    // pto: %x_view_inline1221_inline11524__ssa_v0_view
    int64_t v26 = v17 * v25;
    // pto: %x_view_inline1221_inline11524__ssa_v0_view
    ...
    // pto: %kv_acc_inline1181_inline11604__phi_v5
    Tile<
    ...
    TASSIGN(v30, v31);
    // pto: %kbg_inline1188_inline11727__ssa_v0
    ...
    for (int64_t i36 = v24; i36 < (v4 / v13); i36 += v17) {
        ...
        // pto: %kv_acc_inline1181_inline11604__tile
        Tile<
            TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
            CompactMode::Null>
            v38 = Tile<
        ...
        for (int64_t j40 = v24; j40 < v16; j40 += v12) {
            ...
            // pto: %kv_x_chunk_bf16_inline1178_inline11740__tile
            Tile<
            ...
            // pto: %x_view_inline1221_inline11524__ssa_v0_pview
            ...
            TLOAD(v46, v55);
            // pto: %wkv_chunk_inline1236_inline11568__tile
            Tile<
            ...
            // pto: %wkv_hca_inline527__ssa_v0_pview
            ...
            if (j40 == v24) {
                // pto: %kv_acc_inline1181_inline11604__tile_l0_init_storage
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v76 = Tile<
                ...
                // pto: %kv_acc_inline1181_inline11604__tile_l0_a
                Tile<
                ...
                // pto: %kv_acc_inline1181_inline11604__tile_l0_b
                Tile<
                ...
                // pto: %kv_acc_inline1181_inline11604__tile_l0_c_first
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v86 = Tile<
                ...
                pipe_barrier(PIPE_M);
                TMATMUL(v86, v78, v80);
                // pto: %kv_acc_inline1181_inline11604__tile_l0_c_acc
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v88 = Tile<
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: kv_partials_inline1314_inline11722__ssa_v0
    __gm__ Tensor *kv_partials_inline1314_inline11722__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *kv_partials_inline1314_inline11722__ssa_v0 =
        reinterpret_cast<__gm__ float *>(kv_partials_inline1314_inline11722__ssa_v0_tensor->buffer.addr) +
        kv_partials_inline1314_inline11722__ssa_v0_tensor->start_offset;

    // Unpack tensor: x_view_inline1221_inline11524__ssa_v0
    __gm__ Tensor *x_view_inline1221_inline11524__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ bfloat16_t *x_view_inline1221_inline11524__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(x_view_inline1221_inline11524__ssa_v0_tensor->buffer.addr) +
        x_view_inline1221_inline11524__ssa_v0_tensor->start_offset;

    // Unpack tensor: wkv_hca_inline527__ssa_v0
    __gm__ Tensor *wkv_hca_inline527__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ bfloat16_t *wkv_hca_inline527__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(wkv_hca_inline527__ssa_v0_tensor->buffer.addr) +
        wkv_hca_inline527__ssa_v0_tensor->start_offset;
    ...
    t_dim_inline1283_inline11618__ssa_v0_conv.u64 = args[4];
    int64_t t_dim_inline1283_inline11618__ssa_v0 = t_dim_inline1283_inline11618__ssa_v0_conv.val;

    // Extract dynamic dim: kv_partial_rows_inline1329_inline11715__ssa_v0
    int64_t kv_partial_rows_inline1329_inline11715__ssa_v0 =
        static_cast<int64_t>(kv_partials_inline1314_inline11722__ssa_v0_tensor->shapes[0]);

    // Extract dynamic dim: t_dim_inline1283_inline11618__ssa_v0_1
    int64_t t_dim_inline1283_inline11618__ssa_v0_1 =
        static_cast<int64_t>(x_view_inline1221_inline11524__ssa_v0_tensor->shapes[0]);

    // Forward to ptoas-generated function
    kv_proj_matmul_2(
        kv_partials_inline1314_inline11722__ssa_v0, x_view_inline1221_inline11524__ssa_v0, wkv_hca_inline527__ssa_v0,
        t_matmul_inline1250_inline11559__ssa_v0, t_dim_inline1283_inline11618__ssa_v0,
        kv_partial_rows_inline1329_inline11715__ssa_v0, t_dim_inline1283_inline11618__ssa_v0_1, __pypto_spmd_block_idx,
