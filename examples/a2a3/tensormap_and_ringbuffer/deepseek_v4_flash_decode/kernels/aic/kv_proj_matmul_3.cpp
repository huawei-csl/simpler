 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: kv_proj_matmul_3
...
static __aicore__ void kv_proj_matmul_3(
    ...
    // pto: %kv_acc_inline1670_inline12805__phi_v5
    Tile<
    ...
    TASSIGN(v30, v31);
    // pto: %kbg_inline1677_inline12786__ssa_v0
    ...
    for (int64_t i36 = v24; i36 < (v4 / v13); i36 += v17) {
        ...
        // pto: %kv_acc_inline1670_inline12805__tile
        Tile<
            TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
            CompactMode::Null>
            v38 = Tile<
        ...
        for (int64_t j40 = v24; j40 < v16; j40 += v12) {
            ...
            // pto: %kv_x_chunk_bf16_inline1667_inline12837__tile
            Tile<
            ...
            TLOAD(v46, v55);
            // pto: %wkv_chunk_inline1725_inline12286__tile
            Tile<
            ...
            // pto: %wkv_last_inline729__ssa_v0_pview
            ...
            if (j40 == v24) {
                // pto: %kv_acc_inline1670_inline12805__tile_l0_init_storage
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v76 = Tile<
                ...
                // pto: %kv_acc_inline1670_inline12805__tile_l0_a
                Tile<
                ...
                // pto: %kv_acc_inline1670_inline12805__tile_l0_b
                Tile<
                ...
                // pto: %kv_acc_inline1670_inline12805__tile_l0_c_first
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v86 = Tile<
                ...
                pipe_barrier(PIPE_M);
                TMATMUL(v86, v78, v80);
                // pto: %kv_acc_inline1670_inline12805__tile_l0_c_acc
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v88 = Tile<
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: kv_partials_inline1803_inline12301__ssa_v0
    __gm__ Tensor *kv_partials_inline1803_inline12301__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *kv_partials_inline1803_inline12301__ssa_v0 =
        reinterpret_cast<__gm__ float *>(kv_partials_inline1803_inline12301__ssa_v0_tensor->buffer.addr) +
        kv_partials_inline1803_inline12301__ssa_v0_tensor->start_offset;
    ...
    // Unpack tensor: wkv_last_inline729__ssa_v0
    __gm__ Tensor *wkv_last_inline729__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ bfloat16_t *wkv_last_inline729__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(wkv_last_inline729__ssa_v0_tensor->buffer.addr) +
        wkv_last_inline729__ssa_v0_tensor->start_offset;
    ...
    int64_t kv_partial_rows_inline1818_inline12303__ssa_v0 =
        static_cast<int64_t>(kv_partials_inline1803_inline12301__ssa_v0_tensor->shapes[0]);
    ...
    kv_proj_matmul_3(
        kv_partials_inline1803_inline12301__ssa_v0, x_view_inline1710_inline12436__ssa_v0, wkv_last_inline729__ssa_v0,
        t_matmul_inline1739_inline12394__ssa_v0, t_dim_inline1772_inline12422__ssa_v0,
        kv_partial_rows_inline1818_inline12303__ssa_v0, t_dim_inline1772_inline12422__ssa_v0_1, __pypto_spmd_block_idx,
