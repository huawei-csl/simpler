...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *gate_tile_i32_inline2749_inline11981__ssa_v0_tensor =
    ...
    __gm__ ChipTensor *routed_w1_hca_inline615__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[2]);
