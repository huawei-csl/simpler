...
qr_hadamard_matmul(__gm__ bfloat16_t *v1, __gm__ bfloat16_t *v2, __gm__ float *v3, int32_t v4, int32_t v5) {
    const int64_t v6 = 64;
    ...
    // pto: %idx_inline2009_inline10542__ssa_v0, %0
    ...
    // pto: %qr_bf16_inline1969_inline10778__ssa_v1_pview
    ...
    // pto: %csa_hadamard_idx_csa_inline572__ssa_v0_mat
    Tile<
    ...
    TMOV(v22, v11);
    // pto: %csa_hadamard_idx_csa_inline572__ssa_v0_mat_Right
    Tile<
    ...
    // pto: %qh_acc_inline2010_inline10715__tile
    Tile<
    ...
    // pto: %qh_acc_gm_inline2006_inline10430__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: qr_bf16_inline1969_inline10778__ssa_v1
    __gm__ Tensor *qr_bf16_inline1969_inline10778__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ bfloat16_t *qr_bf16_inline1969_inline10778__ssa_v1 =
        reinterpret_cast<__gm__ bfloat16_t *>(qr_bf16_inline1969_inline10778__ssa_v1_tensor->buffer.addr) +
        qr_bf16_inline1969_inline10778__ssa_v1_tensor->start_offset;

    // Unpack tensor: csa_hadamard_idx_csa_inline572__ssa_v0
    __gm__ Tensor *csa_hadamard_idx_csa_inline572__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    // Unpack tensor: qh_acc_gm_inline2006_inline10430__ssa_v0
    __gm__ Tensor *qh_acc_gm_inline2006_inline10430__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *qh_acc_gm_inline2006_inline10430__ssa_v0 =
        reinterpret_cast<__gm__ float *>(qh_acc_gm_inline2006_inline10430__ssa_v0_tensor->buffer.addr) +
        qh_acc_gm_inline2006_inline10430__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    qr_hadamard_matmul(
        qr_bf16_inline1969_inline10778__ssa_v1, csa_hadamard_idx_csa_inline572__ssa_v0,
        qh_acc_gm_inline2006_inline10430__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
