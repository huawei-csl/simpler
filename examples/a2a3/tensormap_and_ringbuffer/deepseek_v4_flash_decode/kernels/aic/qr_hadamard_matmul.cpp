...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *qr_bf16_inline1969_inline10778__ssa_v1_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[0]);
    ...
    __gm__ ChipTensor *csa_hadamard_idx_csa_inline572__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[1]);
    ...
    __gm__ ChipTensor *qh_acc_gm_inline2006_inline10430__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[2]);
