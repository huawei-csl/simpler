...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *qr_partials_inline1686_inline12530__ssa_v0_tensor =
    ...
    __gm__ ChipTensor *wq_a_last_inline507__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[2]);
