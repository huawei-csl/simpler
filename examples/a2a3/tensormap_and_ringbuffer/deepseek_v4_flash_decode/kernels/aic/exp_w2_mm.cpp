...
exp_w2_mm(__gm__ int32_t *v1, __gm__ int8_t *v2, __gm__ int8_t *v3, int64_t v4, int32_t v5, int32_t v6) {
    ...
    // pto: %y_acc_inline2733_inline9254__phi_v5
    Tile<
    ...
    TASSIGN(v22, v23);
    // pto: %y_acc_inline2733_inline9254__tile_l0_c_phi
    Tile<
        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v24 = Tile<
    ...
    for (int64_t i26 = v21; i26 < v10; i26 += v12) {
        ...
        for (int64_t j30 = v21; j30 < v15; j30 += v11) {
            // pto: %h_k_inline2732_inline9188__tile
            Tile<
            ...
            // pto: %h_tile_i8_inline2806_inline9280__ssa_v4_pview
            ...
            TLOAD(v37, v43);
            // pto: %w2_k_inline2731_inline9151__tile
            Tile<
            ...
            // pto: %w2_k_inline2731_inline9151__tile_view2d_pview
            ...
            if (j30 == v21) {
                // pto: %w2_k_inline2731_inline9151__tile_t
                Tile<
                ...
                TASSIGN(v51, v52);
                // pto: %y_acc_inline2733_inline9254__tile_l0_init
                Tile<
                    TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v53 = Tile<
                ...
                for (int64_t k55 = v21; k55 < v8; k55 += v9) {
                    // pto: %y_acc_inline2733_inline9254__tile_l0_a
                    Tile<
                    ...
                    // pto: %y_acc_inline2733_inline9254__tile_l0_b
                    Tile<
                    ...
                    if (k55 == v21) {
                        // pto: %y_acc_inline2733_inline9254__tile_l0_c_first
                        Tile<
                            TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v65 = Tile<
                        ...
                        // pto: %y_acc_inline2733_inline9254__tile_l0_c_acc
                        Tile<
                            TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                            PadValue::Null, CompactMode::Null>
                            v67 = Tile<
                ...
                for (int64_t k73 = v21; k73 < v8; k73 += v9) {
                    // pto: %y_acc_inline2733_inline9254__iter_v1_l0_a
                    Tile<
                        TileType::Left, int8_t, 16, 128, BLayout::RowMajor, -1, -1, SLayout::RowMajor, 512,
                        PadValue::Null, CompactMode::Null>
                        v74 = Tile<
                    ...
                    // pto: %y_acc_inline2733_inline9254__iter_v1_l0_b
                    Tile<
                        TileType::Right, int8_t, 128, 256, BLayout::RowMajor, -1, -1, SLayout::ColMajor, 512,
                        PadValue::Null, CompactMode::Null>
                        v76 = Tile<
                    ...
                    // pto: %y_acc_inline2733_inline9254__iter_v1_l0_c_acc
                    Tile<
                        TileType::Acc, int32_t, 16, 256, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024,
                        PadValue::Null, CompactMode::Null>
                        v83 = Tile<
        ...
        TASSIGN(v108, v109);
        // pto: %y_i32_inline2737_inline9279__iter_v1_pview
        ...
        // pto: %43, %y_i32_inline2737_inline9279__iter_v1_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: y_i32_inline2737_inline9279__ssa_v0
    __gm__ Tensor *y_i32_inline2737_inline9279__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ int32_t *y_i32_inline2737_inline9279__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(y_i32_inline2737_inline9279__ssa_v0_tensor->buffer.addr) +
        y_i32_inline2737_inline9279__ssa_v0_tensor->start_offset;

    // Unpack tensor: h_tile_i8_inline2806_inline9280__ssa_v4
    __gm__ Tensor *h_tile_i8_inline2806_inline9280__ssa_v4_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *h_tile_i8_inline2806_inline9280__ssa_v4 =
        reinterpret_cast<__gm__ int8_t *>(h_tile_i8_inline2806_inline9280__ssa_v4_tensor->buffer.addr) +
        h_tile_i8_inline2806_inline9280__ssa_v4_tensor->start_offset;

    // Unpack tensor: routed_w2_l0_inline591__ssa_v0
    __gm__ Tensor *routed_w2_l0_inline591__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ int8_t *routed_w2_l0_inline591__ssa_v0 =
        reinterpret_cast<__gm__ int8_t *>(routed_w2_l0_inline591__ssa_v0_tensor->buffer.addr) +
        routed_w2_l0_inline591__ssa_v0_tensor->start_offset;
    ...
    local_e_inline2742_inline9382__idx_v0_conv.u64 = args[3];
    int64_t local_e_inline2742_inline9382__idx_v0 = local_e_inline2742_inline9382__idx_v0_conv.val;

    // Forward to ptoas-generated function
    exp_w2_mm(
        y_i32_inline2737_inline9279__ssa_v0, h_tile_i8_inline2806_inline9280__ssa_v4, routed_w2_l0_inline591__ssa_v0,
        local_e_inline2742_inline9382__idx_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
