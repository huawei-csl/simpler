...
static __aicore__ void gate_3_aic(
    ...
    // pto: %gate_logits_tile_inline2592_inline13067__tile_l0_c_phi
    Tile<
    ...
    // pto: %gb_idx_inline2614_inline13058__ssa_v0
    int64_t v25 = (int64_t)v8;
    // pto: %12, %14
    int64_t v26 = (int64_t)((uint64_t)(v25 / v14) * (uint64_t)v15);
    // pto: %13, %15
    int64_t v27 = (int64_t)((uint64_t)(v25 % v14) * (uint64_t)v15);
    // pto: %gate_logits_tile_inline2592_inline13067__tile
    Tile<
        TileType::Acc, float, 16, 16, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v28 = Tile<
    ...
    TASSIGN(v28, v29);
    // pto: %gd_x_inline2620_inline12941__tile
    Tile<
    ...
    TLOAD(v30, v35);
    // pto: %gd_w_inline2571_inline12934__tile
    Tile<
        TileType::Mat, float, 16, 2048, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
        CompactMode::Null>
        v36 = Tile<
    ...
    // pto: %gate_w_last_inline493__ssa_v0_pview
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 16, 2048>, pto::Stride<65536, 65536, 65536, 4096, 1>, pto::Layout::ND> v51 =
        GlobalTensor<float, pto::Shape<1, 1, 1, 16, 2048>, pto::Stride<65536, 65536, 65536, 4096, 1>, pto::Layout::ND>(
            v3 + (v13 + v38 * v10), v49, v50
        );
    TLOAD(v47, v51);
    set_flag(PIPE_MTE2, PIPE_MTE1, EVENT_ID1);
    // pto: %gd_w_inline2571_inline12934__tile_t
    Tile<
    ...
    TASSIGN(v52, v53);
    // pto: %gate_logits_tile_inline2592_inline13067__tile_l0_init
    Tile<
        TileType::Acc, float, 16, 16, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v54 = Tile<
    ...
    for (int64_t i56 = v20; i56 < v13; i56 += v12) {
        // pto: %gate_logits_tile_inline2592_inline13067__tile_l0_a
        Tile<
        ...
        TASSIGN(v61, v62);
        // pto: %22
        int64_t v63 = (int64_t)((uint64_t)i56 + (uint64_t)v11);
        ...
        if (i56 == v20) {
            // pto: %gate_logits_tile_inline2592_inline13067__tile_l0_c_first
            Tile<
                TileType::Acc, float, 16, 16, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                CompactMode::Null>
                v66 = Tile<
            ...
            // pto: %gate_logits_tile_inline2592_inline13067__tile_l0_c_acc
            Tile<
                TileType::Acc, float, 16, 16, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                CompactMode::Null>
                v68 = Tile<
    ...
    for (int64_t i74 = v20; i74 < v13; i74 += v12) {
        // pto: %6
        Tile<
            TileType::Left, float, 16, 512, BLayout::RowMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
            CompactMode::Null>
        ...
        TASSIGN(v79, v80);
        // pto: %26
        int64_t v81 = (int64_t)((uint64_t)i74 + (uint64_t)v11);
...
static __aicore__ void gate_3_aiv(
    __gm__ float *v1, __gm__ float *v2, __gm__ float *v3, __gm__ float *v4, __gm__ float *v5, __gm__ float *v6,
    __gm__ float *v7, int32_t v8, int32_t v9, int32_t v10
) {
    const int64_t v11 = 256;
    const int32_t v12 = 16;
    const float v13 = 10.0f;
    ...
    if ((int64_t)v10 == v17) {
        ...
        // pto: %37, %39
        int64_t v28 = (int64_t)((uint64_t)(v27 / v16) * (uint64_t)v18);
        // pto: %38, %40
        int64_t v29 = (int64_t)((uint64_t)(v27 % v16) * (uint64_t)v18);
        // pto: %t__tile
        Tile<
        ...
        // pto: %gate_bias_last_inline492__ssa_v0_pview
        ...
        TLOAD(v30, v35);
        // pto: %gp_bias_row_inline2559_inline12932__tile
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v36 = Tile<
        ...
        // pto: %inv_rms_buf_inline2585_inline13013__ssa_v0_pview
        ...
        TLOAD(v38, v43);
        // pto: %gate_logits_tile_inline2592_inline13067__rv_v2_Vec
        Tile<
        ...
        // pto: %gate_logits_tile_v1_inline2568_inline13111__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v45 = Tile<
        ...
        // pto: %gp_relu_inline2577_inline13014__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v47 = Tile<
        ...
        TASSIGN(v49, v50);
        TNEG(v49, v45);
        // pto: %gp_abs_inline2545_inline13040__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v51 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TLOG(v59, v57);
        // pto: %gp_softplus_log_inline2547_inline12997__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v61 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TMAXS(v67, v65, v15);
        // pto: %gp_neg_floor_mask_inline2544_inline13038__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v69 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TEXP(v73, v71);
        // pto: %gp_neg_floor_inline2550_inline12938__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v75 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TMUL(v75, v69, v73);
        // pto: %gp_softplus_inline2543_inline13028__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v77 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TMAX(v77, v61, v75);
        // pto: %gp_score_inline2542_inline12949__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v79 = Tile<
        ...
        // pto: %route_scores_buf_inline2607_inline13004__ssa_v0_pview
        ...
        TASSIGN(v84, v85);
        TEXPANDS(v84, v14);
        // pto: %gp_bias_inline2541_inline13062__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v86 = Tile<
        ...
        // pto: %gp_biased_inline2570_inline12998__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v88 = Tile<
        ...
        // pto: %biased_scores_buf_inline2564_inline13093__ssa_v1_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: gate_bias_last_inline492__ssa_v0
    __gm__ Tensor *gate_bias_last_inline492__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *gate_bias_last_inline492__ssa_v0 =
        reinterpret_cast<__gm__ float *>(gate_bias_last_inline492__ssa_v0_tensor->buffer.addr) +
        gate_bias_last_inline492__ssa_v0_tensor->start_offset;

    // Unpack tensor: xg_buf_inline2582_inline13127__ssa_v0
    __gm__ Tensor *xg_buf_inline2582_inline13127__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    // Unpack tensor: gate_w_last_inline493__ssa_v0
    __gm__ Tensor *gate_w_last_inline493__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *gate_w_last_inline493__ssa_v0 =
        reinterpret_cast<__gm__ float *>(gate_w_last_inline493__ssa_v0_tensor->buffer.addr) +
        gate_w_last_inline493__ssa_v0_tensor->start_offset;

    // Unpack tensor: inv_rms_buf_inline2585_inline13013__ssa_v0
    __gm__ Tensor *inv_rms_buf_inline2585_inline13013__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    __gm__ float *inv_rms_buf_inline2585_inline13013__ssa_v0 =
        reinterpret_cast<__gm__ float *>(inv_rms_buf_inline2585_inline13013__ssa_v0_tensor->buffer.addr) +
        inv_rms_buf_inline2585_inline13013__ssa_v0_tensor->start_offset;

    // Unpack tensor: route_scores_buf_inline2607_inline13004__ssa_v0
    __gm__ Tensor *route_scores_buf_inline2607_inline13004__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ float *route_scores_buf_inline2607_inline13004__ssa_v0 =
        reinterpret_cast<__gm__ float *>(route_scores_buf_inline2607_inline13004__ssa_v0_tensor->buffer.addr) +
        route_scores_buf_inline2607_inline13004__ssa_v0_tensor->start_offset;

    // Unpack tensor: biased_scores_buf_inline2564_inline13093__ssa_v1
    __gm__ Tensor *biased_scores_buf_inline2564_inline13093__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[5]);
    __gm__ float *biased_scores_buf_inline2564_inline13093__ssa_v1 =
        reinterpret_cast<__gm__ float *>(biased_scores_buf_inline2564_inline13093__ssa_v1_tensor->buffer.addr) +
        biased_scores_buf_inline2564_inline13093__ssa_v1_tensor->start_offset;
    ...
    gate_3_aic(
        gate_bias_last_inline492__ssa_v0, xg_buf_inline2582_inline13127__ssa_v0, gate_w_last_inline493__ssa_v0,
        inv_rms_buf_inline2585_inline13013__ssa_v0, route_scores_buf_inline2607_inline13004__ssa_v0,
        biased_scores_buf_inline2564_inline13093__ssa_v1, __gm_pipe_buffer, __pypto_spmd_block_idx,
