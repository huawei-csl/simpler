 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: kv_proj_matmul_1
...
static __aicore__ void kv_proj_matmul_1(
    ...
    // pto: %x_view_inline1710_inline10512__ssa_v0_view
    int64_t v25 = v7 * v18;
    // pto: %x_view_inline1710_inline10512__ssa_v0_view
    int64_t v26 = v17 * v25;
    // pto: %x_view_inline1710_inline10512__ssa_v0_view
    ...
    // pto: %kv_acc_inline1670_inline10881__phi_v5
    Tile<
    ...
    TASSIGN(v30, v31);
    // pto: %kbg_inline1677_inline10862__ssa_v0
    ...
    for (int64_t i36 = v24; i36 < (v4 / v13); i36 += v17) {
        ...
        // pto: %kv_acc_inline1670_inline10881__tile
        Tile<
            TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
            CompactMode::Null>
            v38 = Tile<
        ...
        for (int64_t j40 = v24; j40 < v16; j40 += v12) {
            // pto: %22
            ...
            // pto: %kv_x_chunk_bf16_inline1667_inline10913__tile
            Tile<
            ...
            // pto: %x_view_inline1710_inline10512__ssa_v0_pview
            ...
            TLOAD(v46, v55);
            // pto: %wkv_chunk_inline1725_inline10362__tile
            Tile<
            ...
            // pto: %wkv_csa_inline696__ssa_v0_pview
            pto::Shape<1, 1, 1, 256, 128> v59 = pto::Shape<1, 1, 1, 256, 128>();
            // pto: %wkv_csa_inline696__ssa_v0_pview
            pto::Stride<131072, 131072, 131072, 512, 1> v60 = pto::Stride<131072, 131072, 131072, 512, 1>();
            // pto: %wkv_csa_inline696__ssa_v0_pview
            GlobalTensor<
                bfloat16_t, pto::Shape<1, 1, 1, 256, 128>, pto::Stride<131072, 131072, 131072, 512, 1>, pto::Layout::ND>
                v61 = GlobalTensor<
                    bfloat16_t, pto::Shape<1, 1, 1, 256, 128>, pto::Stride<131072, 131072, 131072, 512, 1>,
            ...
            // pto: %40
            pto::Stride<131072, 131072, 131072, 512, 1> v74 = pto::Stride<131072, 131072, 131072, 512, 1>();
            // pto: %40
            GlobalTensor<
                bfloat16_t, pto::Shape<1, 1, 1, 256, 128>, pto::Stride<131072, 131072, 131072, 512, 1>, pto::Layout::ND>
                v75 = GlobalTensor<
            ...
            if (j40 == v24) {
                // pto: %kv_acc_inline1670_inline10881__tile_l0_init_storage
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v76 = Tile<
                ...
                // pto: %kv_acc_inline1670_inline10881__tile_l0_a
                Tile<
                ...
                // pto: %kv_acc_inline1670_inline10881__tile_l0_b
                Tile<
                ...
                // pto: %kv_acc_inline1670_inline10881__tile_l0_c_first
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v86 = Tile<
                ...
                pipe_barrier(PIPE_M);
                TMATMUL(v86, v78, v80);
                // pto: %kv_acc_inline1670_inline10881__tile_l0_c_acc
                Tile<
                    TileType::Acc, float, 16, 128, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                    CompactMode::Null>
                    v88 = Tile<
        ...
        // pto: %kv_partials_inline1803_inline10377__iter_v1_pview
        pto::Shape<1, 1, 1, 16, 128> v115 = pto::Shape<1, 1, 1, 16, 128>();
        // pto: %kv_partials_inline1803_inline10377__iter_v1_pview
        pto::Stride<8192, 8192, 8192, 512, 1> v116 = pto::Stride<8192, 8192, 8192, 512, 1>();
        // pto: %44, %kv_partials_inline1803_inline10377__iter_v1_pview, %45
        GlobalTensor<float, pto::Shape<1, 1, 1, 16, 128>, pto::Stride<8192, 8192, 8192, 512, 1>, pto::Layout::ND> v117 =
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: kv_partials_inline1803_inline10377__ssa_v0
    __gm__ Tensor *kv_partials_inline1803_inline10377__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *kv_partials_inline1803_inline10377__ssa_v0 =
        reinterpret_cast<__gm__ float *>(kv_partials_inline1803_inline10377__ssa_v0_tensor->buffer.addr) +
        kv_partials_inline1803_inline10377__ssa_v0_tensor->start_offset;

    // Unpack tensor: x_view_inline1710_inline10512__ssa_v0
    __gm__ Tensor *x_view_inline1710_inline10512__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ bfloat16_t *x_view_inline1710_inline10512__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(x_view_inline1710_inline10512__ssa_v0_tensor->buffer.addr) +
        x_view_inline1710_inline10512__ssa_v0_tensor->start_offset;

    // Unpack tensor: wkv_csa_inline696__ssa_v0
    __gm__ Tensor *wkv_csa_inline696__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ bfloat16_t *wkv_csa_inline696__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(wkv_csa_inline696__ssa_v0_tensor->buffer.addr) +
        wkv_csa_inline696__ssa_v0_tensor->start_offset;
    ...
    t_dim_inline1772_inline10498__ssa_v0_conv.u64 = args[4];
    int64_t t_dim_inline1772_inline10498__ssa_v0 = t_dim_inline1772_inline10498__ssa_v0_conv.val;

    // Extract dynamic dim: kv_partial_rows_inline1818_inline10379__ssa_v0
    int64_t kv_partial_rows_inline1818_inline10379__ssa_v0 =
        static_cast<int64_t>(kv_partials_inline1803_inline10377__ssa_v0_tensor->shapes[0]);

    // Extract dynamic dim: t_dim_inline1772_inline10498__ssa_v0_1
    int64_t t_dim_inline1772_inline10498__ssa_v0_1 =
        static_cast<int64_t>(x_view_inline1710_inline10512__ssa_v0_tensor->shapes[0]);

    // Forward to ptoas-generated function
    kv_proj_matmul_1(
        kv_partials_inline1803_inline10377__ssa_v0, x_view_inline1710_inline10512__ssa_v0, wkv_csa_inline696__ssa_v0,
        t_matmul_inline1739_inline10470__ssa_v0, t_dim_inline1772_inline10498__ssa_v0,
        kv_partial_rows_inline1818_inline10379__ssa_v0, t_dim_inline1772_inline10498__ssa_v0_1, __pypto_spmd_block_idx,
