...
static __aicore__ void quant_1(__gm__ float *v1, __gm__ int8_t *v2, __gm__ float *v3, int64_t v4, int64_t v5) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %oc_amax_inline2067_inline10691__tile
    Tile<
    ...
    // pto: %o_r_pad_inline2225_inline10832__ssa_v3_pview
    ...
    // pto: %g_abs_inline2174_inline10263__tile
    Tile<
        TileType::Vec, float, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v25 = Tile<
    ...
    TASSIGN(v27, v28);
    // pto: %g_row_max_inline2066_inline10262__tile
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TROWMAX(v29, v25, v27);
    // pto: %g_row_max_v1_inline2064_inline10451__tile
    Tile<
    ...
    TASSIGN(v31, v32);
    // pto: %g_amax_floor_inline2063_inline10846__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v33 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TEXPANDS(v33, v12);
    // pto: %g_amax_inline2115_inline10261__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v35 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TMAX(v35, v33, v31);
    // pto: %g_scale_num_inline2062_inline10260__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v37 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v37, v38);
    TEXPANDS(v37, v11);
    // pto: %g_sq_row_inline2061_inline10665__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v39 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %act_scale_dq_inline2081_inline10852__iter_v1_pview
    pto::Shape<1, 1, 1, 1, 8> v43 = pto::Shape<1, 1, 1, 1, 8>();
    // pto: %act_scale_dq_inline2081_inline10852__iter_v1_pview
    pto::Stride<8, 8, 8, 8, 1> v44 = pto::Stride<8, 8, 8, 8, 1>();
    // pto: %1, %act_scale_dq_inline2081_inline10852__iter_v1_pview
    ...
    // pto: %g_sq_col_inline2060_inline10539__tile
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v46 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v46, v47);
    // pto: %oc_q_inline2176_inline10259__tile
    Tile<
        TileType::Vec, float, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v48 = Tile<
    ...
    // pto: %oq_scaled_inline2059_inline10754__tile
    Tile<
        TileType::Vec, float, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v50 = Tile<
    ...
    // pto: %oq_i32_inline2110_inline10258__tile
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v52, v50, v9, v8);
    // pto: %oq_half_inline2068_inline10257__tile
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v54, v52, v7, v8);
    // pto: %oq_i8_inline2058_inline10256__tile
    Tile<
    ...
    // pto: %o_r_i8_pad_inline2082_inline10272__iter_v1_pview
    ...
    // pto: %zero_half_inline2095_inline10255__tile
    Tile<
        TileType::Vec, half, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v61 = Tile<
    ...
    TEXPANDS(v61, v10);
    // pto: %zero_i8_inline2157_inline10673__tile
    Tile<
        TileType::Vec, int8_t, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v63 = Tile<
    ...
    // pto: %o_r_i8_pad_inline2082_inline10272__tile_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: act_scale_dq_inline2081_inline10852__iter_v1
    __gm__ Tensor *act_scale_dq_inline2081_inline10852__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *act_scale_dq_inline2081_inline10852__iter_v1 =
        reinterpret_cast<__gm__ float *>(act_scale_dq_inline2081_inline10852__iter_v1_tensor->buffer.addr) +
        act_scale_dq_inline2081_inline10852__iter_v1_tensor->start_offset;

    // Unpack tensor: o_r_i8_pad_inline2082_inline10272__iter_v1
    __gm__ Tensor *o_r_i8_pad_inline2082_inline10272__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *o_r_i8_pad_inline2082_inline10272__iter_v1 =
        reinterpret_cast<__gm__ int8_t *>(o_r_i8_pad_inline2082_inline10272__iter_v1_tensor->buffer.addr) +
        o_r_i8_pad_inline2082_inline10272__iter_v1_tensor->start_offset;

    // Unpack tensor: o_r_pad_inline2225_inline10832__ssa_v3
    __gm__ Tensor *o_r_pad_inline2225_inline10832__ssa_v3_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *o_r_pad_inline2225_inline10832__ssa_v3 =
        reinterpret_cast<__gm__ float *>(o_r_pad_inline2225_inline10832__ssa_v3_tensor->buffer.addr) +
        o_r_pad_inline2225_inline10832__ssa_v3_tensor->start_offset;

    // Unpack scalar: col_g_inline2196_inline10384__ssa_v0
    union {
        uint64_t u64;
        int64_t val;
    } col_g_inline2196_inline10384__ssa_v0_conv;
    col_g_inline2196_inline10384__ssa_v0_conv.u64 = args[3];
    int64_t col_g_inline2196_inline10384__ssa_v0 = col_g_inline2196_inline10384__ssa_v0_conv.val;
    ...
    quant_1(
        act_scale_dq_inline2081_inline10852__iter_v1, o_r_i8_pad_inline2082_inline10272__iter_v1,
        o_r_pad_inline2225_inline10832__ssa_v3, col_g_inline2196_inline10384__ssa_v0, g_inline2162_inline10271__idx_v0
    );
}
