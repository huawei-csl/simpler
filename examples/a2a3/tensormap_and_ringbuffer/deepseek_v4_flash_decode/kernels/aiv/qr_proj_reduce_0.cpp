 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: qr_proj_reduce_0
...
qr_proj_reduce_0(__gm__ float *v1, __gm__ float *v2, int64_t v3, int64_t v4, int64_t v5, int32_t v6, int32_t v7) {
    ...
    // pto: %qr_partials_inline803_inline9739__rv_v2_pview
    ...
    // pto: %qr_fp32_inline806_inline9638__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: qr_partials_inline803_inline9739__rv_v2
    __gm__ Tensor *qr_partials_inline803_inline9739__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *qr_partials_inline803_inline9739__rv_v2 =
        reinterpret_cast<__gm__ float *>(qr_partials_inline803_inline9739__rv_v2_tensor->buffer.addr) +
        qr_partials_inline803_inline9739__rv_v2_tensor->start_offset;

    // Unpack tensor: qr_fp32_inline806_inline9638__ssa_v0
    __gm__ Tensor *qr_fp32_inline806_inline9638__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *qr_fp32_inline806_inline9638__ssa_v0 =
        reinterpret_cast<__gm__ float *>(qr_fp32_inline806_inline9638__ssa_v0_tensor->buffer.addr) +
        qr_fp32_inline806_inline9638__ssa_v0_tensor->start_offset;
    ...
    int64_t qr_partial_rows_inline846_inline9616__ssa_v0 =
        static_cast<int64_t>(qr_partials_inline803_inline9739__rv_v2_tensor->shapes[0]);

    // Extract dynamic dim: t_matmul_inline856_inline9609__ssa_v0_1
    int64_t t_matmul_inline856_inline9609__ssa_v0_1 =
        static_cast<int64_t>(qr_fp32_inline806_inline9638__ssa_v0_tensor->shapes[0]);

    // Forward to ptoas-generated function
    qr_proj_reduce_0(
        qr_partials_inline803_inline9739__rv_v2, qr_fp32_inline806_inline9638__ssa_v0,
        t_matmul_inline856_inline9609__ssa_v0, qr_partial_rows_inline846_inline9616__ssa_v0,
