...
static __aicore__ void qr_rope(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %idx_inline1975_inline10354__ssa_v0, %3
    int64_t v23 = (int64_t)((uint64_t)((int64_t)v6) * (uint64_t)v13);
    // pto: %4
    int64_t v24 = v23 / v10;
    // pto: %rope_swap_idx_inline1961_inline10784__tile
    Tile<
    ...
    TASSIGN(v25, v26);
    // pto: %rope_swap_idx_t_inline1970_inline10780__ssa_v1_pview
    ...
    TLOAD(v25, v29);
    // pto: %cos_row_inline1956_inline10787__tile
    Tile<
    ...
    TLOAD(v30, v35);
    // pto: %sin_row_inline1960_inline10788__tile
    Tile<
        TileType::Vec, float, 1, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v36 = Tile<
    ...
    TLOAD(v36, v40);
    // pto: %qr_nope_slice_inline2037_inline10584__tile
    Tile<
    ...
    // pto: %qr_proj_flat_inline1973_inline10549__ssa_v0_pview
    ...
    TLOAD(v41, v46);
    // pto: %qr_rope_slice_inline1971_inline10790__tile
    Tile<
        TileType::Vec, float, 32, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v47 = Tile<
    ...
    // pto: %qr_swapped_inline2002_inline10794__tile
    Tile<
        TileType::Vec, float, 32, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v73 = Tile<
    ...
    // pto: %rope_rot_inline2005_inline10446__tile
    Tile<
        TileType::Vec, float, 32, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v79 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v83, v79, v9, v8);
    // pto: %qr_vec_inline1981_inline10464__tile
    Tile<
    ...
    // pto: %qr_bf16_inline1969_inline10778__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    qr_rope(
        rope_swap_idx_t_inline1970_inline10780__ssa_v1, step_cos_il_inline10506__ssa_v1,
        step_sin_signed_inline10441__ssa_v1, qr_proj_flat_inline1973_inline10549__ssa_v0,
        qr_bf16_inline1969_inline10778__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
