...
static __aicore__ void quant_2(__gm__ float *v1, __gm__ int8_t *v2, __gm__ float *v3, int64_t v4, int64_t v5) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %oc_amax_inline1447_inline11297__tile
    Tile<
    ...
    // pto: %o_r_pad_inline1536_inline11403__ssa_v3_pview
    ...
    // pto: %g_abs_inline1446_inline11586__tile
    Tile<
        TileType::Vec, float, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v25 = Tile<
    ...
    TASSIGN(v27, v28);
    // pto: %g_row_max_inline1478_inline11383__tile
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TROWMAX(v29, v25, v27);
    // pto: %g_row_max_v1_inline1464_inline11528__tile
    Tile<
    ...
    TASSIGN(v31, v32);
    // pto: %g_amax_floor_inline1488_inline11333__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v33 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TEXPANDS(v33, v12);
    // pto: %g_amax_inline1445_inline11296__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v35 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TMAX(v35, v33, v31);
    // pto: %g_scale_num_inline1450_inline11295__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v37 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v37, v38);
    TEXPANDS(v37, v11);
    // pto: %g_sq_row_inline1444_inline11651__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v39 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %act_scale_dq_inline1577_inline11391__iter_v1_pview
    pto::Shape<1, 1, 1, 1, 8> v43 = pto::Shape<1, 1, 1, 1, 8>();
    // pto: %act_scale_dq_inline1577_inline11391__iter_v1_pview
    pto::Stride<8, 8, 8, 8, 1> v44 = pto::Stride<8, 8, 8, 8, 1>();
    // pto: %1, %act_scale_dq_inline1577_inline11391__iter_v1_pview
    ...
    // pto: %g_sq_col_inline1494_inline11579__tile
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v46 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v46, v47);
    // pto: %oc_q_inline1443_inline11294__tile
    Tile<
        TileType::Vec, float, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v48 = Tile<
    ...
    // pto: %oq_scaled_inline1511_inline11399__tile
    Tile<
        TileType::Vec, float, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v50 = Tile<
    ...
    // pto: %oq_i32_inline1440_inline11743__tile
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v52, v50, v9, v8);
    // pto: %oq_half_inline1566_inline11293__tile
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v54, v52, v7, v8);
    // pto: %oq_i8_inline1439_inline11292__tile
    Tile<
    ...
    // pto: %o_r_i8_pad_inline1462_inline11408__iter_v1_pview
    ...
    // pto: %zero_half_inline1483_inline11291__tile
    Tile<
        TileType::Vec, half, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v61 = Tile<
    ...
    TEXPANDS(v61, v10);
    // pto: %zero_i8_inline1461_inline11425__tile
    Tile<
        TileType::Vec, int8_t, 8, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v63 = Tile<
    ...
    // pto: %o_r_i8_pad_inline1462_inline11408__tile_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: act_scale_dq_inline1577_inline11391__iter_v1
    __gm__ Tensor *act_scale_dq_inline1577_inline11391__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *act_scale_dq_inline1577_inline11391__iter_v1 =
        reinterpret_cast<__gm__ float *>(act_scale_dq_inline1577_inline11391__iter_v1_tensor->buffer.addr) +
        act_scale_dq_inline1577_inline11391__iter_v1_tensor->start_offset;

    // Unpack tensor: o_r_i8_pad_inline1462_inline11408__iter_v1
    __gm__ Tensor *o_r_i8_pad_inline1462_inline11408__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *o_r_i8_pad_inline1462_inline11408__iter_v1 =
        reinterpret_cast<__gm__ int8_t *>(o_r_i8_pad_inline1462_inline11408__iter_v1_tensor->buffer.addr) +
        o_r_i8_pad_inline1462_inline11408__iter_v1_tensor->start_offset;

    // Unpack tensor: o_r_pad_inline1536_inline11403__ssa_v3
    __gm__ Tensor *o_r_pad_inline1536_inline11403__ssa_v3_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *o_r_pad_inline1536_inline11403__ssa_v3 =
        reinterpret_cast<__gm__ float *>(o_r_pad_inline1536_inline11403__ssa_v3_tensor->buffer.addr) +
        o_r_pad_inline1536_inline11403__ssa_v3_tensor->start_offset;
    ...
    col_g_inline1449_inline11676__ssa_v0_conv.u64 = args[3];
    ...
    quant_2(
        act_scale_dq_inline1577_inline11391__iter_v1, o_r_i8_pad_inline1462_inline11408__iter_v1,
        o_r_pad_inline1536_inline11403__ssa_v3, col_g_inline1449_inline11676__ssa_v0, g_inline1480_inline11801__idx_v0
    );
}
