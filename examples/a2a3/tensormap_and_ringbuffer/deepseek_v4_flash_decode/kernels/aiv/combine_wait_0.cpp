 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: combine_wait_0
...
static __aicore__ void combine_wait_0(__gm__ int32_t *v1, int32_t v2, __gm__ int64_t *v3) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    for (int64_t i12 = v8; i12 < v10; i12 += v9) {
        // pto: %0
        ...
        if (i12 != v13) {
            ...
            int64_t v14 = (v3)[v10];
            // pto: %3, %4, %5, %6
            int64_t v15 = (v3)[(int64_t)((uint64_t)((int64_t)((int32_t)v14)) + (uint64_t)v7)];
            // pto: %7, %8
            int64_t v16 = (v3)[(int64_t)((uint64_t)i12 + (uint64_t)v7)];
            ...
            GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN> v19 =
                GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN>(
                    (v1 + (int64_t)((uint64_t)v16 - (uint64_t)v15) / v7) + (v8 + (v13 < v8 ? v8 : v13)), v17, v18
                );
            pipe_barrier(PIPE_ALL);
            pto::comm::TNOTIFY(v19, v6, v5);
        }
    }
    for (int64_t i20 = v8; i20 < v10; i20 += v9) {
        // pto: %15, %16
        if (i20 != (int64_t)v2) {
            ...
            GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN> v23 =
                GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN>(
                    v1 + (v8 + (i20 < v8 ? v8 : i20)), v21, v22
                );
            pto::comm::TWAIT(v23, v11, v4);
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    combine_wait_0(combine_arrived__ssa_v0, my_rank__ssa_v0, combine_arrived_ctx);
}
