 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: comb_sinkhorn_1
...
static __aicore__ void comb_sinkhorn_1(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %inv_rms_inline14231__ssa_v1_view
    int64_t v45 = v6 * v22;
    // pto: %inv_rms_inline14231__ssa_v1_view
    int64_t v46 = v22 * v45;
    // pto: %inv_rms_inline14231__ssa_v1_view
    ...
    // pto: %ob_inline14235__ssa_v0, %56
    int64_t v50 = (int64_t)((uint64_t)((int64_t)v7) * (uint64_t)v21);
    // pto: %inv_col_t_inline14287__ssa_v0
    Tile<
    ...
    // pto: %inv_rms_inline14231__ssa_v1_pview
    ...
    TLOAD(v51, v59);
    // pto: %mix_g0_inline14294__ssa_v0
    Tile<
    ...
    TASSIGN(v60, v61);
    // pto: %mixes_raw_inline14254__ssa_v1_pview
    ...
    // pto: %mix_g1_inline14246__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v65 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TLOAD(v65, v69);
    // pto: %mix_g2_inline14232__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v70 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TLOAD(v70, v74);
    // pto: %mix_g3_inline14230__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v75 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v80, v81);
    // pto: %hc_base_2d_inline14291__ssa_v0_pview
    ...
    pipe_barrier(PIPE_V);
    TADD(v130, v126, v128);
    // pto: %row0_p_inline14298__ssa_v0
    ...
    TASSIGN(v132, v133);
    TFILLPAD(v132, v106);
    // pto: %row1_p_inline14286__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v134 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    TASSIGN(v134, v135);
    TFILLPAD(v134, v114);
    // pto: %row2_p_inline14300__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v136 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    TASSIGN(v136, v137);
    TFILLPAD(v136, v122);
    // pto: %row3_p_inline14301__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v138 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    pipe_barrier(PIPE_V);
    TFILLPAD(v138, v130);
    // pto: %row_max_tmp_inline14303__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v140 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v140, v141);
    // pto: %row_sum_tmp_inline14305__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v142 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v142, v143);
    // pto: %row0_max_inline14306__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v144 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row1_max_inline14308__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v146 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row2_max_inline14326__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v148 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row3_max_inline14309__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v150 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row0_exp_inline14249__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v154 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row1_exp_inline14312__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v158 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row2_exp_inline14313__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v162 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row3_exp_inline14261__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v166 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    pipe_barrier(PIPE_V);
    TEXP(v166, v164);
    // pto: %row0_sum_inline14310__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v168 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row1_sum_inline14315__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v170 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row2_sum_inline14331__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v172 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row3_sum_inline14316__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v174 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row0_soft_inline14280__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v178 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row1_soft_inline14304__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v182 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row2_soft_inline14317__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v186 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row3_soft_inline14243__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v190 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row0_eff_inline14267__ssa_v0
    Tile<
    ...
    TASSIGN(v192, v193);
    TFILLPAD(v192, v178);
    // pto: %row1_eff_inline14320__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v194 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v194, v195);
    TFILLPAD(v194, v182);
    // pto: %row2_eff_inline14321__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v196 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v196, v197);
    TFILLPAD(v196, v186);
    // pto: %row3_eff_inline14322__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v198 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    pipe_barrier(PIPE_V);
    TFILLPAD(v198, v190);
    // pto: %row_sum_tmp_iter_inline14307__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v200 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TADD(v204, v196, v198);
    // pto: %col_sum_inline14323__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v206 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    pipe_barrier(PIPE_V);
    TADD(v206, v202, v204);
    // pto: %col_sum_v1_inline14325__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v208 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    pipe_barrier(PIPE_V);
    TADDS(v208, v206, v19);
    // pto: %row0_cur_inline14329__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v210 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    pipe_barrier(PIPE_V);
    TDIV(v210, v192, v208);
    // pto: %row1_cur_inline14330__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v212 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v212, v213);
    TDIV(v212, v194, v208);
    // pto: %row2_cur_inline14341__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v214 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v214, v215);
    TDIV(v214, v196, v208);
    // pto: %row3_cur_inline14332__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v216 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    for (int64_t i218 = v24; i218 < v18; i218 += v17) {
        ...
        // pto: %row0_rowsum_inline14335__rm_a0_tmp_v0
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v221 = Tile<
        ...
        TASSIGN(v221, v222);
        // pto: %row0_rowsum_inline14335__row_major_tmp_v1
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v223 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v223, v221, v19);
        // pto: %row0_rowsum_inline14335__ssa_v0
        Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v225 = Tile<
        ...
        // pto: %row1_rowsum_inline14351__rm_a0_tmp_v2
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v229 = Tile<
        ...
        TASSIGN(v229, v230);
        // pto: %row1_rowsum_inline14351__row_major_tmp_v3
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v231 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v231, v229, v19);
        // pto: %row1_rowsum_inline14351__ssa_v0
        Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v233 = Tile<
        ...
        // pto: %row2_rowsum_inline14338__rm_a0_tmp_v4
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v237 = Tile<
        ...
        TASSIGN(v237, v238);
        // pto: %row2_rowsum_inline14338__row_major_tmp_v5
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v239 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v239, v237, v19);
        // pto: %row2_rowsum_inline14338__ssa_v0
        Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v241 = Tile<
        ...
        // pto: %row3_rowsum_inline14296__rm_a0_tmp_v6
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v245 = Tile<
        ...
        TASSIGN(v245, v246);
        // pto: %row3_rowsum_inline14296__row_major_tmp_v7
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v247 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v247, v245, v19);
        // pto: %row3_rowsum_inline14296__ssa_v0
        Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v249 = Tile<
        ...
        TASSIGN(v249, v250);
        // pto: %row0_norm_inline14255__ssa_v0
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v251 = Tile<
        ...
        // pto: %row1_norm_inline14324__ssa_v0
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v253 = Tile<
        ...
        // pto: %row2_norm_inline14339__ssa_v0
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v255 = Tile<
        ...
        // pto: %row3_norm_inline14277__ssa_v0
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v257 = Tile<
        ...
        TASSIGN(v261, v262);
        TADD(v261, v255, v257);
        // pto: %col_sum_v1_inline14325__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v263 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADD(v263, v259, v261);
        // pto: %col_sum_v1_inline14325__ssa_v4
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v265 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v265, v263, v19);
        // pto: %row0_cur_inline14329__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v267 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TDIV(v267, v251, v265);
        // pto: %row1_cur_inline14330__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v269 = Tile<
        ...
        TASSIGN(v269, v270);
        TDIV(v269, v253, v265);
        // pto: %row2_cur_inline14341__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v271 = Tile<
        ...
        TASSIGN(v271, v272);
        TDIV(v271, v255, v265);
        // pto: %row3_cur_inline14332__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v273 = Tile<
    ...
    // pto: %col_sum_v1_inline14325__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v387 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v387, v388);
    // pto: %row0_cur_inline14329__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v389 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v389, v390);
    // pto: %row1_cur_inline14330__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v391 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v391, v392);
    // pto: %row2_cur_inline14341__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v393 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v393, v394);
    // pto: %row3_cur_inline14332__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v395 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    // pto: %comb_t_inline9848__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: inv_rms_inline14231__ssa_v1
    __gm__ Tensor *inv_rms_inline14231__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *inv_rms_inline14231__ssa_v1 =
        reinterpret_cast<__gm__ float *>(inv_rms_inline14231__ssa_v1_tensor->buffer.addr) +
        inv_rms_inline14231__ssa_v1_tensor->start_offset;

    // Unpack tensor: mixes_raw_inline14254__ssa_v1
    __gm__ Tensor *mixes_raw_inline14254__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *mixes_raw_inline14254__ssa_v1 =
        reinterpret_cast<__gm__ float *>(mixes_raw_inline14254__ssa_v1_tensor->buffer.addr) +
        mixes_raw_inline14254__ssa_v1_tensor->start_offset;

    // Unpack tensor: hc_base_2d_inline14291__ssa_v0
    __gm__ Tensor *hc_base_2d_inline14291__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *hc_base_2d_inline14291__ssa_v0 =
        reinterpret_cast<__gm__ float *>(hc_base_2d_inline14291__ssa_v0_tensor->buffer.addr) +
        hc_base_2d_inline14291__ssa_v0_tensor->start_offset;
    ...
    float scale2_inline14256__ssa_v0 = hc_scale[2];

    // Extract dynamic dim: t_linear_inline14281__ssa_v0
    int64_t t_linear_inline14281__ssa_v0 = static_cast<int64_t>(inv_rms_inline14231__ssa_v1_tensor->shapes[0]);

    // Forward to ptoas-generated function
    comb_sinkhorn_1(
        inv_rms_inline14231__ssa_v1, mixes_raw_inline14254__ssa_v1, hc_base_2d_inline14291__ssa_v0,
        comb_t_inline9848__ssa_v0, scale2_inline14256__ssa_v0, t_linear_inline14281__ssa_v0, __pypto_spmd_block_idx,
