...
mix_x_7(__gm__ float *v1, __gm__ bfloat16_t *v2, __gm__ float *v3, int64_t v4, int64_t v5, int32_t v6, int32_t v7) {
    ...
    // pto: %pre_val_store_inline15141__ssa_v1_pview
    ...
    TASSIGN(v39, v40);
    // pto: %pre_tile_t_inline15142__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v41 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    for (int64_t i59 = v21; i59 < v14; i59 += v12) {
        ...
        // pto: %x_mixed_inline12448__iter_v1_pview
        ...
        // pto: %x_mixed_inline12448__tile_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: pre_val_store_inline15141__ssa_v1
    __gm__ Tensor *pre_val_store_inline15141__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *pre_val_store_inline15141__ssa_v1 =
        reinterpret_cast<__gm__ float *>(pre_val_store_inline15141__ssa_v1_tensor->buffer.addr) +
        pre_val_store_inline15141__ssa_v1_tensor->start_offset;

    // Unpack tensor: x_mixed_inline12448__ssa_v0
    __gm__ Tensor *x_mixed_inline12448__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ bfloat16_t *x_mixed_inline12448__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(x_mixed_inline12448__ssa_v0_tensor->buffer.addr) +
        x_mixed_inline12448__ssa_v0_tensor->start_offset;

    // Unpack tensor: x_flat_inline15158__ssa_v0
    __gm__ Tensor *x_flat_inline15158__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    ...
    int64_t t_linear_inline15163__ssa_v0 = static_cast<int64_t>(pre_val_store_inline15141__ssa_v1_tensor->shapes[0]);

    // Extract dynamic dim: t_dim_inline15145__ssa_v0
    int64_t t_dim_inline15145__ssa_v0 = static_cast<int64_t>(x_flat_inline15158__ssa_v0_tensor->shapes[0]);

    // Forward to ptoas-generated function
    mix_x_7(
        pre_val_store_inline15141__ssa_v1, x_mixed_inline12448__ssa_v0, x_flat_inline15158__ssa_v0,
        t_linear_inline15163__ssa_v0, t_dim_inline15145__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
