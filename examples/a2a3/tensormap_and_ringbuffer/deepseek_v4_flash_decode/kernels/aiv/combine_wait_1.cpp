 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: combine_wait_1
...
static __aicore__ void combine_wait_1(__gm__ int32_t *v1, int32_t v2, int32_t v3, __gm__ int64_t *v4) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    csa_moe_epoch_inline715__ssa_v0_conv.u64 = args[2];
    ...
    combine_wait_1(combine_arrived__ssa_v0, my_rank__ssa_v0, csa_moe_epoch_inline715__ssa_v0, combine_arrived_ctx);
}
