...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *rope_cos_t_inline10511__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    ...
    __gm__ Tensor *rope_sin_t_inline10813__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    __gm__ Tensor *step_cos_inline10504__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    ...
    __gm__ Tensor *step_sin_inline10488__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
