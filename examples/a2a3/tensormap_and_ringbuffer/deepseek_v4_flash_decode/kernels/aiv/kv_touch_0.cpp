...
static __aicore__ void kv_touch_0(__gm__ bfloat16_t *v1, int64_t v2) {
    const int64_t v3 = 8;
    ...
    TASSIGN(v6, v7);
    // pto: %ori_kv_flat_inline2164_inline12781__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    int64_t ori_block_num_inline2165_inline12779__ssa_v0 =
        (static_cast<int64_t>(ori_kv_flat_inline2164_inline12781__ssa_v0_tensor->shapes[0]) / 128);

    // Forward to ptoas-generated function
    kv_touch_0(ori_kv_flat_inline2164_inline12781__ssa_v0, ori_block_num_inline2165_inline12779__ssa_v0);
}
