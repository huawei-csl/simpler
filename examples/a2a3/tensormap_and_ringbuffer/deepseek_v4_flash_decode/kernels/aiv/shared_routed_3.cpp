 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: shared_routed_3
...
static __aicore__ void shared_routed_3(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %t_inline2815_inline12863__ssa_v0
    ...
    if (v17 < v4) {
        ...
        // pto: %sh_inline13063__rv_v2_pview
        ...
        // pto: %acc_inline2814_inline13056__tile
        Tile<
        ...
        // pto: %ffn_out_inline12872__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: sh_inline13063__rv_v2
    __gm__ Tensor *sh_inline13063__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ bfloat16_t *sh_inline13063__rv_v2 =
        reinterpret_cast<__gm__ bfloat16_t *>(sh_inline13063__rv_v2_tensor->buffer.addr) +
        sh_inline13063__rv_v2_tensor->start_offset;
    ...
    // Unpack tensor: ffn_out_inline12872__ssa_v0
    __gm__ Tensor *ffn_out_inline12872__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ bfloat16_t *ffn_out_inline12872__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(ffn_out_inline12872__ssa_v0_tensor->buffer.addr) +
        ffn_out_inline12872__ssa_v0_tensor->start_offset;

    // Unpack scalar: active_tokens_inline2816_inline13087__phi_v4
    union {
        uint64_t u64;
        int64_t val;
    } active_tokens_inline2816_inline13087__phi_v4_conv;
    active_tokens_inline2816_inline13087__phi_v4_conv.u64 = args[3];
    int64_t active_tokens_inline2816_inline13087__phi_v4 = active_tokens_inline2816_inline13087__phi_v4_conv.val;
    ...
    shared_routed_3(
        sh_inline13063__rv_v2, routed_y_buf__ssa_v0, ffn_out_inline12872__ssa_v0,
        active_tokens_inline2816_inline13087__phi_v4, routed_y_buf_ctx, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
