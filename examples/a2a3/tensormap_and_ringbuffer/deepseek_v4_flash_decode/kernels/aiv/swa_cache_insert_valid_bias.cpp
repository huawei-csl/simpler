...
static __aicore__ void swa_cache_insert_valid_bias(
    ...
    for (int64_t i19 = v18; i19 < v14; i19 += v15) {
        // pto: %write_row_i64_inline8836__tile
        int64_t v20 = (v2)[i19];
        // pto: %10
        if (v20 >= v18) {
            // pto: %t__tile
    ...
    TASSIGN(v42, v43);
    // pto: %v_lens_inline8848__rm_a0_tmp_v0
    Tile<
        TileType::Vec, int32_t, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v44 = Tile<
    ...
    TASSIGN(v44, v45);
    // pto: %v_lens_inline8848__row_major_tmp_v1
    Tile<
    ...
    // pto: %sparse_bias_inline9002__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: kv_cache_flat_inline9080__ssa_v0
    __gm__ Tensor *kv_cache_flat_inline9080__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ bfloat16_t *kv_cache_flat_inline9080__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(kv_cache_flat_inline9080__ssa_v0_tensor->buffer.addr) +
        kv_cache_flat_inline9080__ssa_v0_tensor->start_offset;
    ...
    // Unpack tensor: kv_inline9025__ssa_v0
    __gm__ Tensor *kv_inline9025__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ bfloat16_t *kv_inline9025__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(kv_inline9025__ssa_v0_tensor->buffer.addr) +
        kv_inline9025__ssa_v0_tensor->start_offset;
    ...
    // Unpack tensor: sparse_bias_inline9002__ssa_v0
    __gm__ Tensor *sparse_bias_inline9002__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ float *sparse_bias_inline9002__ssa_v0 =
        reinterpret_cast<__gm__ float *>(sparse_bias_inline9002__ssa_v0_tensor->buffer.addr) +
        sparse_bias_inline9002__ssa_v0_tensor->start_offset;

    // Extract dynamic dim: ori_block_num_inline9079__ssa_v0
    int64_t ori_block_num_inline9079__ssa_v0 =
        (static_cast<int64_t>(kv_cache_flat_inline9080__ssa_v0_tensor->shapes[0]) / 128);

    // Forward to ptoas-generated function
    swa_cache_insert_valid_bias(
        kv_cache_flat_inline9080__ssa_v0, swa_slot_mapping_inline576__ssa_v0, kv_inline9025__ssa_v0,
        swa_lens_inline628__ssa_v0, sparse_bias_inline9002__ssa_v0, ori_block_num_inline9079__ssa_v0
    );
}
