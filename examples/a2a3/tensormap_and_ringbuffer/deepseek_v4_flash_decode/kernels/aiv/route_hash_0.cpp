...
static __aicore__ void route_hash_0(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %th_idx_inline2540_inline9984__ssa_v0, %5
    int64_t v23 = (int64_t)((uint64_t)((int64_t)v7) * (uint64_t)v14);
    // pto: %hs_idx_tile_inline2593_inline10006__tile
    Tile<
    ...
    // pto: %local_scores_inline2591_inline9983__tile
    Tile<
    ...
    TASSIGN(v35, v36);
    // pto: %route_scores_buf_inline2607_inline10035__ssa_v1_pview
    pto::Shape<1, 1, 1, 8, 256> v37 = pto::Shape<1, 1, 1, 8, 256>();
    // pto: %route_scores_buf_inline2607_inline10035__ssa_v1_pview
    pto::Stride<2048, 2048, 2048, 256, 1> v38 = pto::Stride<2048, 2048, 2048, 256, 1>();
    // pto: %15, %route_scores_buf_inline2607_inline10035__ssa_v1_pview
    ...
    // pto: %gather_all_inline2535_inline10013__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v64 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %hs_vals_pad_inline2532_inline10215__tile
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TFILLPAD(v66, v64);
    // pto: %hs_idx_read_inline2531_inline9962__tile
    Tile<
        TileType::Vec, int32_t, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v68 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TROWSUM(v80, v66, v78);
    // pto: %hs_denom_inline2530_inline10211__tile
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v82 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %hs_weights_pad_inline2529_inline9960__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v86 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: tid2eid_l1_inline725__ssa_v0
    __gm__ Tensor *tid2eid_l1_inline725__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int32_t *tid2eid_l1_inline725__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(tid2eid_l1_inline725__ssa_v0_tensor->buffer.addr) +
        tid2eid_l1_inline725__ssa_v0_tensor->start_offset;

    // Unpack tensor: route_scores_buf_inline2607_inline10035__ssa_v1
    __gm__ Tensor *route_scores_buf_inline2607_inline10035__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *route_scores_buf_inline2607_inline10035__ssa_v1 =
        reinterpret_cast<__gm__ float *>(route_scores_buf_inline2607_inline10035__ssa_v1_tensor->buffer.addr) +
        route_scores_buf_inline2607_inline10035__ssa_v1_tensor->start_offset;

    // Unpack tensor: indices_inline10048__ssa_v0
    __gm__ Tensor *indices_inline10048__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    ...
    // Unpack scalar: active_tokens_inline2578_inline9997__phi_v4
    union {
        uint64_t u64;
        int64_t val;
    } active_tokens_inline2578_inline9997__phi_v4_conv;
    active_tokens_inline2578_inline9997__phi_v4_conv.u64 = args[5];
    int64_t active_tokens_inline2578_inline9997__phi_v4 = active_tokens_inline2578_inline9997__phi_v4_conv.val;

    // Forward to ptoas-generated function
    route_hash_0(
        input_ids__ssa_v0, tid2eid_l1_inline725__ssa_v0, route_scores_buf_inline2607_inline10035__ssa_v1,
        indices_inline10048__ssa_v0, weights_inline10038__ssa_v0, active_tokens_inline2578_inline9997__phi_v4,
