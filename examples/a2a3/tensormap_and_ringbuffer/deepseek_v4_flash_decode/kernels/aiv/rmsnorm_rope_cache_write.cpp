...
static __aicore__ void rmsnorm_rope_cache_write(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %cos_b_inline1833_inline10688__tile
    Tile<
    ...
    TEXPANDS(v41, v25);
    // pto: %sin_b_inline1832_inline10642__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v43 = Tile<
    ...
    TASSIGN(v45, v46);
    // pto: %cmp_cos_il_inline10546__ssa_v1_pview
    ...
    TASSIGN(v53, v54);
    // pto: %cmp_sin_signed_inline10493__ssa_v1_pview
    ...
    // pto: %partial_sq_inline1856_inline10418__tile
    Tile<
    ...
    for (int64_t i63 = v38; i63 < v27; i63 += v30) {
        // pto: %kv_rms_chunk_inline1827_inline10507__tile
        Tile<
            TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v64 = Tile<
        ...
        // pto: %kv_rms_sq_inline1826_inline10920__tile
        Tile<
            TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v69 = Tile<
        ...
        TROWSUM(v73, v69, v71);
        set_flag(PIPE_V, PIPE_MTE2, EVENT_ID2);
        // pto: %kv_rms_rowsum_inline1825_inline10744__tile
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v75 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TADDS(v81, v79, v22);
    // pto: %variance_inline1824_inline10747__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v83 = Tile<
    ...
    TASSIGN(v89, v90);
    // pto: %inv_rms_inline1841_inline10361__rm_a0_tmp_v2
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v91 = Tile<
    ...
    TASSIGN(v91, v92);
    // pto: %inv_rms_inline1841_inline10361__row_major_tmp_v3
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v93 = Tile<
    ...
    // pto: %inv_rms_inline1841_inline10361__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v95 = Tile<
    ...
    for (int64_t i97 = v38; i97 < v21; i97 += v30) {
        // pto: %kv_norm_chunk_inline1882_inline10452__tile
        Tile<
            TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v98 = Tile<
        ...
        TASSIGN(v104, v105);
        // pto: %norm_w_2d_inline1842_inline10405__ssa_v0_pview
        ...
        // pto: %gamma_inline1823_inline10749__tile
        Tile<
        ...
        // pto: %normed_chunk_inline1849_inline10750__tile
        Tile<
            TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v113 = Tile<
        ...
        // pto: %normed_kv_inline1835_inline10702__iter_v1_pview
    ...
    // pto: %kv_rope_norm_inline1914_inline10560__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v118 = Tile<
    ...
    // pto: %gamma_rope_inline1822_inline10752__tile
    Tile<
        TileType::Vec, float, 1, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v128 = Tile<
    ...
    // pto: %rope_normed_inline1848_inline10755__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v132 = Tile<
    ...
    // pto: %rope_ones_inline1845_inline10757__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v134 = Tile<
    ...
    // pto: %rope_col_inline1831_inline10321__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v140 = Tile<
    ...
    // pto: %rope_dup_f_inline1893_inline10786__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v146 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMULS(v148, v146, v17);
    // pto: %rope_lane_inline1829_inline10759__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v150 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TSUB(v156, v152, v154);
    // pto: %rope_swap_idx_inline1828_inline10762__tile
    Tile<
        TileType::Vec, int32_t, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v158 = Tile<
    ...
    // pto: %swapped_inline1898_inline10607__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v181 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMUL(v185, v181, v43);
    // pto: %rope_rot_inline1858_inline10764__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v187 = Tile<
    ...
    // pto: %normed_kv_inline1835_inline10702__rv_v2_pview
    ...
    for (int64_t i192 = v38; i192 < v31; i192 += v29) {
        ...
        // pto: %first_pos_b_inline1905_inline10699__tile
        int32_t v194 = (v8)[v193];
        // pto: %34, %35
        int64_t v195 = (int64_t)v194 % v31;
        // pto: %36
        if (v195 >= v26) {
            // pto: %kv_row_fp32_inline1834_inline10617__tile
            Tile<
            ...
            if (v201 >= v38) {
                ...
                // pto: %cmp_kv_cache_flat_inline1870_inline10523__iter_v1_pview
                pto::Shape<1, 1, 1, 1, 512> v207 = pto::Shape<1, 1, 1, 1, 512>();
                // pto: %cmp_kv_cache_flat_inline1870_inline10523__iter_v1_pview
                pto::Stride<512, 512, 512, 512, 1> v208 = pto::Stride<512, 512, 512, 512, 1>();
                // pto: %46, %cmp_kv_cache_flat_inline1870_inline10523__iter_v1_pview
                GlobalTensor<
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: cmp_cos_il_inline10546__ssa_v1
    __gm__ Tensor *cmp_cos_il_inline10546__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *cmp_cos_il_inline10546__ssa_v1 =
        reinterpret_cast<__gm__ float *>(cmp_cos_il_inline10546__ssa_v1_tensor->buffer.addr) +
        cmp_cos_il_inline10546__ssa_v1_tensor->start_offset;

    // Unpack tensor: cmp_sin_signed_inline10493__ssa_v1
    __gm__ Tensor *cmp_sin_signed_inline10493__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *cmp_sin_signed_inline10493__ssa_v1 =
        reinterpret_cast<__gm__ float *>(cmp_sin_signed_inline10493__ssa_v1_tensor->buffer.addr) +
        cmp_sin_signed_inline10493__ssa_v1_tensor->start_offset;

    // Unpack tensor: pooled_kv_inline1855_inline10468__rv_v2
    __gm__ Tensor *pooled_kv_inline1855_inline10468__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *pooled_kv_inline1855_inline10468__rv_v2 =
        reinterpret_cast<__gm__ float *>(pooled_kv_inline1855_inline10468__rv_v2_tensor->buffer.addr) +
        pooled_kv_inline1855_inline10468__rv_v2_tensor->start_offset;

    // Unpack tensor: normed_kv_inline1835_inline10702__ssa_v0
    __gm__ Tensor *normed_kv_inline1835_inline10702__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    __gm__ float *normed_kv_inline1835_inline10702__ssa_v0 =
        reinterpret_cast<__gm__ float *>(normed_kv_inline1835_inline10702__ssa_v0_tensor->buffer.addr) +
        normed_kv_inline1835_inline10702__ssa_v0_tensor->start_offset;

    // Unpack tensor: norm_w_2d_inline1842_inline10405__ssa_v0
    __gm__ Tensor *norm_w_2d_inline1842_inline10405__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ bfloat16_t *norm_w_2d_inline1842_inline10405__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(norm_w_2d_inline1842_inline10405__ssa_v0_tensor->buffer.addr) +
        norm_w_2d_inline1842_inline10405__ssa_v0_tensor->start_offset;

    // Unpack tensor: cmp_kv_cache_flat_inline1870_inline10523__ssa_v0
    __gm__ Tensor *cmp_kv_cache_flat_inline1870_inline10523__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[5]);
    __gm__ bfloat16_t *cmp_kv_cache_flat_inline1870_inline10523__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(cmp_kv_cache_flat_inline1870_inline10523__ssa_v0_tensor->buffer.addr) +
        cmp_kv_cache_flat_inline1870_inline10523__ssa_v0_tensor->start_offset;

    // Unpack tensor: kv_flat_inline1901_inline10417__ssa_v0
    __gm__ Tensor *kv_flat_inline1901_inline10417__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[6]);
    __gm__ float *kv_flat_inline1901_inline10417__ssa_v0 =
        reinterpret_cast<__gm__ float *>(kv_flat_inline1901_inline10417__ssa_v0_tensor->buffer.addr) +
        kv_flat_inline1901_inline10417__ssa_v0_tensor->start_offset;

    // Unpack tensor: position_ids_bsd_inline10328__ssa_v0
    __gm__ Tensor *position_ids_bsd_inline10328__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[7]);
    ...
    // Unpack tensor: cmp_slot_mapping_bsd_inline10327__ssa_v0
    __gm__ Tensor *cmp_slot_mapping_bsd_inline10327__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[8]);
    __gm__ int64_t *cmp_slot_mapping_bsd_inline10327__ssa_v0 =
        reinterpret_cast<__gm__ int64_t *>(cmp_slot_mapping_bsd_inline10327__ssa_v0_tensor->buffer.addr) +
        cmp_slot_mapping_bsd_inline10327__ssa_v0_tensor->start_offset;

    // Extract dynamic dim: cmp_block_num_inline1877_inline10324__ssa_v0
    int64_t cmp_block_num_inline1877_inline10324__ssa_v0 =
        (static_cast<int64_t>(cmp_kv_cache_flat_inline1870_inline10523__ssa_v0_tensor->shapes[0]) / 128);

    // Forward to ptoas-generated function
    rmsnorm_rope_cache_write(
        cmp_cos_il_inline10546__ssa_v1, cmp_sin_signed_inline10493__ssa_v1, pooled_kv_inline1855_inline10468__rv_v2,
        normed_kv_inline1835_inline10702__ssa_v0, norm_w_2d_inline1842_inline10405__ssa_v0,
        cmp_kv_cache_flat_inline1870_inline10523__ssa_v0, kv_flat_inline1901_inline10417__ssa_v0,
        position_ids_bsd_inline10328__ssa_v0, cmp_slot_mapping_bsd_inline10327__ssa_v0,
        cmp_block_num_inline1877_inline10324__ssa_v0
    );
}
