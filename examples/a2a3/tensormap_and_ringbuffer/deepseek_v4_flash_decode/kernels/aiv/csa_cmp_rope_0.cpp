...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *cmp_cos_inline12490__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[0]);
    ...
    __gm__ ChipTensor *cmp_sin_inline12261__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[1]);
