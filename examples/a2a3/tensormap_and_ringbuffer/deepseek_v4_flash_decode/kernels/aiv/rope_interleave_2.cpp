 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: rope_interleave_2
...
static __aicore__ void rope_interleave_2(__gm__ float *v1, __gm__ float *v2, __gm__ float *v3, __gm__ float *v4) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %il_ones_inline1631_inline12584__tile
    Tile<
    ...
    TCVT(v28, v26, v7, v6);
    // pto: %il_col_inline1630_inline12555__tile
    Tile<
        TileType::Vec, float, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v30 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v34, v32, v5, v6);
    // pto: %il_dup_f_inline1629_inline12449__tile
    Tile<
        TileType::Vec, float, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v36 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v36, v34, v7, v6);
    // pto: %il_dup_idx_inline1628_inline12366__tile
    Tile<
        TileType::Vec, int32_t, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v38 = Tile<
    ...
    // pto: %il_lane_inline1627_inline12456__tile
    Tile<
        TileType::Vec, float, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v42 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMULS(v44, v42, v8);
    // pto: %il_sign_inline1626_inline12489__tile
    Tile<
        TileType::Vec, float, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v46 = Tile<
    ...
    TASSIGN(v48, v49);
    // pto: %step_cos_inline12428__rv_v2_pview
    ...
    TASSIGN(v74, v75);
    // pto: %step_cos_il_inline12430__ssa_v0_pview
    ...
    TASSIGN(v79, v80);
    // pto: %step_sin_inline12412__rv_v2_pview
    ...
    // pto: %step_sin_signed_inline12365__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    rope_interleave_2(
        step_cos_inline12428__rv_v2, step_cos_il_inline12430__ssa_v0, step_sin_inline12412__rv_v2,
        step_sin_signed_inline12365__ssa_v0
    );
}
