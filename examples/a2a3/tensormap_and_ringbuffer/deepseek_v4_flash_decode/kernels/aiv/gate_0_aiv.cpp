...
static __aicore__ void gate_0_aic(
    ...
    // pto: %gate_logits_tile_inline2592_inline10098__tile_l0_c_phi
    Tile<
    ...
    TASSIGN(v27, v28);
    // pto: %gd_x_inline2620_inline9972__tile
    Tile<
    ...
    TLOAD(v29, v34);
    // pto: %gd_w_inline2571_inline9965__tile
    Tile<
        TileType::Mat, float, 16, 2048, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
        CompactMode::Null>
        v35 = Tile<
    ...
    // pto: %gate_w_l1_inline693__ssa_v0_pview
    ...
    // pto: %gd_w_inline2571_inline9965__tile_t
    Tile<
    ...
    TASSIGN(v51, v52);
    // pto: %gate_logits_tile_inline2592_inline10098__tile_l0_init
    Tile<
        TileType::Acc, float, 16, 16, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
        CompactMode::Null>
        v53 = Tile<
    ...
    for (int64_t i55 = v19; i55 < v12; i55 += v11) {
        // pto: %gate_logits_tile_inline2592_inline10098__tile_l0_a
        Tile<
        ...
        // pto: %gate_logits_tile_inline2592_inline10098__tile_l0_b
        Tile<
        ...
        if (i55 == v19) {
            // pto: %gate_logits_tile_inline2592_inline10098__tile_l0_c_first
            Tile<
                TileType::Acc, float, 16, 16, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                CompactMode::Null>
                v65 = Tile<
            ...
            // pto: %gate_logits_tile_inline2592_inline10098__tile_l0_c_acc
            Tile<
                TileType::Acc, float, 16, 16, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                CompactMode::Null>
                v67 = Tile<
...
static __aicore__ void gate_0_aiv(
    __gm__ float *v1, __gm__ float *v2, __gm__ float *v3, __gm__ float *v4, __gm__ float *v5, __gm__ float *v6,
    ...
    if ((int64_t)v9 == v16) {
        ...
        TLOAD(v28, v33);
        // pto: %gate_logits_tile_inline2592_inline10098__rv_v2_Vec
        Tile<
        ...
        // pto: %gate_logits_tile_v1_inline2568_inline10142__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v35 = Tile<
        ...
        // pto: %gp_relu_inline2577_inline10045__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v37 = Tile<
        ...
        TASSIGN(v39, v40);
        TNEG(v39, v35);
        // pto: %gp_abs_inline2545_inline10071__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v41 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TLOG(v49, v47);
        // pto: %gp_softplus_log_inline2547_inline10028__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v51 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TMAXS(v57, v55, v14);
        // pto: %gp_neg_floor_mask_inline2544_inline10069__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v59 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TEXP(v63, v61);
        // pto: %gp_neg_floor_inline2550_inline9969__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v65 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TMUL(v65, v59, v63);
        // pto: %gp_softplus_inline2543_inline10059__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v67 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TMAX(v67, v51, v65);
        // pto: %gp_score_inline2542_inline9980__tile
        Tile<
            TileType::Vec, float, 16, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v69 = Tile<
        ...
        // pto: %route_scores_buf_inline2607_inline10035__ssa_v0_pview
        pto::Shape<1, 1, 1, 16, 16> v71 = pto::Shape<1, 1, 1, 16, 16>();
        // pto: %route_scores_buf_inline2607_inline10035__ssa_v0_pview
        pto::Stride<4096, 4096, 4096, 256, 1> v72 = pto::Stride<4096, 4096, 4096, 256, 1>();
        // pto: %route_scores_buf_inline2607_inline10035__ssa_v0_pview, %36
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: gate_bias_l1_inline586__ssa_v0
    __gm__ Tensor *gate_bias_l1_inline586__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *gate_bias_l1_inline586__ssa_v0 =
        reinterpret_cast<__gm__ float *>(gate_bias_l1_inline586__ssa_v0_tensor->buffer.addr) +
        gate_bias_l1_inline586__ssa_v0_tensor->start_offset;

    // Unpack tensor: xg_buf_inline2582_inline10158__ssa_v0
    __gm__ Tensor *xg_buf_inline2582_inline10158__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    // Unpack tensor: gate_w_l1_inline693__ssa_v0
    __gm__ Tensor *gate_w_l1_inline693__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *gate_w_l1_inline693__ssa_v0 =
        reinterpret_cast<__gm__ float *>(gate_w_l1_inline693__ssa_v0_tensor->buffer.addr) +
        gate_w_l1_inline693__ssa_v0_tensor->start_offset;
    ...
    // Unpack tensor: route_scores_buf_inline2607_inline10035__ssa_v0
    __gm__ Tensor *route_scores_buf_inline2607_inline10035__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ float *route_scores_buf_inline2607_inline10035__ssa_v0 =
        reinterpret_cast<__gm__ float *>(route_scores_buf_inline2607_inline10035__ssa_v0_tensor->buffer.addr) +
        route_scores_buf_inline2607_inline10035__ssa_v0_tensor->start_offset;
    ...
    gate_0_aiv(
        gate_bias_l1_inline586__ssa_v0, xg_buf_inline2582_inline10158__ssa_v0, gate_w_l1_inline693__ssa_v0,
        inv_rms_buf_inline2585_inline10044__ssa_v0, route_scores_buf_inline2607_inline10035__ssa_v0, __gm_pipe_buffer,
