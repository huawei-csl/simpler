 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: dispatch_meta_1
...
static __aicore__ void dispatch_meta_1(
    ...
    set_flag(PIPE_MTE3, PIPE_S, EVENT_ID0);
    // pto: %1, %active_tokens_inline2713_inline11204__phi_v4
    // pto: %cursor_inline2708_inline11152__ssa_v0
    int32_t v23[64];
    ...
    for (int64_t i27 = v21; i27 < (v22 > v20 ? v20 : v22); i27 += v18) {
        for (int64_t j28 = v21; j28 < v19; j28 += v18) {
            // pto: %flat_offset_mul, %flat_offset, %eid_inline2694_inline11217__tile
    ...
    // pto: %meta_tile_inline2721_inline11220__ssa_v0
    Tile<
    ...
    for (int64_t i58 = v21; i58 < v16; i58 += v18) {
        // pto: %acc_inline2718_inline11264__rv_v2
        int32_t v59;
        v59 = v15;
        for (int64_t j60 = v21; j60 < v17; j60 += v18) {
            ...
            // pto: %count_inline2688_inline11218__tile
            int32_t v63 = (v2)[v62];
            (v4)[v62] = v63;
            // pto: %57
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *recv_meta_local_inline11212__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    ...
    // Unpack tensor: recv_count_out_inline11145__ssa_v0
    __gm__ Tensor *recv_count_out_inline11145__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ int32_t *recv_count_out_inline11145__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(recv_count_out_inline11145__ssa_v0_tensor->buffer.addr) +
        recv_count_out_inline11145__ssa_v0_tensor->start_offset;
    ...
    csa_moe_epoch_inline715__ssa_v0_conv.u64 = args[7];
    ...
    dispatch_meta_1(
        indices_inline11093__ssa_v0, recv_meta__ssa_v0, arrived__ssa_v0, recv_meta_local_inline11212__ssa_v0,
        recv_count_out_inline11145__ssa_v0, nt_inline677__rv_v2, my_rank__ssa_v0, csa_moe_epoch_inline715__ssa_v0,
