...
static __aicore__ void split_pre_post_2(
    ...
    // pto: %ob_inline14374__ssa_v0, %14
    int64_t v28 = (int64_t)((uint64_t)((int64_t)v9) * (uint64_t)v17);
    // pto: %inv_col_inline14441__tile
    Tile<
    ...
    TASSIGN(v38, v39);
    // pto: %hc_ffn_base_l1_inline720__ssa_v0_pview
    ...
    TLOAD(v38, v42);
    // pto: %pre_base_inline14372__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v43 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %pre_scaled_inline14405__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v52 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %pre_logits_inline14371__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v56 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %pre_val_store_inline14386__ssa_v0_pview
    ...
    TLOAD(v71, v75);
    // pto: %post_base_inline14365__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v76 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %post_scaled_inline14385__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v85 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v87, v88);
    TCOLEXPAND(v87, v76);
    // pto: %post_logits_inline14460__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v89 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TADDS(v95, v93, v15);
    // pto: %post_sig_inline14367__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v97 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TRECIP(v97, v95);
    // pto: %post_pad_inline14363__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v99 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v104, v105);
    // pto: %post_ffn_inline10003__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: hc_ffn_base_l1_inline720__ssa_v0
    __gm__ Tensor *hc_ffn_base_l1_inline720__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *hc_ffn_base_l1_inline720__ssa_v0 =
        reinterpret_cast<__gm__ float *>(hc_ffn_base_l1_inline720__ssa_v0_tensor->buffer.addr) +
        hc_ffn_base_l1_inline720__ssa_v0_tensor->start_offset;

    // Unpack tensor: mixes_raw_inline14381__ssa_v1
    __gm__ Tensor *mixes_raw_inline14381__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    ...
    // Unpack tensor: pre_val_store_inline14386__ssa_v0
    __gm__ Tensor *pre_val_store_inline14386__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    __gm__ float *pre_val_store_inline14386__ssa_v0 =
        reinterpret_cast<__gm__ float *>(pre_val_store_inline14386__ssa_v0_tensor->buffer.addr) +
        pre_val_store_inline14386__ssa_v0_tensor->start_offset;

    // Unpack tensor: post_ffn_inline10003__ssa_v0
    __gm__ Tensor *post_ffn_inline10003__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ float *post_ffn_inline10003__ssa_v0 =
        reinterpret_cast<__gm__ float *>(post_ffn_inline10003__ssa_v0_tensor->buffer.addr) +
        post_ffn_inline10003__ssa_v0_tensor->start_offset;
    ...
    float scale0_inline14397__ssa_v0 = hc_scale[0];
    float scale1_inline14417__ssa_v0 = hc_scale[1];
    ...
    split_pre_post_2(
        inv_rms_inline14358__ssa_v1, hc_ffn_base_l1_inline720__ssa_v0, mixes_raw_inline14381__ssa_v1,
        pre_val_store_inline14386__ssa_v0, post_ffn_inline10003__ssa_v0, scale0_inline14397__ssa_v0,
        scale1_inline14417__ssa_v0, t_linear_inline14408__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
