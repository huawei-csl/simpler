...
static __aicore__ void route_hash_1(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %th_idx_inline2540_inline11029__ssa_v0, %5
    int64_t v23 = (int64_t)((uint64_t)((int64_t)v7) * (uint64_t)v14);
    // pto: %hs_idx_tile_inline2593_inline11051__tile
    Tile<
    ...
    // pto: %15, %route_scores_buf_inline2607_inline11080__ssa_v1_pview
    ...
    // pto: %hs_vals_pad_inline2532_inline11260__tile
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TFILLPAD(v66, v64);
    // pto: %hs_idx_read_inline2531_inline11007__tile
    Tile<
        TileType::Vec, int32_t, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v68 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TROWSUM(v80, v66, v78);
    // pto: %hs_denom_inline2530_inline11256__tile
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v82 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %hs_weights_pad_inline2529_inline11005__tile
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v86 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: tid2eid_csa_inline537__ssa_v0
    __gm__ Tensor *tid2eid_csa_inline537__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int32_t *tid2eid_csa_inline537__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(tid2eid_csa_inline537__ssa_v0_tensor->buffer.addr) +
        tid2eid_csa_inline537__ssa_v0_tensor->start_offset;

    // Unpack tensor: route_scores_buf_inline2607_inline11080__ssa_v1
    __gm__ Tensor *route_scores_buf_inline2607_inline11080__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    ...
    __gm__ Tensor *indices_inline11093__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    ...
    active_tokens_inline2578_inline11042__phi_v4_conv.u64 = args[5];
    int64_t active_tokens_inline2578_inline11042__phi_v4 = active_tokens_inline2578_inline11042__phi_v4_conv.val;

    // Forward to ptoas-generated function
    route_hash_1(
        input_ids__ssa_v0, tid2eid_csa_inline537__ssa_v0, route_scores_buf_inline2607_inline11080__ssa_v1,
