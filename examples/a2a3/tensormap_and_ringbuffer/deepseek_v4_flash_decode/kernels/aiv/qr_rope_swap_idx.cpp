...
static __aicore__ void qr_rope_swap_idx(__gm__ int32_t *v1) {
    ...
    TCVT(v18, v16, v4, v3);
    // pto: %sw_col_inline1996_inline10809__tile
    Tile<
        TileType::Vec, float, 32, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v20 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v24, v22, v2, v3);
    // pto: %sw_dup_f_inline2032_inline10782__tile
    Tile<
        TileType::Vec, float, 32, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v26 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMULS(v28, v26, v5);
    // pto: %sw_lane_inline1990_inline10335__tile
    Tile<
        TileType::Vec, float, 32, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v30 = Tile<
    ...
    // pto: %rope_swap_idx_t_inline1970_inline10780__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: rope_swap_idx_t_inline1970_inline10780__ssa_v0
    __gm__ Tensor *rope_swap_idx_t_inline1970_inline10780__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ int32_t *rope_swap_idx_t_inline1970_inline10780__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(rope_swap_idx_t_inline1970_inline10780__ssa_v0_tensor->buffer.addr) +
        rope_swap_idx_t_inline1970_inline10780__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    qr_rope_swap_idx(rope_swap_idx_t_inline1970_inline10780__ssa_v0);
}
