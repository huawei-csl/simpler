 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: hc_pre_linear_reduce_3
...
hc_pre_linear_reduce_3(__gm__ float *v1, __gm__ float *v2, int64_t v3, int64_t v4, int64_t v5, int32_t v6, int32_t v7) {
    const int64_t v8 = 4;
    const int64_t v9 = 16;
    const int64_t v10 = 1;
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %linear_block_inline14547__ssa_v0, %1
    int64_t v14 = (int64_t)((uint64_t)((int64_t)v6) * (uint64_t)v9);
    // pto: %mixes_total_inline14516__tile
    Tile<
    ...
    // pto: %mixes_partials_inline14507__ssa_v1_pview
    ...
    // pto: %mixes_raw_inline14508__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    t_linear_inline14535__ssa_v0_conv.u64 = args[2];
    ...
    int64_t linear_partial_rows_inline14483__ssa_v0 =
        static_cast<int64_t>(mixes_partials_inline14507__ssa_v1_tensor->shapes[0]);

    // Extract dynamic dim: t_linear_inline14535__ssa_v0_1
    int64_t t_linear_inline14535__ssa_v0_1 = static_cast<int64_t>(mixes_raw_inline14508__ssa_v0_tensor->shapes[0]);

    // Forward to ptoas-generated function
    hc_pre_linear_reduce_3(
        mixes_partials_inline14507__ssa_v1, mixes_raw_inline14508__ssa_v0, t_linear_inline14535__ssa_v0,
        linear_partial_rows_inline14483__ssa_v0, t_linear_inline14535__ssa_v0_1, __pypto_spmd_block_idx,
