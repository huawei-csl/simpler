...
static __aicore__ void ffn_norm_3(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %tok_inline2569_inline12979__ssa_v0
    ...
    // pto: %x_mixed_inline12973__rv_v2_pview
    ...
    // pto: %rms_x_inline2565_inline12994__ssa_v0
    Tile<
    ...
    TASSIGN(v33, v34);
    // pto: %norm_w_2d_inline2589_inline13140__ssa_v0_pview
    ...
    // pto: %rms_w_inline2587_inline13132__ssa_v0
    Tile<
        TileType::Vec, float, 1, 4096, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v38 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v38, v33, v10, v9);
    // pto: %xg_inline2581_inline12971__ssa_v0
    Tile<
        TileType::Vec, float, 1, 4096, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v40 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMUL(v45, v31, v31);
    // pto: %sq_rows_inline2563_inline13046__ssa_v0
    Tile<
    ...
    TASSIGN(v47, v48);
    // pto: %sq_partial_tmp_inline2560_inline13030__ssa_v0
    Tile<
        TileType::Vec, float, 8, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v49 = Tile<
    ...
    TASSIGN(v49, v50);
    // pto: %sq_partial_inline2555_inline12962__ssa_v0
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TROWSUM(v51, v47, v49);
    // pto: %sq_reduce_inline2556_inline13143__ssa_v0
    Tile<
    ...
    // pto: %sq_sum_tmp_inline2617_inline12978__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v60 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v60, v61);
    // pto: %sq_sum_inline2574_inline12958__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v62 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TSQRT(v70, v68);
    // pto: %inv_rms_inline2616_inline12965__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v72 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TABS(v77, v40);
    // pto: %xg_abs_rows_inline2551_inline12942__ssa_v0
    Tile<
        TileType::Vec, float, 8, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v79 = Tile<
    ...
    TASSIGN(v79, v80);
    // pto: %amax_partial_tmp_inline2548_inline13022__ssa_v0
    Tile<
        TileType::Vec, float, 8, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v81 = Tile<
    ...
    TASSIGN(v81, v82);
    // pto: %amax_partial_inline2557_inline12977__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v83 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TROWMAX(v83, v79, v81);
    // pto: %amax_reduce_inline2552_inline13027__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v85 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %amax_tmp_inline2546_inline13041__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v92 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v92, v93);
    // pto: %xg_amax_inline2612_inline12969__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v94 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %amax_eps_inline2595_inline13039__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v98 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %xg_amax_v2_inline2597_inline13043__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v100 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TMAX(v100, v96, v98);
    // pto: %scale_max_inline2599_inline13166__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v102 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %xg_sq_inline2580_inline13047__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v104 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TDIV(v104, v102, v100);
    // pto: %xg_dequant_scale_inline2588_inline13085__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v106 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TMULS(v106, v100, v11);
    // pto: %x_norm_dequant_scale_inline2600_inline13050__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v108 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: x_mixed_inline12973__rv_v2
    __gm__ Tensor *x_mixed_inline12973__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ bfloat16_t *x_mixed_inline12973__rv_v2 =
        reinterpret_cast<__gm__ bfloat16_t *>(x_mixed_inline12973__rv_v2_tensor->buffer.addr) +
        x_mixed_inline12973__rv_v2_tensor->start_offset;

    // Unpack tensor: norm_w_2d_inline2589_inline13140__ssa_v0
    __gm__ Tensor *norm_w_2d_inline2589_inline13140__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ bfloat16_t *norm_w_2d_inline2589_inline13140__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(norm_w_2d_inline2589_inline13140__ssa_v0_tensor->buffer.addr) +
        norm_w_2d_inline2589_inline13140__ssa_v0_tensor->start_offset;
    ...
    __gm__ Tensor *x_norm_scale_inline12976__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    ...
    __gm__ Tensor *xn_scale_buf_inline2572_inline13089__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[5]);
    ...
    ffn_norm_3(
        x_mixed_inline12973__rv_v2, norm_w_2d_inline2589_inline13140__ssa_v0, xg_buf_inline2582_inline13127__ssa_v0,
        inv_rms_buf_inline2585_inline13013__ssa_v0, x_norm_scale_inline12976__ssa_v0,
        xn_scale_buf_inline2572_inline13089__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
