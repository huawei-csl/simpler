 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: comb_sinkhorn_0
...
static __aicore__ void comb_sinkhorn_0(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %inv_rms_inline14104__ssa_v1_view
    int64_t v45 = v6 * v22;
    // pto: %inv_rms_inline14104__ssa_v1_view
    int64_t v46 = v22 * v45;
    // pto: %inv_rms_inline14104__ssa_v1_view
    ...
    // pto: %ob_inline14108__ssa_v0, %56
    int64_t v50 = (int64_t)((uint64_t)((int64_t)v7) * (uint64_t)v21);
    // pto: %inv_col_t_inline14160__ssa_v0
    Tile<
    ...
    // pto: %inv_rms_inline14104__ssa_v1_pview
    ...
    TLOAD(v51, v59);
    // pto: %mix_g0_inline14167__ssa_v0
    Tile<
    ...
    TASSIGN(v60, v61);
    // pto: %mixes_raw_inline14127__ssa_v1_pview
    ...
    // pto: %mix_g1_inline14119__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v65 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TLOAD(v65, v69);
    // pto: %mix_g2_inline14105__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v70 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TLOAD(v70, v74);
    // pto: %mix_g3_inline14103__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v75 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v80, v81);
    // pto: %hc_base_2d_inline14164__ssa_v0_pview
    ...
    pipe_barrier(PIPE_V);
    TADD(v130, v126, v128);
    // pto: %row0_p_inline14171__ssa_v0
    ...
    TASSIGN(v132, v133);
    TFILLPAD(v132, v106);
    // pto: %row1_p_inline14159__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v134 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    TASSIGN(v134, v135);
    TFILLPAD(v134, v114);
    // pto: %row2_p_inline14173__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v136 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    TASSIGN(v136, v137);
    TFILLPAD(v136, v122);
    // pto: %row3_p_inline14174__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v138 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    pipe_barrier(PIPE_V);
    TFILLPAD(v138, v130);
    // pto: %row_max_tmp_inline14176__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v140 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v140, v141);
    // pto: %row_sum_tmp_inline14178__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v142 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v142, v143);
    // pto: %row0_max_inline14179__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v144 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row1_max_inline14181__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v146 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row2_max_inline14199__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v148 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row3_max_inline14182__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v150 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row0_exp_inline14122__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v154 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row1_exp_inline14185__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v158 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row2_exp_inline14186__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v162 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row3_exp_inline14134__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v166 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    pipe_barrier(PIPE_V);
    TEXP(v166, v164);
    // pto: %row0_sum_inline14183__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v168 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row1_sum_inline14188__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v170 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row2_sum_inline14204__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v172 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row3_sum_inline14189__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v174 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %row0_soft_inline14153__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v178 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row1_soft_inline14177__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v182 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row2_soft_inline14190__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v186 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row3_soft_inline14116__ssa_v0
    Tile<TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min, CompactMode::Null>
        v190 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>(v21, v21);
    ...
    // pto: %row0_eff_inline14140__ssa_v0
    Tile<
    ...
    TASSIGN(v192, v193);
    TFILLPAD(v192, v178);
    // pto: %row1_eff_inline14193__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v194 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v194, v195);
    TFILLPAD(v194, v182);
    // pto: %row2_eff_inline14194__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v196 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v196, v197);
    TFILLPAD(v196, v186);
    // pto: %row3_eff_inline14195__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v198 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    pipe_barrier(PIPE_V);
    TFILLPAD(v198, v190);
    // pto: %row_sum_tmp_iter_inline14180__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v200 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TADD(v204, v196, v198);
    // pto: %col_sum_inline14196__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v206 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    pipe_barrier(PIPE_V);
    TADD(v206, v202, v204);
    // pto: %col_sum_v1_inline14198__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v208 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    pipe_barrier(PIPE_V);
    TADDS(v208, v206, v19);
    // pto: %row0_cur_inline14202__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v210 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    pipe_barrier(PIPE_V);
    TDIV(v210, v192, v208);
    // pto: %row1_cur_inline14203__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v212 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v212, v213);
    TDIV(v212, v194, v208);
    // pto: %row2_cur_inline14214__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v214 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v214, v215);
    TDIV(v214, v196, v208);
    // pto: %row3_cur_inline14205__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v216 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    for (int64_t i218 = v24; i218 < v18; i218 += v17) {
        ...
        // pto: %row0_rowsum_inline14208__rm_a0_tmp_v0
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v221 = Tile<
        ...
        TASSIGN(v221, v222);
        // pto: %row0_rowsum_inline14208__row_major_tmp_v1
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v223 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v223, v221, v19);
        // pto: %row0_rowsum_inline14208__ssa_v0
        Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v225 = Tile<
        ...
        // pto: %row1_rowsum_inline14224__rm_a0_tmp_v2
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v229 = Tile<
        ...
        TASSIGN(v229, v230);
        // pto: %row1_rowsum_inline14224__row_major_tmp_v3
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v231 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v231, v229, v19);
        // pto: %row1_rowsum_inline14224__ssa_v0
        Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v233 = Tile<
        ...
        // pto: %row2_rowsum_inline14211__rm_a0_tmp_v4
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v237 = Tile<
        ...
        TASSIGN(v237, v238);
        // pto: %row2_rowsum_inline14211__row_major_tmp_v5
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v239 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v239, v237, v19);
        // pto: %row2_rowsum_inline14211__ssa_v0
        Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v241 = Tile<
        ...
        // pto: %row3_rowsum_inline14169__rm_a0_tmp_v6
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v245 = Tile<
        ...
        TASSIGN(v245, v246);
        // pto: %row3_rowsum_inline14169__row_major_tmp_v7
        Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v247 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v247, v245, v19);
        // pto: %row3_rowsum_inline14169__ssa_v0
        Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v249 = Tile<
        ...
        TASSIGN(v249, v250);
        // pto: %row0_norm_inline14128__ssa_v0
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v251 = Tile<
        ...
        // pto: %row1_norm_inline14197__ssa_v0
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v253 = Tile<
        ...
        // pto: %row2_norm_inline14212__ssa_v0
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v255 = Tile<
        ...
        // pto: %row3_norm_inline14150__ssa_v0
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v257 = Tile<
        ...
        TASSIGN(v261, v262);
        TADD(v261, v255, v257);
        // pto: %col_sum_v1_inline14198__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v263 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADD(v263, v259, v261);
        // pto: %col_sum_v1_inline14198__ssa_v4
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v265 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TADDS(v265, v263, v19);
        // pto: %row0_cur_inline14202__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v267 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TDIV(v267, v251, v265);
        // pto: %row1_cur_inline14203__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v269 = Tile<
        ...
        TASSIGN(v269, v270);
        TDIV(v269, v253, v265);
        // pto: %row2_cur_inline14214__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v271 = Tile<
        ...
        TASSIGN(v271, v272);
        TDIV(v271, v255, v265);
        // pto: %row3_cur_inline14205__ssa_v3
        Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
            CompactMode::Null>
            v273 = Tile<
    ...
    // pto: %col_sum_v1_inline14198__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v387 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v387, v388);
    // pto: %row0_cur_inline14202__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v389 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v389, v390);
    // pto: %row1_cur_inline14203__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v391 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v391, v392);
    // pto: %row2_cur_inline14214__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v393 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    TASSIGN(v393, v394);
    // pto: %row3_cur_inline14205__rv_v2
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero, CompactMode::Null>
        v395 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Zero,
    ...
    // pto: %comb_ffn_inline9269__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: inv_rms_inline14104__ssa_v1
    __gm__ Tensor *inv_rms_inline14104__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *inv_rms_inline14104__ssa_v1 =
        reinterpret_cast<__gm__ float *>(inv_rms_inline14104__ssa_v1_tensor->buffer.addr) +
        inv_rms_inline14104__ssa_v1_tensor->start_offset;

    // Unpack tensor: mixes_raw_inline14127__ssa_v1
    __gm__ Tensor *mixes_raw_inline14127__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *mixes_raw_inline14127__ssa_v1 =
        reinterpret_cast<__gm__ float *>(mixes_raw_inline14127__ssa_v1_tensor->buffer.addr) +
        mixes_raw_inline14127__ssa_v1_tensor->start_offset;

    // Unpack tensor: hc_base_2d_inline14164__ssa_v0
    __gm__ Tensor *hc_base_2d_inline14164__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *hc_base_2d_inline14164__ssa_v0 =
        reinterpret_cast<__gm__ float *>(hc_base_2d_inline14164__ssa_v0_tensor->buffer.addr) +
        hc_base_2d_inline14164__ssa_v0_tensor->start_offset;
    ...
    float scale2_inline14129__ssa_v0 = hc_scale[2];
    ...
    comb_sinkhorn_0(
        inv_rms_inline14104__ssa_v1, mixes_raw_inline14127__ssa_v1, hc_base_2d_inline14164__ssa_v0,
        comb_ffn_inline9269__ssa_v0, scale2_inline14129__ssa_v0, t_linear_inline14154__ssa_v0, __pypto_spmd_block_idx,
