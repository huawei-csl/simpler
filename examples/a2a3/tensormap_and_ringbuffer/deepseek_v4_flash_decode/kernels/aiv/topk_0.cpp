...
topk_0(__gm__ int32_t *v1, __gm__ int32_t *v2, __gm__ int32_t *v3, __gm__ float *v4, int32_t v5, int32_t v6) {
    const int32_t v7 = 0;
    ...
    // pto: %topk_idxs_flat_inline1930_inline12661__ssa_v0_view
    int64_t v28 = v14 * v13;
    // pto: %topk_idxs_flat_inline1930_inline12661__ssa_v0_view
    int64_t v29 = v12 * v28;
    // pto: %topk_idxs_flat_inline1930_inline12661__ssa_v0_view
    ...
    // pto: %t_inline1992_inline12340__ssa_v0
    int64_t v33 = (int64_t)v5;
    // pto: %invalid_idxs_inline1947_inline12344__tile
    Tile<
    ...
    // pto: %topk_idxs_flat_inline1930_inline12661__ssa_v0_pview
    ...
    if (v45 > v18) {
        // pto: %score_full_raw_inline1943_inline12771__tile
        Tile<
        ...
        TASSIGN(v46, v47);
        // pto: %score_flat_inline1948_inline12292__rv_v2_pview
        ...
        // pto: %score_full_inline1927_inline12700__tile
        Tile<
        ...
        TASSIGN(v53, v54);
        TEXPANDS(v53, v8);
        // pto: %score_full_v1_inline1926_inline12709__tile
        Tile<
            TileType::Vec, float, 1, 4096, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>
            v55 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TMAX(v55, v51, v53);
        // pto: %idx_init_inline1925_inline12713__tile
        Tile<
        ...
        // pto: %sorted_full_inline1987_inline12663__tile
        Tile<
        ...
        pipe_barrier(PIPE_V);
        TSORT32(v59, v55, v57);
        // pto: %sorted_full_v1_inline1924_inline12774__tile
        Tile<
            TileType::Vec, float, 1, 8192, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>
            v61 = Tile<
        ...
        // pto: %sorted_full_v2_inline1923_inline12734__tile
        Tile<
            TileType::Vec, float, 1, 8192, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>
            v63 = Tile<
        ...
        // pto: %sorted_full_v3_inline2007_inline12295__tile
        Tile<
            TileType::Vec, float, 1, 8192, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>
            v65 = Tile<
        ...
        // pto: %half0_candidates_inline1959_inline12775__tile
        Tile<
        ...
        TASSIGN(v70, v71);
        // pto: %half1_candidates_inline1922_inline12778__tile
        Tile<
            TileType::Vec, float, 1, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>
            v72 = Tile<
        ...
        TASSIGN(v77, v78);
        // pto: %merged_candidates_inline1921_inline12475__tile
        Tile<
        ...
        // pto: %topk_pairs_inline2021_inline12689__tile
        Tile<
            TileType::Vec, float, 1, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Min,
            CompactMode::Null>
            v81 = Tile<
        ...
        TASSIGN(v84, v85);
        // pto: %topk_idxs_tile_inline1920_inline12432__tile
        Tile<
        ...
        // pto: %topk_idxs_flat_inline1930_inline12661__tile_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    topk_0(
        topk_idxs_flat_inline1930_inline12661__ssa_v0, kv_seq_lens__ssa_v0, position_ids_bsd_inline12252__ssa_v0,
        score_flat_inline1948_inline12292__rv_v2, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
