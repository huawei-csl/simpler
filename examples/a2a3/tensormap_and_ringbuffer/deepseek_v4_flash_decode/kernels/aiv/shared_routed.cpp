...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *sh_inline9332__rv_v2_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[0]);
    ...
    __gm__ ChipTensor *ffn_out_inline9141__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[2]);
