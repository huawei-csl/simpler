...
static __aicore__ void combine_wait(__gm__ int32_t *v1, int32_t v2, __gm__ int64_t *v3) {
    pto::comm::WaitCmp v4 = pto::comm::WaitCmp::GE;
    pto::comm::NotifyOp v5 = pto::comm::NotifyOp::AtomicAdd;
    const int32_t v6 = 1;
    const int64_t v7 = 4;
    const int64_t v8 = 0;
    const int64_t v9 = 1;
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    for (int64_t i11 = v8; i11 < v10; i11 += v9) {
        // pto: %0
        int64_t v12 = (int64_t)v2;
        // pto: %1
        if (i11 != v12) {
            // pto: %2
            int64_t v13 = (v3)[v10];
            // pto: %3, %4, %5, %6
            int64_t v14 = (v3)[(int64_t)((uint64_t)((int64_t)((int32_t)v13)) + (uint64_t)v7)];
            // pto: %7, %8
            int64_t v15 = (v3)[(int64_t)((uint64_t)i11 + (uint64_t)v7)];
            // pto: %combine_arrived__ssa_v0_peer_pview
            pto::Shape<1, 1, 1, 1, 1> v16 = pto::Shape<1, 1, 1, 1, 1>();
            // pto: %combine_arrived__ssa_v0_peer_pview
            pto::Stride<1, 1, 1, 1, 2> v17 = pto::Stride<1, 1, 1, 1, 2>();
            // pto: %9, %10, %12, %14, %combine_arrived__ssa_v0_peer_pview
            GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN> v18 =
                GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN>(
                    (v1 + (int64_t)((uint64_t)v15 - (uint64_t)v14) / v7) + (v8 + (v12 < v8 ? v8 : v12)), v16, v17
                );
            pipe_barrier(PIPE_ALL);
            pto::comm::TNOTIFY(v18, v6, v5);
        }
    }
    for (int64_t i19 = v8; i19 < v10; i19 += v9) {
        // pto: %15, %16
        if (i19 != (int64_t)v2) {
            // pto: %combine_arrived__ssa_v0_local_pview
            pto::Shape<1, 1, 1, 1, 1> v20 = pto::Shape<1, 1, 1, 1, 1>();
            // pto: %combine_arrived__ssa_v0_local_pview
            pto::Stride<1, 1, 1, 1, 2> v21 = pto::Stride<1, 1, 1, 1, 2>();
            // pto: %17, %combine_arrived__ssa_v0_local_pview
            GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN> v22 =
                GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN>(
                    v1 + (v8 + (i19 < v8 ? v8 : i19)), v20, v21
                );
            pto::comm::TWAIT(v22, v6, v4);
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ int64_t *combine_arrived_ctx = reinterpret_cast<__gm__ int64_t *>(args[2]);

    // Forward to ptoas-generated function
    combine_wait(combine_arrived__ssa_v0, my_rank__ssa_v0, combine_arrived_ctx);
}
