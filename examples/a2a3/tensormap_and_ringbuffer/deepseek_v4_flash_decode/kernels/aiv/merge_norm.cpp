...
static __aicore__ void merge_norm(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %m_idx_inline1005_inline8859__ssa_v0
    ...
    // pto: %m_mi_inline1069_inline8764__tile
    Tile<
    ...
    // pto: %sparse_blk_mi_inline1018_inline9107__rv_v2_pview
    ...
    TLOAD(v37, v42);
    // pto: %m_li_inline1111_inline8951__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v43 = Tile<
    ...
    TASSIGN(v43, v44);
    // pto: %sparse_blk_li_inline1070_inline9008__rv_v2_pview
    ...
    TLOAD(v43, v47);
    // pto: %m_oi_inline1113_inline8763__tile
    Tile<
    ...
    TASSIGN(v48, v49);
    // pto: %sparse_blk_oi_inline1043_inline9109__rv_v2_pview
    ...
    // pto: %n_sink_inline1068_inline8997__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v58 = Tile<
    ...
    TASSIGN(v58, v59);
    // pto: %n_sink_delta_inline1004_inline8762__rm_a0_tmp_v0
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v60 = Tile<
    ...
    TASSIGN(v60, v61);
    // pto: %n_sink_delta_inline1004_inline8762__rm_a1_tmp_v1
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v62 = Tile<
    ...
    TASSIGN(v62, v63);
    // pto: %n_sink_delta_inline1004_inline8762__row_major_tmp_v2
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v64 = Tile<
    ...
    TSUB(v64, v60, v62);
    // pto: %n_sink_delta_inline1004_inline8762__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v66 = Tile<
    ...
    TASSIGN(v66, v67);
    // pto: %n_sink_exp_inline1115_inline8871__rm_a0_tmp_v3
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v68 = Tile<
    ...
    TASSIGN(v68, v69);
    // pto: %n_sink_exp_inline1115_inline8871__row_major_tmp_v4
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v70 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TEXP(v70, v68);
    // pto: %n_sink_exp_inline1115_inline8871__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v72 = Tile<
    ...
    TASSIGN(v72, v73);
    // pto: %n_denom_inline991_inline8761__rm_a0_tmp_v5
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v74 = Tile<
    ...
    TASSIGN(v74, v75);
    // pto: %n_denom_inline991_inline8761__rm_a1_tmp_v6
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v76 = Tile<
    ...
    TASSIGN(v76, v77);
    // pto: %n_denom_inline991_inline8761__row_major_tmp_v7
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v78 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TADD(v78, v74, v76);
    // pto: %n_denom_inline991_inline8761__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v80 = Tile<
    ...
    TASSIGN(v80, v81);
    // pto: %n_normalized_inline1028_inline8976__tile
    Tile<
        TileType::Vec, float, 16, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v82 = Tile<
    ...
    // pto: %n_full_inline1117_inline8760__tile
    Tile<
        TileType::Vec, float, 16, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v84 = Tile<
    ...
    TASSIGN(v87, v88);
    // pto: %n_bf16_inline1107_inline8759__tile
    Tile<
    ...
    // pto: %m_rope_inline1009_inline8870__tile
    Tile<
    ...
    TASSIGN(v96, v97);
    // pto: %rope_swap_idx_inline1029_inline8812__ssa_v1_pview
    ...
    // pto: %m_swapped_inline983_inline8758__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v122 = Tile<
    ...
    TASSIGN(v122, v123);
    // pto: %m_cos_il_inline1050_inline8756__tile
    Tile<
        TileType::Vec, float, 1, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v124 = Tile<
    ...
    // pto: %rope_cos_il_inline972_inline8894__rv_v2_pview
    ...
    // pto: %m_sin_signed_inline1120_inline8755__tile
    Tile<
        TileType::Vec, float, 1, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v130 = Tile<
    ...
    TASSIGN(v130, v131);
    // pto: %rope_sin_signed_inline1066_inline8798__rv_v2_pview
    ...
    // pto: %m_rope_inline1009_inline8870__tile_textract
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v135 = Tile<
    ...
    // pto: %m_rope_cos_inline1038_inline9014__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v137 = Tile<
    ...
    // pto: %m_swap_sin_inline1072_inline8754__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v139 = Tile<
    ...
    // pto: %m_rot_inline1110_inline8753__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v141 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TADD(v141, v137, v139);
    // pto: %n_rope_bf16_inline1122_inline8765__tile
    Tile<
    ...
    // pto: %o_packed_heads_inline1025_inline8944__ssa_v0_pview
    ...
    TASSIGN(v159, v160);
    // pto: %o_packed_heads_inline1025_inline8944__tile_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    merge_norm(
        sparse_blk_mi_inline1018_inline9107__rv_v2, sparse_blk_li_inline1070_inline9008__rv_v2,
        sparse_blk_oi_inline1043_inline9109__rv_v2, attn_sink_l0_inline595__ssa_v0,
        rope_swap_idx_inline1029_inline8812__ssa_v1, rope_cos_il_inline972_inline8894__rv_v2,
        rope_sin_signed_inline1066_inline8798__rv_v2, o_packed_heads_inline1025_inline8944__ssa_v0,
