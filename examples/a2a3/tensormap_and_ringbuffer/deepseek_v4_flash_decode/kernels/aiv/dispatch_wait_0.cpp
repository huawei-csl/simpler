 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: dispatch_wait_0
...
static __aicore__ void dispatch_wait_0(__gm__ int32_t *v1, __gm__ int32_t *v2, int32_t v3, __gm__ int64_t *v4) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ int64_t *data_arrived_ctx = reinterpret_cast<__gm__ int64_t *>(args[3]);

    // Forward to ptoas-generated function
    dispatch_wait_0(indices_inline10048__ssa_v0, data_arrived__ssa_v0, my_rank__ssa_v0, data_arrived_ctx);
}
