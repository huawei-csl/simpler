...
static __aicore__ void combine_0(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %e_inline2820_inline9975__ssa_v0
    int64_t v15 = (int64_t)v6;
    set_flag(PIPE_MTE3, PIPE_MTE2, EVENT_ID1);
    set_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID1);
    // pto: %b_inline2829_inline9900__rv_v2
    int64_t v16;
    v16 = v14;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *recv_meta_local_inline10167__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    ...
    __gm__ Tensor *recv_r_route_out_inline10131__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    // Unpack tensor: recv_y_flat_inline2828_inline9902__ssa_v0
    __gm__ Tensor *recv_y_flat_inline2828_inline9902__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    __gm__ bfloat16_t *recv_y_flat_inline2828_inline9902__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(recv_y_flat_inline2828_inline9902__ssa_v0_tensor->buffer.addr) +
        recv_y_flat_inline2828_inline9902__ssa_v0_tensor->start_offset;
    ...
    combine_0(
        recv_meta_local_inline10167__ssa_v0, recv_r_route_out_inline10131__ssa_v0, routed_y_buf__ssa_v0,
        recv_y_flat_inline2828_inline9902__ssa_v0, routed_y_buf_ctx, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
