...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *logit_row_indices__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[1]);
    ...
    __gm__ ChipTensor *selected_hidden_inline51_inline13294__ssa_v0_tensor =
    ...
    __gm__ ChipTensor *lm_head_hidden_window__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[3]);
    ...
    __gm__ ChipTensor *lm_head_hidden_done__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[4]);
