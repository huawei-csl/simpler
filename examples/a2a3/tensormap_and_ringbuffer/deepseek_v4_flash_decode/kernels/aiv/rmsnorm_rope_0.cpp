 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: rmsnorm_rope_0
...
rmsnorm_rope_0(__gm__ float *v1, __gm__ float *v2, __gm__ float *v3, __gm__ bfloat16_t *v4, __gm__ bfloat16_t *v5) {
    ...
    // pto: %partial_sq_inline15255__tile
    Tile<
    ...
    TASSIGN(v53, v54);
    TEXPANDS(v53, v17);
    // pto: %kv_rms_chunk_inline15324__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v55 = Tile<
    ...
    TASSIGN(v55, v56);
    // pto: %pooled_kv_inline15274__rv_v2_pview
    ...
    // pto: %kv_rms_sq_inline15335__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v65 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TROWSUM(v69, v65, v67);
    // pto: %kv_rms_rowsum_inline15254__tile
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v71 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TADDS(v87, v85, v15);
    // pto: %variance_inline15253__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v89 = Tile<
    ...
    TASSIGN(v95, v96);
    // pto: %inv_rms_inline15251__rm_a0_tmp_v2
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v97 = Tile<
    ...
    TASSIGN(v97, v98);
    // pto: %inv_rms_inline15251__row_major_tmp_v3
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v99 = Tile<
    ...
    TASSIGN(v101, v102);
    // pto: %kv_norm_chunk_inline15327__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v103 = Tile<
    ...
    TASSIGN(v105, v106);
    // pto: %norm_w_2d_inline15258__ssa_v0_pview
    ...
    // pto: %normed_chunk_inline15311__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v114 = Tile<
    ...
    // pto: %normed_kv_inline15296__ssa_v0_pview
    ...
    // pto: %kv_rope_norm_inline15248__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v121 = Tile<
    ...
    // pto: %gamma_rope_inline15323__tile
    Tile<
        TileType::Vec, float, 1, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v128 = Tile<
    ...
    // pto: %rope_normed_inline15247__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v132 = Tile<
    ...
    // pto: %rope_ones_inline15285__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v134 = Tile<
    ...
    // pto: %rope_col_inline15246__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v140 = Tile<
    ...
    // pto: %rope_dup_f_inline15321__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v146 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMULS(v148, v146, v11);
    // pto: %rope_lane_inline15245__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v150 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TSUB(v156, v152, v154);
    // pto: %rope_swap_idx_inline15244__tile
    Tile<
        TileType::Vec, int32_t, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v158 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMUL(v185, v181, v35);
    // pto: %rope_rot_inline15243__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v187 = Tile<
    ...
    // pto: %normed_kv_inline15296__rv_v2_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *step_cos_il_inline12430__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    ...
    __gm__ Tensor *step_sin_signed_inline12365__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    // Unpack tensor: pooled_kv_inline15274__rv_v2
    __gm__ Tensor *pooled_kv_inline15274__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *pooled_kv_inline15274__rv_v2 =
        reinterpret_cast<__gm__ float *>(pooled_kv_inline15274__rv_v2_tensor->buffer.addr) +
        pooled_kv_inline15274__rv_v2_tensor->start_offset;

    // Unpack tensor: normed_kv_inline15296__ssa_v0
    __gm__ Tensor *normed_kv_inline15296__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    __gm__ bfloat16_t *normed_kv_inline15296__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(normed_kv_inline15296__ssa_v0_tensor->buffer.addr) +
        normed_kv_inline15296__ssa_v0_tensor->start_offset;

    // Unpack tensor: norm_w_2d_inline15258__ssa_v0
    __gm__ Tensor *norm_w_2d_inline15258__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ bfloat16_t *norm_w_2d_inline15258__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(norm_w_2d_inline15258__ssa_v0_tensor->buffer.addr) +
        norm_w_2d_inline15258__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    rmsnorm_rope_0(
        step_cos_il_inline12430__ssa_v1, step_sin_signed_inline12365__ssa_v1, pooled_kv_inline15274__rv_v2,
        normed_kv_inline15296__ssa_v0, norm_w_2d_inline15258__ssa_v0
    );
}
