...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *hc_attn_base_hca_inline567__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[1]);
    ...
    __gm__ ChipTensor *mixes_raw_inline14882__ssa_v1_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[2]);
    ...
    __gm__ ChipTensor *pre_val_store_inline14887__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[3]);
    ...
    __gm__ ChipTensor *post_t_inline11780__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[4]);
