...
static __aicore__ void merge_norm_3(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %m_idx_inline2243_inline12325__ssa_v0
    ...
    // pto: %m_mi_inline2137_inline12332__tile
    Tile<
    ...
    // pto: %sparse_blk_mi_inline2120_inline12729__rv_v2_pview
    ...
    // pto: %m_li_inline2213_inline12209__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v79 = Tile<
    ...
    TASSIGN(v79, v80);
    // pto: %sparse_blk_li_inline2118_inline12815__rv_v2_pview
    ...
    TLOAD(v79, v83);
    // pto: %m_oi_inline2163_inline12765__tile
    Tile<
    ...
    TASSIGN(v84, v85);
    // pto: %sparse_blk_oi_inline2116_inline12816__rv_v2_pview
    ...
    for (int64_t i89 = v32; i89 < v25; i89 += v24) {
        ...
        // pto: %m_cur_mi_inline2237_inline12208__tile
        Tile<
            TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v93 = Tile<
        ...
        // pto: %m_cur_li_inline2254_inline12206__tile
        Tile<
            TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v99 = Tile<
        ...
        // pto: %m_cur_oi_inline2255_inline12205__tile
        Tile<
            TileType::Vec, float, 16, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v104 = Tile<
        ...
        // pto: %m_mi_new_inline2256_inline12204__rm_a0_tmp_v0
        Tile<
        ...
        TASSIGN(v125, v126);
        // pto: %m_mi_new_inline2256_inline12204__rm_a1_tmp_v1
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v127 = Tile<
        ...
        TASSIGN(v127, v128);
        // pto: %m_mi_new_inline2256_inline12204__row_major_tmp_v2
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v129 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TMAX(v129, v125, v127);
        // pto: %m_mi_new_inline2256_inline12204__tile
        Tile<
            TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v131 = Tile<
        ...
        TASSIGN(v131, v132);
        // pto: %m_mi_inline2137_inline12332__ssa_v3
        Tile<
            TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v133 = Tile<
        ...
        TASSIGN(v141, v142);
        // pto: %m_alpha_inline2098_inline12309__rm_a0_tmp_v6
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v143 = Tile<
        ...
        TASSIGN(v143, v144);
        // pto: %m_alpha_inline2098_inline12309__row_major_tmp_v7
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v145 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TEXP(v145, v143);
        // pto: %m_alpha_inline2098_inline12309__tile
        Tile<
            TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v147 = Tile<
        ...
        TASSIGN(v155, v156);
        // pto: %m_beta_inline2097_inline12203__rm_a0_tmp_v11
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v157 = Tile<
        ...
        TASSIGN(v157, v158);
        // pto: %m_beta_inline2097_inline12203__row_major_tmp_v12
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v159 = Tile<
        ...
        pipe_barrier(PIPE_V);
        TEXP(v159, v157);
        // pto: %m_beta_inline2097_inline12203__tile
        Tile<
            TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v161 = Tile<
        ...
        TASSIGN(v177, v178);
        // pto: %m_li_inline2213_inline12209__rm_a0_tmp_v19
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v179 = Tile<
        ...
        TASSIGN(v179, v180);
        // pto: %m_li_inline2213_inline12209__rm_a1_tmp_v20
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v181 = Tile<
        ...
        TASSIGN(v181, v182);
        // pto: %m_li_inline2213_inline12209__row_major_tmp_v21
        Tile<
            TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v183 = Tile<
        ...
        TADD(v259, v255, v257);
        set_flag(PIPE_V, PIPE_MTE2, EVENT_ID3);
        // pto: %m_li_inline2213_inline12209__tile_mv
        Tile<
            TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v261 = Tile<
        ...
        TASSIGN(v261, v262);
        TMOV(v261, v253);
        // pto: %m_mi_inline2137_inline12332__ssa_v3_mv
        Tile<
            TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v263 = Tile<
    ...
    // pto: %n_sink_bias_inline2248_inline12385__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v270 = Tile<
    ...
    TASSIGN(v278, v279);
    // pto: %n_sink_tile_inline2152_inline12202__rm_a0_tmp_v25
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v280 = Tile<
    ...
    TASSIGN(v280, v281);
    // pto: %n_sink_tile_inline2152_inline12202__rm_a1_tmp_v26
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v282 = Tile<
    ...
    TASSIGN(v282, v283);
    // pto: %n_sink_tile_inline2152_inline12202__row_major_tmp_v27
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v284 = Tile<
    ...
    // pto: %n_sink_tile_inline2152_inline12202__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v286 = Tile<
    ...
    TASSIGN(v300, v301);
    // pto: %n_denom_inline2094_inline12650__rm_a0_tmp_v33
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v302 = Tile<
    ...
    TASSIGN(v302, v303);
    // pto: %n_denom_inline2094_inline12650__rm_a1_tmp_v34
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v304 = Tile<
    ...
    TASSIGN(v304, v305);
    // pto: %n_denom_inline2094_inline12650__row_major_tmp_v35
    Tile<
        TileType::Vec, float, 1, 16, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v306 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TADD(v306, v302, v304);
    // pto: %n_denom_inline2094_inline12650__tile
    Tile<
        TileType::Vec, float, 16, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v308 = Tile<
    ...
    // pto: %n_full_inline2093_inline12324__tile
    Tile<
        TileType::Vec, float, 16, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v312 = Tile<
    ...
    TASSIGN(v315, v316);
    // pto: %n_bf16_inline2092_inline12217__tile
    Tile<
    ...
    // pto: %m_rope_inline2091_inline12219__tile
    Tile<
    ...
    TASSIGN(v322, v323);
    // pto: %m_cos_il_inline2123_inline12200__tile
    Tile<
    ...
    // pto: %rope_cos_il_inline2100_inline12543__ssa_v1_pview
    ...
    TLOAD(v324, v329);
    // pto: %m_sin_signed_inline2090_inline12222__tile
    Tile<
        TileType::Vec, float, 1, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v330 = Tile<
    ...
    TASSIGN(v330, v331);
    // pto: %rope_sin_signed_inline2192_inline12320__ssa_v1_pview
    ...
    TASSIGN(v335, v336);
    // pto: %rope_swap_idx_inline2169_inline12752__ssa_v1_pview
    ...
    // pto: %m_swapped_inline2088_inline12413__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v361 = Tile<
    ...
    TASSIGN(v361, v362);
    // pto: %m_rope_inline2091_inline12219__tile_textract
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v363 = Tile<
    ...
    // pto: %m_rot_inline2087_inline12207__tile
    Tile<
        TileType::Vec, float, 16, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v369 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TADD(v369, v365, v367);
    // pto: %n_rope_bf16_inline2086_inline12199__tile
    Tile<
    ...
    TASSIGN(v376, v377);
    // pto: %n_full_bf16_inline2085_inline12198__tile
    Tile<
        TileType::Vec, bfloat16_t, 16, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v378 = Tile<
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: sparse_blk_mi_inline2120_inline12729__rv_v2
    __gm__ Tensor *sparse_blk_mi_inline2120_inline12729__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *sparse_blk_mi_inline2120_inline12729__rv_v2 =
        reinterpret_cast<__gm__ float *>(sparse_blk_mi_inline2120_inline12729__rv_v2_tensor->buffer.addr) +
        sparse_blk_mi_inline2120_inline12729__rv_v2_tensor->start_offset;

    // Unpack tensor: sparse_blk_li_inline2118_inline12815__rv_v2
    __gm__ Tensor *sparse_blk_li_inline2118_inline12815__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *sparse_blk_li_inline2118_inline12815__rv_v2 =
        reinterpret_cast<__gm__ float *>(sparse_blk_li_inline2118_inline12815__rv_v2_tensor->buffer.addr) +
        sparse_blk_li_inline2118_inline12815__rv_v2_tensor->start_offset;

    // Unpack tensor: sparse_blk_oi_inline2116_inline12816__rv_v2
    __gm__ Tensor *sparse_blk_oi_inline2116_inline12816__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *sparse_blk_oi_inline2116_inline12816__rv_v2 =
        reinterpret_cast<__gm__ float *>(sparse_blk_oi_inline2116_inline12816__rv_v2_tensor->buffer.addr) +
        sparse_blk_oi_inline2116_inline12816__rv_v2_tensor->start_offset;

    // Unpack tensor: attn_sink_last_inline504__ssa_v0
    __gm__ Tensor *attn_sink_last_inline504__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    __gm__ float *attn_sink_last_inline504__ssa_v0 =
        reinterpret_cast<__gm__ float *>(attn_sink_last_inline504__ssa_v0_tensor->buffer.addr) +
        attn_sink_last_inline504__ssa_v0_tensor->start_offset;

    // Unpack tensor: rope_cos_il_inline2100_inline12543__ssa_v1
    __gm__ Tensor *rope_cos_il_inline2100_inline12543__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ float *rope_cos_il_inline2100_inline12543__ssa_v1 =
        reinterpret_cast<__gm__ float *>(rope_cos_il_inline2100_inline12543__ssa_v1_tensor->buffer.addr) +
        rope_cos_il_inline2100_inline12543__ssa_v1_tensor->start_offset;

    // Unpack tensor: rope_sin_signed_inline2192_inline12320__ssa_v1
    __gm__ Tensor *rope_sin_signed_inline2192_inline12320__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[5]);
    __gm__ float *rope_sin_signed_inline2192_inline12320__ssa_v1 =
        reinterpret_cast<__gm__ float *>(rope_sin_signed_inline2192_inline12320__ssa_v1_tensor->buffer.addr) +
        rope_sin_signed_inline2192_inline12320__ssa_v1_tensor->start_offset;

    // Unpack tensor: rope_swap_idx_inline2169_inline12752__ssa_v1
    __gm__ Tensor *rope_swap_idx_inline2169_inline12752__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[6]);
    __gm__ int32_t *rope_swap_idx_inline2169_inline12752__ssa_v1 =
        reinterpret_cast<__gm__ int32_t *>(rope_swap_idx_inline2169_inline12752__ssa_v1_tensor->buffer.addr) +
        rope_swap_idx_inline2169_inline12752__ssa_v1_tensor->start_offset;

    // Unpack tensor: o_packed_inline2242_inline12218__ssa_v0
    __gm__ Tensor *o_packed_inline2242_inline12218__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[7]);
    __gm__ bfloat16_t *o_packed_inline2242_inline12218__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(o_packed_inline2242_inline12218__ssa_v0_tensor->buffer.addr) +
        o_packed_inline2242_inline12218__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    merge_norm_3(
        sparse_blk_mi_inline2120_inline12729__rv_v2, sparse_blk_li_inline2118_inline12815__rv_v2,
        sparse_blk_oi_inline2116_inline12816__rv_v2, attn_sink_last_inline504__ssa_v0,
        rope_cos_il_inline2100_inline12543__ssa_v1, rope_sin_signed_inline2192_inline12320__ssa_v1,
        rope_swap_idx_inline2169_inline12752__ssa_v1, o_packed_inline2242_inline12218__ssa_v0, __pypto_spmd_block_idx,
