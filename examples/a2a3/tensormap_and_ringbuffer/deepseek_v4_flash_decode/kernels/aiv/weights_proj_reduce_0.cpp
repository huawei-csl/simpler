 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: weights_proj_reduce_0
...
static __aicore__ void weights_proj_reduce_0(__gm__ float *v1, __gm__ float *v2) {
    unsigned v3 = 3072;
    unsigned v4 = 2048;
    unsigned v5 = 1024;
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %w_sum_inline1952_inline12743__tile
    Tile<
    ...
    TASSIGN(v11, v12);
    // pto: %weights_partial_inline2014_inline12590__ssa_v1_pview
    ...
    // pto: %weights_inline2015_inline12545__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: weights_partial_inline2014_inline12590__ssa_v1
    __gm__ Tensor *weights_partial_inline2014_inline12590__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *weights_partial_inline2014_inline12590__ssa_v1 =
        reinterpret_cast<__gm__ float *>(weights_partial_inline2014_inline12590__ssa_v1_tensor->buffer.addr) +
        weights_partial_inline2014_inline12590__ssa_v1_tensor->start_offset;

    // Unpack tensor: weights_inline2015_inline12545__ssa_v0
    __gm__ Tensor *weights_inline2015_inline12545__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *weights_inline2015_inline12545__ssa_v0 =
        reinterpret_cast<__gm__ float *>(weights_inline2015_inline12545__ssa_v0_tensor->buffer.addr) +
        weights_inline2015_inline12545__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    weights_proj_reduce_0(weights_partial_inline2014_inline12590__ssa_v1, weights_inline2015_inline12545__ssa_v0);
}
