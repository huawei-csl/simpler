...
static __aicore__ void q_rope_prepare(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %qrp_idx_inline838_inline8929__ssa_v0, %7
    int64_t v28 = (int64_t)((uint64_t)((int64_t)v7) * (uint64_t)v16);
    // pto: %qrp_ones_inline847_inline9101__tile
    Tile<
    ...
    TASSIGN(v29, v30);
    TEXPANDS(v29, v15);
    // pto: %qrp_idx_i32_inline857_inline8964__tile
    Tile<
    ...
    // pto: %qrp_idx_fp32_inline885_inline8984__tile
    Tile<
    ...
    // pto: %qrp_col_inline802_inline8874__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v35 = Tile<
    ...
    // pto: %qrp_half_inline851_inline8901__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v37 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMULS(v37, v35, v13);
    // pto: %qrp_dup_i32_inline895_inline8910__tile
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v39, v37, v9, v10);
    // pto: %qrp_dup_f_inline855_inline8885__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v41 = Tile<
    ...
    // pto: %qrp_dup_idx_inline852_inline8921__tile
    Tile<
        TileType::Vec, int32_t, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v43 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMULS(v45, v41, v12);
    // pto: %qrp_lane_inline888_inline8903__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v47 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TSUB(v47, v35, v45);
    // pto: %qrp_next_col_inline925_inline8887__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v49 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TADDS(v49, v35, v15);
    // pto: %qrp_lane_offset_inline860_inline8985__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v51 = Tile<
    ...
    TASSIGN(v51, v52);
    TMULS(v51, v47, v12);
    // pto: %qrp_swap_f_inline861_inline8986__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v53 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TSUB(v53, v49, v51);
    // pto: %qrp_swap_idx_inline800_inline8819__tile
    Tile<
        TileType::Vec, int32_t, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v55 = Tile<
    ...
    TASSIGN(v57, v58);
    TMULS(v57, v47, v12);
    // pto: %qrp_sign_inline845_inline8856__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v59 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TSUBS(v59, v57, v15);
    // pto: %qrp_cos_rows_inline866_inline8881__tile
    Tile<
    ...
    // pto: %rope_cos_view_inline825_inline8935__ssa_v0_pview
    ...
    // pto: %qrp_sin_rows_inline826_inline8855__tile
    Tile<
        TileType::Vec, bfloat16_t, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v67 = Tile<
    ...
    TASSIGN(v67, v68);
    // pto: %rope_sin_view_inline813_inline8906__ssa_v0_pview
    ...
    // pto: %qrp_cos_inline817_inline8892__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v72 = Tile<
    ...
    // pto: %qrp_sin_inline815_inline8926__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v74 = Tile<
    ...
    // pto: %qrp_cos_il_inline843_inline8957__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v97 = Tile<
    ...
    // pto: %qrp_sin_il_inline850_inline8852__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v120 = Tile<
    ...
    TASSIGN(v120, v121);
    // pto: %qrp_sin_signed_inline810_inline8974__tile
    Tile<
        TileType::Vec, float, 8, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v122 = Tile<
    ...
    // pto: %q_rope_cos_il_inline862_inline8877__ssa_v0_pview
    ...
    TSTORE(v126, v97);
    // pto: %q_rope_sin_signed_inline898_inline8960__ssa_v0_pview
    ...
    TSTORE(v129, v122);
    // pto: %q_rope_swap_idx_inline864_inline8934__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: rope_cos_view_inline825_inline8935__ssa_v0
    __gm__ Tensor *rope_cos_view_inline825_inline8935__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ bfloat16_t *rope_cos_view_inline825_inline8935__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(rope_cos_view_inline825_inline8935__ssa_v0_tensor->buffer.addr) +
        rope_cos_view_inline825_inline8935__ssa_v0_tensor->start_offset;

    // Unpack tensor: rope_sin_view_inline813_inline8906__ssa_v0
    __gm__ Tensor *rope_sin_view_inline813_inline8906__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ bfloat16_t *rope_sin_view_inline813_inline8906__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(rope_sin_view_inline813_inline8906__ssa_v0_tensor->buffer.addr) +
        rope_sin_view_inline813_inline8906__ssa_v0_tensor->start_offset;

    // Unpack tensor: q_rope_cos_il_inline862_inline8877__ssa_v0
    __gm__ Tensor *q_rope_cos_il_inline862_inline8877__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *q_rope_cos_il_inline862_inline8877__ssa_v0 =
        reinterpret_cast<__gm__ float *>(q_rope_cos_il_inline862_inline8877__ssa_v0_tensor->buffer.addr) +
        q_rope_cos_il_inline862_inline8877__ssa_v0_tensor->start_offset;

    // Unpack tensor: q_rope_sin_signed_inline898_inline8960__ssa_v0
    __gm__ Tensor *q_rope_sin_signed_inline898_inline8960__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    __gm__ float *q_rope_sin_signed_inline898_inline8960__ssa_v0 =
        reinterpret_cast<__gm__ float *>(q_rope_sin_signed_inline898_inline8960__ssa_v0_tensor->buffer.addr) +
        q_rope_sin_signed_inline898_inline8960__ssa_v0_tensor->start_offset;

    // Unpack tensor: q_rope_swap_idx_inline864_inline8934__ssa_v0
    __gm__ Tensor *q_rope_swap_idx_inline864_inline8934__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ int32_t *q_rope_swap_idx_inline864_inline8934__ssa_v0 =
        reinterpret_cast<__gm__ int32_t *>(q_rope_swap_idx_inline864_inline8934__ssa_v0_tensor->buffer.addr) +
        q_rope_swap_idx_inline864_inline8934__ssa_v0_tensor->start_offset;

    // Extract dynamic dim: t_dim_inline889_inline8972__ssa_v0
    int64_t t_dim_inline889_inline8972__ssa_v0 =
        static_cast<int64_t>(rope_cos_view_inline825_inline8935__ssa_v0_tensor->shapes[0]);

    // Forward to ptoas-generated function
    q_rope_prepare(
        rope_cos_view_inline825_inline8935__ssa_v0, rope_sin_view_inline813_inline8906__ssa_v0,
        q_rope_cos_il_inline862_inline8877__ssa_v0, q_rope_sin_signed_inline898_inline8960__ssa_v0,
        q_rope_swap_idx_inline864_inline8934__ssa_v0, t_dim_inline889_inline8972__ssa_v0, __pypto_spmd_block_idx,
