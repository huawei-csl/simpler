...
csa_cmp_rope(__gm__ float *v1, __gm__ float *v2, __gm__ int32_t *v3, __gm__ bfloat16_t *v4, __gm__ bfloat16_t *v5) {
    ...
    for (int64_t i14 = v13; i14 < v11; i14 += v9) {
        // pto: %3, %first_pos_b_inline10521__tile
        ...
        // pto: %cmp_cos_inline10566__iter_v1_pview
        ...
        // pto: %cmp_sin_inline10337__iter_v1_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: cmp_cos_inline10566__ssa_v0
    __gm__ Tensor *cmp_cos_inline10566__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *cmp_cos_inline10566__ssa_v0 =
        reinterpret_cast<__gm__ float *>(cmp_cos_inline10566__ssa_v0_tensor->buffer.addr) +
        cmp_cos_inline10566__ssa_v0_tensor->start_offset;

    // Unpack tensor: cmp_sin_inline10337__ssa_v0
    __gm__ Tensor *cmp_sin_inline10337__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *cmp_sin_inline10337__ssa_v0 =
        reinterpret_cast<__gm__ float *>(cmp_sin_inline10337__ssa_v0_tensor->buffer.addr) +
        cmp_sin_inline10337__ssa_v0_tensor->start_offset;
    ...
    csa_cmp_rope(
        cmp_cos_inline10566__ssa_v0, cmp_sin_inline10337__ssa_v0, position_ids__ssa_v0,
