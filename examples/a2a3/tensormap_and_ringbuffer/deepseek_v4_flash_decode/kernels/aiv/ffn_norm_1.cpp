...
static __aicore__ void ffn_norm_1(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %tok_inline2569_inline11055__ssa_v0
    ...
    // pto: %x_mixed_inline11049__rv_v2_pview
    ...
    // pto: %rms_x_inline2565_inline11070__ssa_v0
    Tile<
    ...
    TASSIGN(v33, v34);
    // pto: %norm_w_2d_inline2589_inline11216__ssa_v0_pview
    ...
    // pto: %rms_w_inline2587_inline11208__ssa_v0
    Tile<
        TileType::Vec, float, 1, 4096, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v38 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v38, v33, v10, v9);
    // pto: %xg_inline2581_inline11047__ssa_v0
    Tile<
        TileType::Vec, float, 1, 4096, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v40 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMUL(v45, v31, v31);
    // pto: %sq_rows_inline2563_inline11122__ssa_v0
    Tile<
    ...
    TASSIGN(v47, v48);
    // pto: %sq_partial_tmp_inline2560_inline11106__ssa_v0
    Tile<
        TileType::Vec, float, 8, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v49 = Tile<
    ...
    TASSIGN(v49, v50);
    // pto: %sq_partial_inline2555_inline11038__ssa_v0
    Tile<
    ...
    pipe_barrier(PIPE_V);
    TROWSUM(v51, v47, v49);
    // pto: %sq_reduce_inline2556_inline11219__ssa_v0
    Tile<
    ...
    // pto: %sq_sum_tmp_inline2617_inline11054__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v60 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v60, v61);
    // pto: %sq_sum_inline2574_inline11034__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v62 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TSQRT(v70, v68);
    // pto: %inv_rms_inline2616_inline11041__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v72 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TABS(v77, v40);
    // pto: %xg_abs_rows_inline2551_inline11018__ssa_v0
    Tile<
        TileType::Vec, float, 8, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v79 = Tile<
    ...
    TASSIGN(v79, v80);
    // pto: %amax_partial_tmp_inline2548_inline11098__ssa_v0
    Tile<
        TileType::Vec, float, 8, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v81 = Tile<
    ...
    TASSIGN(v81, v82);
    // pto: %amax_partial_inline2557_inline11053__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v83 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TROWMAX(v83, v79, v81);
    // pto: %amax_reduce_inline2552_inline11103__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v85 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %amax_tmp_inline2546_inline11117__ssa_v0
    Tile<
        TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v92 = Tile<
            TileType::Vec, float, 8, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TASSIGN(v92, v93);
    // pto: %xg_amax_inline2612_inline11045__ssa_v0
    Tile<
        TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v94 = Tile<
            TileType::Vec, float, 8, 1, BLayout::ColMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %amax_eps_inline2595_inline11115__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v98 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %xg_amax_v2_inline2597_inline11119__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v100 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TMAX(v100, v96, v98);
    // pto: %scale_max_inline2599_inline11242__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v102 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    // pto: %xg_sq_inline2580_inline11123__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v104 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TDIV(v104, v102, v100);
    // pto: %xg_dequant_scale_inline2588_inline11161__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v106 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TMULS(v106, v100, v11);
    // pto: %x_norm_dequant_scale_inline2600_inline11126__ssa_v0
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v108 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    TSTORE(v112, v108);
    // pto: %xn_scale_buf_inline2572_inline11165__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: x_mixed_inline11049__rv_v2
    __gm__ Tensor *x_mixed_inline11049__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ bfloat16_t *x_mixed_inline11049__rv_v2 =
        reinterpret_cast<__gm__ bfloat16_t *>(x_mixed_inline11049__rv_v2_tensor->buffer.addr) +
        x_mixed_inline11049__rv_v2_tensor->start_offset;

    // Unpack tensor: norm_w_2d_inline2589_inline11216__ssa_v0
    __gm__ Tensor *norm_w_2d_inline2589_inline11216__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ bfloat16_t *norm_w_2d_inline2589_inline11216__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(norm_w_2d_inline2589_inline11216__ssa_v0_tensor->buffer.addr) +
        norm_w_2d_inline2589_inline11216__ssa_v0_tensor->start_offset;

    // Unpack tensor: xg_buf_inline2582_inline11203__ssa_v0
    __gm__ Tensor *xg_buf_inline2582_inline11203__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    ...
    __gm__ Tensor *x_norm_scale_inline11052__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    ...
    // Unpack tensor: xn_scale_buf_inline2572_inline11165__ssa_v0
    __gm__ Tensor *xn_scale_buf_inline2572_inline11165__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[5]);
    __gm__ float *xn_scale_buf_inline2572_inline11165__ssa_v0 =
        reinterpret_cast<__gm__ float *>(xn_scale_buf_inline2572_inline11165__ssa_v0_tensor->buffer.addr) +
        xn_scale_buf_inline2572_inline11165__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    ffn_norm_1(
        x_mixed_inline11049__rv_v2, norm_w_2d_inline2589_inline11216__ssa_v0, xg_buf_inline2582_inline11203__ssa_v0,
        inv_rms_buf_inline2585_inline11089__ssa_v0, x_norm_scale_inline11052__ssa_v0,
        xn_scale_buf_inline2572_inline11165__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
