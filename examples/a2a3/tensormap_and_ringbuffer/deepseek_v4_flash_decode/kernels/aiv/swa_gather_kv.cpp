...
swa_gather_kv(__gm__ bfloat16_t *v1, __gm__ int32_t *v2, __gm__ bfloat16_t *v3, int64_t v4, int32_t v5, int32_t v6) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %g_task_inline1012_inline9092__ssa_v0
    ...
    for (int64_t i20 = v16; i20 < v10; i20 += v14) {
        ...
        // pto: %g_first_inline1057_inline9096__tile
        int32_t v23 = (v2)[v22];
        // pto: %12, %10, %g_last_inline1058_inline9097__tile
        ...
        if ((int64_t)((uint64_t)((int64_t)((int32_t)((uint32_t)v24 - (uint32_t)v23))) +
            ...
            for (int64_t j34 = v16; j34 < v9; j34 += v14) {
                ...
                // pto: %26, %24, %g_slot_i32_inline1035_inline9105__tile
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: swa_kv_flat_inline1000_inline9087__ssa_v0
    __gm__ Tensor *swa_kv_flat_inline1000_inline9087__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ bfloat16_t *swa_kv_flat_inline1000_inline9087__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(swa_kv_flat_inline1000_inline9087__ssa_v0_tensor->buffer.addr) +
        swa_kv_flat_inline1000_inline9087__ssa_v0_tensor->start_offset;
    ...
    // Unpack tensor: ori_kv_flat_inline1033_inline8970__ssa_v0
    __gm__ Tensor *ori_kv_flat_inline1033_inline8970__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ bfloat16_t *ori_kv_flat_inline1033_inline8970__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(ori_kv_flat_inline1033_inline8970__ssa_v0_tensor->buffer.addr) +
        ori_kv_flat_inline1033_inline8970__ssa_v0_tensor->start_offset;

    // Extract dynamic dim: ori_block_num_inline1046_inline9076__ssa_v0
    int64_t ori_block_num_inline1046_inline9076__ssa_v0 =
        (static_cast<int64_t>(ori_kv_flat_inline1033_inline8970__ssa_v0_tensor->shapes[0]) / 128);

    // Forward to ptoas-generated function
    swa_gather_kv(
        swa_kv_flat_inline1000_inline9087__ssa_v0, swa_indices_inline636__ssa_v1,
        ori_kv_flat_inline1033_inline8970__ssa_v0, ori_block_num_inline1046_inline9076__ssa_v0, __pypto_spmd_block_idx,
