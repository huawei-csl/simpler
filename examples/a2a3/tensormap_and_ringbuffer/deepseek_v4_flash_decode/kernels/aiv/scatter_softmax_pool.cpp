...
static __aicore__ void scatter_softmax_pool(
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %front_kv_inline1862_inline10718__phi_v2
    Tile<
    ...
    TASSIGN(v31, v32);
    // pto: %front_score_inline1911_inline10680__phi_v2
    Tile<
        TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v33 = Tile<
    ...
    for (int64_t i35 = v25; i35 < v17; i35 += v19) {
        ...
        // pto: %token_pos_inline1853_inline10462__tile
        int32_t v37 = (v3)[v36];
        // pto: %state_row_i64_inline1850_inline10622__tile
        int64_t v38 = (v4)[v36];
        // pto: %23, %24
        ...
        if (v38 >= v25) {
            // pto: %kv_tile_inline1869_inline10733__tile
            Tile<
            ...
            // pto: %cmp4_kv_proj_pad_inline1900_inline10467__ssa_v1_pview
            ...
            // pto: %score_tile_inline1897_inline10693__tile
            Tile<
                TileType::Vec, float, 1, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                CompactMode::Null>
                v50 = Tile<
            ...
            TASSIGN(v50, v51);
            // pto: %cmp4_score_proj_pad_inline1878_inline10597__ssa_v1_pview
            ...
            TLOAD(v50, v54);
            // pto: %ape_tile_inline1907_inline10717__tile
            Tile<
                TileType::Vec, float, 1, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                CompactMode::Null>
                v55 = Tile<
            ...
            // pto: %score_tile_v1_inline1902_inline10594__tile
            Tile<
                TileType::Vec, float, 1, 1024, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                CompactMode::Null>
                v60 = Tile<
            ...
            // pto: %compress_state_flat_inline1881_inline10554__iter_v1_pview
            ...
            TSTORE(v65, v44);
            // pto: %compress_state_flat_inline1881_inline10554__tile_pview
        ...
        if (v42 >= v25) {
            ...
            // pto: %compress_state_flat_inline1881_inline10554__phi_v7_pview
        ...
        if (v96 >= v16) {
            ...
            // pto: %mi_inline1891_inline10713__tile
            Tile<
                TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                CompactMode::Null>
                v102 = Tile<
            ...
            TSUB(v108, v102, v102);
            // pto: %li_inline1910_inline10714__tile
            Tile<
                TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                CompactMode::Null>
                v110 = Tile<
            ...
            pipe_barrier(PIPE_V);
            TEXP(v110, v108);
            // pto: %oi_inline1899_inline10553__tile
            Tile<
                TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                CompactMode::Null>
                v112 = Tile<
            ...
            for (int64_t j117 = v25; j117 < v17; j117 += v19) {
                ...
                // pto: %front_score_inline1911_inline10680__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v119 = Tile<
                ...
                pipe_barrier(PIPE_V);
                TEXPANDS(v119, v13);
                // pto: %front_kv_inline1862_inline10718__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v121 = Tile<
                ...
                if (v95 >= v17) {
                    ...
                    // pto: %front_kv_inline1862_inline10718__tile_mv
                    Tile<
                        TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                        CompactMode::Null>
                        v136 = Tile<
                    ...
                    pipe_barrier(PIPE_V);
                    TMOV(v136, v121);
                    // pto: %front_score_inline1911_inline10680__tile_mv
                    Tile<
                        TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                        CompactMode::Null>
                        v138 = Tile<
                ...
                // pto: %mi_next_front_inline1880_inline10479__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v140 = Tile<
                ...
                pipe_barrier(PIPE_V);
                TSUB(v142, v102, v140);
                // pto: %alpha_front_inline1918_inline10771__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v144 = Tile<
                ...
                TASSIGN(v146, v147);
                TSUB(v146, v33, v140);
                // pto: %beta_front_inline1885_inline10722__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v148 = Tile<
                ...
                TADD(v158, v154, v156);
                set_flag(PIPE_V, PIPE_MTE2, EVENT_ID1);
                // pto: %mi_inline1891_inline10713__ssa_v3
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v160 = Tile<
                ...
                TASSIGN(v160, v161);
                // pto: %mi_inline1891_inline10713__ssa_v3_mv
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v162 = Tile<
            ...
            for (int64_t j164 = v25; j164 < v14; j164 += v19) {
                ...
                int64_t v167 = (int64_t)((uint64_t)((int64_t)((uint64_t)((int64_t)v166) * (uint64_t)v17)) +
                                         (uint64_t)(v165 % v17));
                // pto: %back_score_inline1861_inline10731__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v168 = Tile<
                ...
                // pto: %back_kv_inline1838_inline10732__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v174 = Tile<
                ...
                // pto: %mi_next_back_inline1837_inline10734__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v179 = Tile<
                ...
                pipe_barrier(PIPE_V);
                TSUB(v181, v102, v179);
                // pto: %alpha_back_inline1864_inline10644__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v183 = Tile<
                ...
                TASSIGN(v185, v186);
                TSUB(v185, v168, v179);
                // pto: %beta_back_inline1883_inline10738__tile
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v187 = Tile<
                ...
                TADD(v197, v193, v195);
                set_flag(PIPE_V, PIPE_MTE2, EVENT_ID3);
                // pto: %mi_inline1891_inline10713__ssa_v6
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v199 = Tile<
                ...
                TASSIGN(v199, v200);
                // pto: %mi_inline1891_inline10713__ssa_v6_mv
                Tile<
                    TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                    CompactMode::Null>
                    v201 = Tile<
            ...
            // pto: %pooled_chunk_inline1836_inline10743__tile
            Tile<
                TileType::Vec, float, 1, 512, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
                CompactMode::Null>
                v203 = Tile<
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: compress_state_flat_inline1881_inline10554__ssa_v0
    __gm__ Tensor *compress_state_flat_inline1881_inline10554__ssa_v0_tensor =
        reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *compress_state_flat_inline1881_inline10554__ssa_v0 =
        reinterpret_cast<__gm__ float *>(compress_state_flat_inline1881_inline10554__ssa_v0_tensor->buffer.addr) +
        compress_state_flat_inline1881_inline10554__ssa_v0_tensor->start_offset;

    // Unpack tensor: pooled_kv_inline1855_inline10468__ssa_v0
    __gm__ Tensor *pooled_kv_inline1855_inline10468__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *pooled_kv_inline1855_inline10468__ssa_v0 =
        reinterpret_cast<__gm__ float *>(pooled_kv_inline1855_inline10468__ssa_v0_tensor->buffer.addr) +
        pooled_kv_inline1855_inline10468__ssa_v0_tensor->start_offset;
    ...
    // Unpack tensor: state_slot_mapping_bsd_inline10711__ssa_v0
    __gm__ Tensor *state_slot_mapping_bsd_inline10711__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[3]);
    __gm__ int64_t *state_slot_mapping_bsd_inline10711__ssa_v0 =
        reinterpret_cast<__gm__ int64_t *>(state_slot_mapping_bsd_inline10711__ssa_v0_tensor->buffer.addr) +
        state_slot_mapping_bsd_inline10711__ssa_v0_tensor->start_offset;

    // Unpack tensor: cmp4_kv_proj_pad_inline1900_inline10467__ssa_v1
    __gm__ Tensor *cmp4_kv_proj_pad_inline1900_inline10467__ssa_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[4]);
    __gm__ float *cmp4_kv_proj_pad_inline1900_inline10467__ssa_v1 =
        reinterpret_cast<__gm__ float *>(cmp4_kv_proj_pad_inline1900_inline10467__ssa_v1_tensor->buffer.addr) +
        cmp4_kv_proj_pad_inline1900_inline10467__ssa_v1_tensor->start_offset;

    // Unpack tensor: cmp4_score_proj_pad_inline1878_inline10597__ssa_v1
    __gm__ Tensor *cmp4_score_proj_pad_inline1878_inline10597__ssa_v1_tensor =
        reinterpret_cast<__gm__ Tensor *>(args[5]);
    __gm__ float *cmp4_score_proj_pad_inline1878_inline10597__ssa_v1 =
        reinterpret_cast<__gm__ float *>(cmp4_score_proj_pad_inline1878_inline10597__ssa_v1_tensor->buffer.addr) +
        cmp4_score_proj_pad_inline1878_inline10597__ssa_v1_tensor->start_offset;

    // Unpack tensor: csa_cmp_ape_csa_inline734__ssa_v0
    __gm__ Tensor *csa_cmp_ape_csa_inline734__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[6]);
    __gm__ float *csa_cmp_ape_csa_inline734__ssa_v0 =
        reinterpret_cast<__gm__ float *>(csa_cmp_ape_csa_inline734__ssa_v0_tensor->buffer.addr) +
        csa_cmp_ape_csa_inline734__ssa_v0_tensor->start_offset;
    ...
    // Extract dynamic dim: compress_state_block_num_inline1857_inline10595__ssa_v0
    int64_t compress_state_block_num_inline1857_inline10595__ssa_v0 =
        (static_cast<int64_t>(compress_state_flat_inline1881_inline10554__ssa_v0_tensor->shapes[0]) / 4);

    // Forward to ptoas-generated function
    scatter_softmax_pool(
        compress_state_flat_inline1881_inline10554__ssa_v0, pooled_kv_inline1855_inline10468__ssa_v0,
        position_ids_bsd_inline10328__ssa_v0, state_slot_mapping_bsd_inline10711__ssa_v0,
        cmp4_kv_proj_pad_inline1900_inline10467__ssa_v1, cmp4_score_proj_pad_inline1878_inline10597__ssa_v1,
        csa_cmp_ape_csa_inline734__ssa_v0, csa_compress_state_block_table__ssa_v0,
        compress_state_block_num_inline1857_inline10595__ssa_v0
    );
}
