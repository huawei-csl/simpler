...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *act_scale_dq_inline1008_inline9690__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    ...
    __gm__ Tensor *o_r_i8_pad_inline1095_inline9509__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    __gm__ Tensor *o_r_pad_inline974_inline9624__ssa_v3_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
