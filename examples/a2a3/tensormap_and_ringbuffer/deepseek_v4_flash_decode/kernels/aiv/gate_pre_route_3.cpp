 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: gate_pre_route_3
...
gate_pre_route_3(__gm__ float *v1, __gm__ int32_t *v2, __gm__ float *v3, __gm__ float *v4, int64_t v5) {
    unsigned v6 = 64;
    ...
    // pto: %biased_scores_buf_inline2564_inline13093__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    gate_pre_route_3(
        x_norm_scale_inline12976__ssa_v0, indices_inline13017__ssa_v0, weights_inline13007__ssa_v0,
        biased_scores_buf_inline2564_inline13093__ssa_v0, active_tokens_inline2578_inline12966__phi_v4
    );
}
