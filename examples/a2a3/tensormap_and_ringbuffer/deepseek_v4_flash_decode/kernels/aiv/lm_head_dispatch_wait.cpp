...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *x_out__rv_v2_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[0]);
    ...
    __gm__ ChipTensor *lm_head_hidden_done__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[1]);
