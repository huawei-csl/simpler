 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: lm_head_dispatch_wait
...
lm_head_dispatch_wait(__gm__ bfloat16_t *v1, __gm__ int32_t *v2, int32_t v3, __gm__ int64_t *v4, int64_t v5) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    for (int64_t i11 = v7; i11 < v8; i11 += v9) {
        // pto: %0, %1, %3
        if (i11 != (int64_t)v3 % v8) {
            // pto: %lm_head_hidden_done__ssa_v0_local_pview
            pto::Shape<1, 1, 1, 1, 1> v12 = pto::Shape<1, 1, 1, 1, 1>();
            // pto: %lm_head_hidden_done__ssa_v0_local_pview
            pto::Stride<1, 1, 1, 1, 2> v13 = pto::Stride<1, 1, 1, 1, 2>();
            // pto: %4, %lm_head_hidden_done__ssa_v0_local_pview
            GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN> v14 =
                GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN>(
                    v2 + (v7 + (i11 < v7 ? v7 : i11)), v12, v13
                );
            pto::comm::TWAIT(v14, v10, v6);
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    lm_head_dispatch_wait(x_out__rv_v2, lm_head_hidden_done__ssa_v0, my_rank__ssa_v0, lm_head_hidden_done_ctx, T_DYN);
}
