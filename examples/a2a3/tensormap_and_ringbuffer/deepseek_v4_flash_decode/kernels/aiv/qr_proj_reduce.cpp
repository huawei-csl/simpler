...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *qr_partials_inline803_inline8977__rv_v2_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[0]);
    ...
    __gm__ ChipTensor *qr_fp32_inline806_inline8876__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[1]);
