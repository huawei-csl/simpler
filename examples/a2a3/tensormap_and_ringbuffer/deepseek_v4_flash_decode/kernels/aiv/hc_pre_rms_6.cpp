...
hc_pre_rms_6(__gm__ float *v1, __gm__ float *v2, int64_t v3, int64_t v4, int32_t v5, int32_t v6) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %inv_rms_inline14986__ssa_v0_view
    int64_t v30 = v4 * v16;
    // pto: %inv_rms_inline14986__ssa_v0_view
    int64_t v31 = v16 * v30;
    // pto: %inv_rms_inline14986__ssa_v0_view
    ...
    // pto: %t_inline15091__ssa_v0, %24
    int64_t v35 = (int64_t)((uint64_t)((int64_t)v5) * (uint64_t)v15);
    // pto: %sq_sum_inline15034__tile
    Tile<
    ...
    for (int64_t i38 = v22; i38 < v13; i38 += v12) {
        ...
        // pto: %x_flat_inline15031__ssa_v0_pview, %33
    ...
    TASSIGN(v112, v113);
    // pto: %inv_rms_inline14986__ssa_v0_pview
    ...
    // pto: %43, %inv_rms_inline14986__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: inv_rms_inline14986__ssa_v0
    __gm__ Tensor *inv_rms_inline14986__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ float *inv_rms_inline14986__ssa_v0 =
        reinterpret_cast<__gm__ float *>(inv_rms_inline14986__ssa_v0_tensor->buffer.addr) +
        inv_rms_inline14986__ssa_v0_tensor->start_offset;
    ...
    int64_t t_linear_inline15036__ssa_v0 = static_cast<int64_t>(inv_rms_inline14986__ssa_v0_tensor->shapes[0]);

    // Forward to ptoas-generated function
    hc_pre_rms_6(
        x_flat_inline15031__ssa_v0, inv_rms_inline14986__ssa_v0, t_dim_inline15018__ssa_v0,
        t_linear_inline15036__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num
    );
}
