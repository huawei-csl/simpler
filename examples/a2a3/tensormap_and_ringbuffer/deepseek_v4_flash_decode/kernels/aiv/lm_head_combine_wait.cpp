...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ ChipTensor *logits_shards_inline40_inline13289__rv_v2_tensor =
    ...
    __gm__ ChipTensor *lm_head_logits_done__ssa_v0_tensor = reinterpret_cast<__gm__ ChipTensor *>(args[1]);
