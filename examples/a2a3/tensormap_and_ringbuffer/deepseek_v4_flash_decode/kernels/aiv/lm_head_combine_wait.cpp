 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: lm_head_combine_wait
...
static __aicore__ void lm_head_combine_wait(__gm__ float *v1, __gm__ int32_t *v2, int32_t v3, __gm__ int64_t *v4) {
    ...
    for (int64_t i10 = v6; i10 < v7; i10 += v8) {
        // pto: %0, %1, %3
        if (i10 != (int64_t)v3 % v7) {
            // pto: %lm_head_logits_done__ssa_v0_local_pview
            pto::Shape<1, 1, 1, 1, 1> v11 = pto::Shape<1, 1, 1, 1, 1>();
            // pto: %lm_head_logits_done__ssa_v0_local_pview
            pto::Stride<1, 1, 1, 1, 2> v12 = pto::Stride<1, 1, 1, 1, 2>();
            // pto: %4, %lm_head_logits_done__ssa_v0_local_pview
            GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN> v13 =
                GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 1>, pto::Stride<1, 1, 1, 1, 2>, pto::Layout::DN>(
                    v2 + (v6 + (i10 < v6 ? v6 : i10)), v11, v12
                );
            pto::comm::TWAIT(v13, v9, v5);
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *logits_shards_inline40_inline13289__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    ...
    __gm__ Tensor *lm_head_logits_done__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    __gm__ int64_t *lm_head_logits_done_ctx = reinterpret_cast<__gm__ int64_t *>(args[3]);

    // Forward to ptoas-generated function
    lm_head_combine_wait(
        logits_shards_inline40_inline13289__rv_v2, lm_head_logits_done__ssa_v0, my_rank__ssa_v0, lm_head_logits_done_ctx
    );
}
