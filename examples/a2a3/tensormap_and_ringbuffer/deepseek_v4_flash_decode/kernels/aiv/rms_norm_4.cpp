...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *x_head_inline485__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    ...
    __gm__ Tensor *x_out__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    ...
    __gm__ Tensor *final_norm_w__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
