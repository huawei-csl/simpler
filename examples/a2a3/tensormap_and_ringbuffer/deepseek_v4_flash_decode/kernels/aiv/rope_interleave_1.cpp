 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: rope_interleave_1
...
static __aicore__ void rope_interleave_1(__gm__ float *v1, __gm__ float *v2, __gm__ float *v3, __gm__ float *v4) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %il_ones_inline1148_inline11560__tile
    Tile<
    ...
    TCVT(v28, v26, v7, v6);
    // pto: %il_col_inline1147_inline11595__tile
    Tile<
        TileType::Vec, float, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v30 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v34, v32, v5, v6);
    // pto: %il_dup_f_inline1146_inline11533__tile
    Tile<
        TileType::Vec, float, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v36 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TCVT(v36, v34, v7, v6);
    // pto: %il_dup_idx_inline1145_inline11546__tile
    Tile<
        TileType::Vec, int32_t, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v38 = Tile<
    ...
    // pto: %il_lane_inline1144_inline11587__tile
    Tile<
        TileType::Vec, float, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v42 = Tile<
    ...
    pipe_barrier(PIPE_V);
    TMULS(v44, v42, v8);
    // pto: %il_sign_inline1143_inline11539__tile
    Tile<
        TileType::Vec, float, 4, 64, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v46 = Tile<
    ...
    TASSIGN(v48, v49);
    // pto: %cmp_cos_inline11642__rv_v2_pview
    ...
    TASSIGN(v74, v75);
    // pto: %cmp_cos_il_inline11581__ssa_v0_pview
    ...
    TASSIGN(v79, v80);
    // pto: %cmp_sin_inline11548__rv_v2_pview
    ...
    // pto: %cmp_sin_signed_inline11505__ssa_v0_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    rope_interleave_1(
        cmp_cos_inline11642__rv_v2, cmp_cos_il_inline11581__ssa_v0, cmp_sin_inline11548__rv_v2,
        cmp_sin_signed_inline11505__ssa_v0
    );
}
