 ...
 * -----------------------------------------------------------------------------------------------------------
 */
// Kernel Function: x_norm_quant_1
...
static __aicore__ void x_norm_quant_1(__gm__ float *v1, __gm__ int8_t *v2, __gm__ float *v3, int64_t v4) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %xn_sq_col_inline2609_inline11137__tile
    Tile<
    ...
    for (int64_t i23 = v16; i23 < v11; i23 += v10) {
        ...
        // pto: %xn_q_scaled_inline2608_inline11267__tile
        Tile<
            TileType::Vec, float, 8, 256, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v37 = Tile<
        ...
        // pto: %xn_q_i32_inline2575_inline11147__tile
        Tile<
        ...
        pipe_barrier(PIPE_V);
        TCVT(v39, v37, v8, v7);
        // pto: %xn_q_half_inline2562_inline11065__tile
        Tile<
        ...
        // pto: %x_norm_i8_inline11072__iter_v3_pview
        ...
        // pto: %x_norm_i8_inline11072__tile_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ Tensor *xn_scale_buf_inline2572_inline11165__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    ...
    // Unpack tensor: x_norm_i8_inline11072__iter_v1
    __gm__ Tensor *x_norm_i8_inline11072__iter_v1_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ int8_t *x_norm_i8_inline11072__iter_v1 =
        reinterpret_cast<__gm__ int8_t *>(x_norm_i8_inline11072__iter_v1_tensor->buffer.addr) +
        x_norm_i8_inline11072__iter_v1_tensor->start_offset;
    ...
    // Unpack scalar: t0_inline2605_inline11063__idx_v0
    union {
        uint64_t u64;
        int64_t val;
    } t0_inline2605_inline11063__idx_v0_conv;
    t0_inline2605_inline11063__idx_v0_conv.u64 = args[3];
    int64_t t0_inline2605_inline11063__idx_v0 = t0_inline2605_inline11063__idx_v0_conv.val;

    // Forward to ptoas-generated function
    x_norm_quant_1(
        xn_scale_buf_inline2572_inline11165__ssa_v0, x_norm_i8_inline11072__iter_v1,
        xg_buf_inline2582_inline11203__ssa_v0, t0_inline2605_inline11063__idx_v0
    );
}
