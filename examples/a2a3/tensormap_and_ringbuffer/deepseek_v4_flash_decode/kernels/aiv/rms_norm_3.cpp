...
rms_norm_3(__gm__ bfloat16_t *v1, __gm__ bfloat16_t *v2, __gm__ bfloat16_t *v3, int32_t v4, int32_t v5) {
    ...
    set_mask_norm();
    set_vector_mask(-1, -1);
    // pto: %tg_idx_inline1645_inline12390__ssa_v0, %26
    int64_t v26 = (int64_t)((uint64_t)((int64_t)v4) * (uint64_t)v16);
    // pto: %x_sq_sum_inline1644_inline12302__tile
    Tile<
    ...
    for (int64_t i29 = v20; i29 < v13; i29 += v12) {
        ...
        // pto: %x_mixed_inline12448__rv_v2_pview
        ...
        // pto: %x_mixed_inline12448__rv_v2_pview, %31
        GlobalTensor<
        ...
        // pto: %rms_x_chunk_inline1642_inline12498__tile
        Tile<
    ...
    TASSIGN(v71, v72);
    // pto: %x_inv_rms_inline1649_inline12515__tile
    Tile<
        TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>
        v73 = Tile<
            TileType::Vec, float, 1, 8, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    pipe_barrier(PIPE_V);
    TRSQRT(v73, v69, v71);
    // pto: %x_inv_rms_t_inline1647_inline12313__tile
    Tile<
    ...
    for (int64_t i77 = v20; i77 < v13; i77 += v12) {
        ...
        TASSIGN(v87, v88);
        // pto: %attn_norm_w_last_inline570__ssa_v0_pview
        ...
        // pto: %apply_x_chunk_inline1652_inline12258__tile
        Tile<
            TileType::Vec, float, 8, 128, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v103 = Tile<
        ...
        TASSIGN(v105, v106);
        // pto: %norm_w_chunk_inline1639_inline12437__tile
        Tile<
        ...
        // pto: %x_normed_chunk_inline1638_inline12523__tile
        Tile<
            TileType::Vec, float, 8, 128, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
            CompactMode::Null>
            v111 = Tile<
        ...
        // pto: %x_normed_t_inline12472__iter_v1_pview
        ...
        // pto: %x_normed_t_inline12472__tile_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: x_mixed_inline12448__rv_v2
    __gm__ Tensor *x_mixed_inline12448__rv_v2_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ bfloat16_t *x_mixed_inline12448__rv_v2 =
        reinterpret_cast<__gm__ bfloat16_t *>(x_mixed_inline12448__rv_v2_tensor->buffer.addr) +
        x_mixed_inline12448__rv_v2_tensor->start_offset;

    // Unpack tensor: x_normed_t_inline12472__ssa_v0
    __gm__ Tensor *x_normed_t_inline12472__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[1]);
    __gm__ bfloat16_t *x_normed_t_inline12472__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(x_normed_t_inline12472__ssa_v0_tensor->buffer.addr) +
        x_normed_t_inline12472__ssa_v0_tensor->start_offset;

    // Unpack tensor: attn_norm_w_last_inline570__ssa_v0
    __gm__ Tensor *attn_norm_w_last_inline570__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ bfloat16_t *attn_norm_w_last_inline570__ssa_v0 =
        reinterpret_cast<__gm__ bfloat16_t *>(attn_norm_w_last_inline570__ssa_v0_tensor->buffer.addr) +
        attn_norm_w_last_inline570__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    rms_norm_3(
        x_mixed_inline12448__rv_v2, x_normed_t_inline12472__ssa_v0, attn_norm_w_last_inline570__ssa_v0,
