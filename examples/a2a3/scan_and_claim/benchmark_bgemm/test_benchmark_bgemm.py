...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for benchmark_bgemm: the host_build_graph scene, same kernels
...
from examples.a2a3.host_build_graph.benchmark_bgemm.test_benchmark_bgemm import TestBenchmarkBgemmHostBuildGraph as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/benchmark_bgemm"
...
class TestBenchmarkBgemmScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestBenchmarkBgemmScanAndClaim.run_module(__name__)
