...
# -----------------------------------------------------------------------------------------------------------
"""scan_and_claim coverage for paged_attention_unroll_manual_scope: the host_build_graph scene, same kernels
...
from examples.a2a3.host_build_graph.paged_attention_unroll_manual_scope.test_paged_attention_unroll_manual_scope import TestPagedAttentionUnrollManualScopeHostBuildGraph as _HbgBase
...
_SHARED_DIR = Path(__file__).resolve().parents[2] / "host_build_graph/paged_attention_unroll_manual_scope"
...
class TestPagedAttentionUnrollManualScopeScanAndClaim(_HbgBase):
...
if __name__ == "__main__":
    TestPagedAttentionUnrollManualScopeScanAndClaim.run_module(__name__)
